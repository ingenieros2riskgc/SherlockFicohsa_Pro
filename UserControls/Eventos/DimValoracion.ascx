<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DimValoracion.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DimValoracion" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DimValoracion] WHERE IdDimValoracion = @IdDimValoracion"
    InsertCommand="INSERT INTO [Eventos].[DimValoracion] ([Dimensiones] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Dimensiones, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDimValoracion] ,[Dimensiones] ,[DimValoracion].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[DimValoracion], [Listas].[Usuarios] WHERE [DimValoracion].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[DimValoracion] SET [Dimensiones] = @Dimensiones  WHERE IdDimValoracion = @IdDimValoracion">
    <DeleteParameters>
        <asp:Parameter Name="IdDimValoracion" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="Dimensiones" Type="String" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Dimensiones de Valoración" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDimValoracion,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDimValoracion" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDimValoracion" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Dimensiones" HeaderText="Dimensiones"
                                            SortExpression="Dimensiones" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Dimensiones:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDimensiones" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDimValoracion" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDimValoracion" />
                                        </td>
                                        <td>
