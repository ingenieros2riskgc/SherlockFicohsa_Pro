<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DesFactorRO.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DesFactorRO" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DesFactorRO] WHERE IdDesFactorRO = @IdDesFactorRO"
    InsertCommand="INSERT INTO [Eventos].[DesFactorRO] ([Descripcion] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Descripcion, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDesFactorRO] ,[Descripcion] ,[DesFactorRO].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[DesFactorRO], [Listas].[Usuarios] WHERE [DesFactorRO].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[DesFactorRO] SET [Descripcion] = @Descripcion  WHERE IdDesFactorRO = @IdDesFactorRO">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Factor RO" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDesFactorRO,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDesFactorRO" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDesFactorRO" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Descripcion" HeaderText="Factor RO"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Descripción:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDesFactorRO" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDesFactorRO" />
                                        </td>
                                        <td>
