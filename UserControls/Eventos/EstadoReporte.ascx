<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EstadoReporte.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.EstadoReporte" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[EstadoReporte] WHERE IdEstadoReporte = @IdEstadoReporte"
    InsertCommand="INSERT INTO [Eventos].[EstadoReporte] ([EstadoReporte] ,[IdUsuario] ,[FechaRegistro]) VALUES (@EstadoReporte, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdEstadoReporte] ,[EstadoReporte] ,[EstadoReporte].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[EstadoReporte], [Listas].[Usuarios] WHERE [EstadoReporte].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[EstadoReporte] SET [EstadoReporte] = @EstadoReporte  WHERE IdEstadoReporte = @IdEstadoReporte">
    <DeleteParameters>
        <asp:Parameter Name="IdEstadoReporte" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="EstadoReporte" Type="String" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Estado del Reporte" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdEstadoReporte,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdEstadoReporte" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdEstadoReporte" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="EstadoReporte" HeaderText="Estado del Reporte"
                                            SortExpression="EstadoReporte" HtmlEncode="False"
                ...
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEstadoReporte" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iEstadoReporte" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iEstadoReporte" />
                                        </td>
                                        <td>
