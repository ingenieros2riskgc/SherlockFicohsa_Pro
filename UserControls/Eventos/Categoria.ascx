<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Categoria.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Categoria" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Categoria] WHERE IdCategoria = @IdCategoria"
    InsertCommand="INSERT INTO [Eventos].[Categoria] ([Categoria] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Categoria, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdCategoria] ,[Categoria] ,[Categoria].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[Categoria], [Listas].[Usuarios] WHERE [Categoria].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[Categoria] SET [Categoria] = @Categoria  WHERE IdCategoria = @IdCategoria">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Categoria" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdCategoria,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdCategoria" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdCategoria" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Categoria" HeaderText="Categoria"
                                            SortExpression="Categoria" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Categoria:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCategoria" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iCategoria" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iCategoria" />
                                        </td>
                                        <td>
