<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DesCausaNDos.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DesCausaNDos" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DesCausaNDos] WHERE IdDesCausaNDos = @IdDesCausaNDos"
    InsertCommand="INSERT INTO [Eventos].[DesCausaNDos] ([Descripcion],[IdDesFactorRO],[IdDesCausaNUno] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Descripcion,@IdDesFactorRO, @IdDesCausaNUno, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDesCausaNDos] ,[DesCausaNDos].[Descripcion] ,[DesCausaNDos].[IdUsuario] ,[DesCausaNDos].[FechaRegistro] , [Usuario], [DesCausaNUno].[Descripcion] as DesCausaNUno,[DesCausaNUno].[IdDesCausaNUno], [DesFactorRO].[Descripcion] as DesFactorRO,[DesFactorRO].[IdDesFactorRO] FROM [Eventos].[DesCausaNDos], [Listas].[Usuarios], [Eventos].[DesCausaNUno], [Eventos].[DesFactorRO] WHERE [DesCausaNDos].[IdUsuario] = [Usuarios].[idUsuario] AND  [DesCausaNUno].IdDesCausaNUno = DesCausaNDos.IdDesCausaNUno AND  [DesFactorRO].IdDesFactorRO = DesCausaNDos.IdDesFactorRO"
    UpdateCommand="UPDATE [Eventos].[DesCausaNDos] SET [Descripcion] = @Descripcion, [IdDesCausaNUno] = @IdDesCausaNUno, [IdDesFactorRO] = @IdDesFactorRO  WHERE IdDesCausaNDos = @IdDesCausaNDos">
    <DeleteParameters>
        <asp:Parameter Name="IdDesCausaNDos" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="Descripcion" Type="String" />
        <asp:Parameter Name="IdDesCausaNUno" Type="Int32" />
        <asp:Parameter Name="IdDesFactorRO" Type="Int32" />
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server"
    ...
    SelectCommand="SELECT [IdDesCausaNUno], [Descripcion] FROM [Eventos].[DesCausaNUno]"></asp:SqlDataSource>
<asp:SqlDataSource ID="SqlDataSource3" runat="server"
    ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    SelectCommand="SELECT [IdDesFactorRO], [Descripcion] FROM [Eventos].[DesFactorRO]"></asp:SqlDataSource>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Descripción Causa Nivel 2" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDesCausaNDos,Usuario,IdDesCausaNUno,IdDesFactorRO" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDesCausaNDos" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDesCausaNDos" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DesCausaNUno" HeaderText="Causa N 1"
                                            SortExpression="DesCausaNUno" HtmlEncode="False"
                                        ...
                                        <asp:BoundField DataField="DesFactorRO" HeaderText="Factor RO"
                                            SortExpression="DesFactorRO" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label5" runat="server" Text="Desc. Causa N1:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlCausaNUno" runat="server" Width="300px"
                                    CssClass="Apariencia" DataSourceID="SqlDataSource2" OnDataBound="ddlCausaNUno_DataBound"
                                    DataTextField="Descripcion" DataValueField="IdDesCausaNUno" AppendDataBoundItems="true">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvLineaUno" runat="server" ControlToValidate="ddlCausaNUno"
                                    ErrorMessage="Debe ingresar la línea de negocio." ToolTip="Debe ingresar la línea de negocio."
                                    ValidationGroup="iLineaUno" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label6" runat="server" Text="Desc. FactorRO:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlDesFactorRO" runat="server" Width="300px"
                                    CssClass="Apariencia" DataSourceID="SqlDataSource3" OnDataBound="ddlDesFactorRO_DataBound"
                                    DataTextField="Descripcion" DataValueField="IdDesFactorRO" AppendDataBoundItems="true">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlDesFactorRO"
                                    ErrorMessage="Debe ingresar factor RO." ToolTip="Debe ingresar factor RO."
                                    ValidationGroup="iLineaUno" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Descripcion:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDesCausaNDos" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDesCausaNDos" />
                                        </td>
                                        <td>
