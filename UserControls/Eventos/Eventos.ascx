    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="popupCausas" runat="server" CssClass="popup" Width="800px" Style="display: none">
            <table width="100%" class="tablaSinBordes">
                ...
                <tr align="center">
                    <td colspan="2">
                        <asp:Button ID="Bok" runat="server" Text="Aceptar" CssClass="Apariencia" CausesValidation="true"
                            ValidationGroup="GEvalorCalificacion" OnClick="Bok_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                DataKeyNames="IdEvento" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <tr>
                            <td align="center">
                                <asp:TabContainer ID="TabContainerEventos" runat="server" ActiveTabIndex="1" Font-Names="Calibri"
                                        ...
                                        <ContentTemplate>
                                            <table id="TbTab1" runat="server" align="center">
                                                ...
                                                <tr align="left" runat="server" visible="true">
                                                    <td bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr align="left" runat="server">
                                                    ...
                                                    <td id="Td4" bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr runat="server" align="left">
                                                    ...
                                                    <td bgcolor="#BBBBBB" runat="server" id="lresponable" visible="False" align="center">
                                                ...
                                                <tr align="center" runat="server">
                                                    <td colspan="4" runat="server">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                                        ValidationGroup="Addne" ToolTip="Guardar" Style="height: 20px" OnClick="ImageButton6_Click" />
                                                                </td>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                                        ValidationGroup="Addne" ToolTip="Actualizar" Style="height: 20px" OnClick="ImageButton8_Click" />
                                                                </td>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                        ...
                                        <ContentTemplate>
                                            <table id="TbDatosComplementarios" runat="server" align="center">
                                                ...
                                                <tr id="TrMasLNegocio" align="left" runat="server" visible="False">
                                                    <td id="Td12" bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr id="Tr3" runat="server" align="left">
                                                    <td id="Td8" bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr id="Tr4" runat="server" align="left">
                                                    <td id="Td10" bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr id="Tr6" align="left" runat="server">
                                                    <td id="Td14" bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr id="Tr1" align="center" runat="server">
                                                    <td id="Td2" colspan="4" runat="server">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton19" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                                        ValidationGroup="Addne1" ToolTip="Guardar" Style="height: 20px" OnClick="ImageButton19_Click" />
                                                                </td>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton20" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                                        ToolTip="Cancelar" OnClick="ImageButton7_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <asp:TabPanel ID="TabDescripciones" runat="server" HeaderText="Descripciones" Font-Names="Calibri"
                                        Font-Size="Small" Visible="false">
                                        <ContentTemplate>
                                            <table id="TbDescripciones" runat="server" align="center">
                                                <tr runat="server">
                                                    <td runat="server">
                                                        <br />
                                                    </td>
                                                ...
                                                <tr align="center" runat="server">
                                                    <td bgcolor="#BBBBBB" colspan="4" runat="server">
                                                        <asp:Label ID="Label28" runat="server" Font-Names="Calibri" Font-Size="Small" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr align="left" runat="server">
                                                    <td bgcolor="#BBBBBB" runat="server" align="center">
                                                        <asp:Label ID="Label33" runat="server" Text="Desc. Factor RO" Font-Names="Calibri"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td runat="server">
                                                        <asp:DropDownList ID="DDLDesFactorRO" runat="server" Width="200px" Font-Names="Calibri"
                                                            Font-Size="Small" AutoPostBack="True" OnSelectedIndexChanged="DDLDesFactorRO_SelectedIndexChanged">
                                                            <asp:ListItem Value="---">---</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="DDLDesFactorRO"
                                                            InitialValue="---" ForeColor="Red" ValidationGroup="Addne1">*</asp:RequiredFieldValidator>
                                                    </td>
                                                    <td bgcolor="#BBBBBB" runat="server" align="center">
                                                        <asp:Label ID="Label35" runat="server" Text="Desc. Categoría" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td runat="server">
                                                        <asp:DropDownList ID="DDLDesCategoria" runat="server" Width="200px" Font-Names="Calibri"
                                                            Font-Size="Small" AutoPostBack="True" OnSelectedIndexChanged="DDLDesCategoria_SelectedIndexChanged">
                                                            <asp:ListItem Value="---">---</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="DDLDesCategoria"
                                                            InitialValue="---" ForeColor="Red" ValidationGroup="Addne1">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr align="left" runat="server">
                                                    <td bgcolor="#BBBBBB" runat="server" align="center">
                                                        <asp:Label ID="Label94" runat="server" Text="Des. Causa Nivel 1" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td runat="server">
                                                        <asp:DropDownList ID="DDLDesCausaNUno" runat="server" Width="200px" Font-Names="Calibri"
                                                            Font-Size="Small" AutoPostBack="True" OnSelectedIndexChanged="DDLDesCausaNUno_SelectedIndexChanged">
                                                            <asp:ListItem Value="0">---</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator37" runat="server" ControlToValidate="DDLDesCausaNUno"
                                                            InitialValue="---" ForeColor="Red" ValidationGroup="Addne1">*</asp:RequiredFieldValidator>
                                                    </td>
                                                    <td bgcolor="#BBBBBB" runat="server" align="center">
                                                        <asp:Label ID="Label95" runat="server" Text="Des. Causa Nivel 2" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td runat="server">
                                                        <asp:DropDownList ID="DDLDesCausaNDos" runat="server" Width="200px" Font-Names="Calibri"
                                                            Font-Size="Small" AutoPostBack="True">
                                                            <asp:ListItem Value="0">---</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator38" runat="server" ControlToValidate="DDLDesCausaNDos"
                                                            InitialValue="---" ForeColor="Red" ValidationGroup="Addne1">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr id="Tr8" align="center" runat="server">
                                                    <td id="Td22" colspan="4" runat="server">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton ID="BtnDescripciones" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                                        ToolTip="Guardar" ValidationGroup="Addne_2" Style="height: 20px" OnClick="BtnDescripciones_Click" />
                                                                </td>
                                                                <td>
                                                                    <asp:ImageButton ID="BtnDescripcionesCancel" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                                        ToolTip="Cancelar" OnClick="BtnDescripcionesCancel_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                        ...
                                        <ContentTemplate>
                                            <table>
                                                ...
                                                <tr id="Tr7" runat="server" align="left">
                                                    <td id="Td16" bgcolor="#BBBBBB" runat="server" align="center">
                                                    ...
                                                    <td bgcolor="#BBBBBB" runat="server" id="lrecuperacio" visible="false" align="center">
                                                ...
                                                <tr id="Tr5" align="left" runat="server">
                                                    <td id="Td18" bgcolor="#BBBBBB" runat="server" align="center">
                                                    ...
                                                    <td id="Td20" bgcolor="#BBBBBB" runat="server" align="center">
                                                ...
                                                <tr id="Tr2" align="center" runat="server">
                                                    <td id="Td3" colspan="4" runat="server">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton21" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                                        ToolTip="Guardar" ValidationGroup="Addne_2" Style="height: 20px" OnClick="ImageButton21_Click" />
                                                                </td>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton22" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                                        ToolTip="Cancelar" OnClick="ImageButton7_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
                    ...
                    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Font-Names="Calibri"
                                    ...
                                    <tr align="center">
                                        <td colspan="2">
                                            <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ForeColor="#333333" GridLines="Vertical" ShowHeaderWhenEmpty="True" BorderStyle="Solid" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <td colspan="2">
                                            <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ButtonField ButtonType="Image" CommandName="Relacionar" ImageUrl="~/Imagenes/Icons/selectV5.png"
                                                        Text="Asociar"></asp:ButtonField>
                                                </Columns>
                                                <EditRowStyle BackColor="#999999" />
                                                <FooterStyle BackColor="White" Font-Bold="True" ForeColor="White"></FooterStyle>
                                                <HeaderStyle BackColor="#5D7B9D" CssClass="gridViewHeader" Font-Bold="True" ForeColor="White" HorizontalAlign="Center"></HeaderStyle>
                                                <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center"></PagerStyle>
                                                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" HorizontalAlign="Left"></RowStyle>
                                                <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333"></SelectedRowStyle>
                                                <SortedAscendingCellStyle BackColor="#E9E7E2"></SortedAscendingCellStyle>
                                            ...
                                            <asp:ModalPopupExtender ID="modalPopup" runat="server" PopupControlID="popupCausas" TargetControlID="hidForModel"
                                                BackgroundCssClass="modalBackground" DropShadow="True" BehaviorID="_content_modalPopup" DynamicServicePath="">
                                    ...
                                    <tr align="center">
                                        <td colspan="2">
                                            <asp:GridView ID="GvDesasociar" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                                CellPadding="4" Font-Names="Calibri" Font-Size="Small" ForeColor="#333333" GridLines="Vertical"
                                                HorizontalAlign="Center" ShowHeaderWhenEmpty="True" HeaderStyle-HorizontalAlign="Center">
                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                <Columns>
                                                    <asp:BoundField DataField="Id" HeaderText="Id" Visible="False">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="IdEvento" HeaderText="IdRiesgo" Visible="False">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CodigoEvento" HeaderText="Código Evento">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="IdRiesgo" HeaderText="IdControl" Visible="False">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CodigoRiesgo" HeaderText="Código Riesgo">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="Fecha" HeaderText="Fecha Desasociación">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                </Columns>
                                                <EditRowStyle BackColor="#999999" />
                        ...
                        <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="Plan de Acción" Font-Names="Calibri"
                            ...
                            <ContentTemplate>
                                        ...
                                        <td>
                                            <asp:Panel ID="PanelPlanesAsociados" runat="server">
                                                ...
                                                <table>
                                                    <tr align="right">
                                                        <td>
                                                            <asp:ImageButton ID="ImageButtonPA" runat="server" ToolTip="Insertar"
                                                                ImageUrl="../../Imagenes/Icons/AddV5.png" OnClick="ImageButtonPA_Click" />
                                                        </td>
                                ...
                                <table id="RegistroPA" runat="server" visible="False" align="center">
                                    <tr runat="server">
                                        <td runat="server">
                                            <asp:GridView ID="gvPlanesAccion" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ForeColor="#333333" GridLines="Vertical" ShowHeaderWhenEmpty="True"
                                                BorderStyle="Solid" HorizontalAlign="Justify" Font-Names="Calibri" Font-Size="Small"
                                                OnSelectedIndexChanged="gvPlanesAccion_SelectedIndexChanged" HeaderStyle-HorizontalAlign="Center"
                                                DataKeyNames="Codigo" OnRowCommand="gvPlanesAccion_RowCommand" OnPageIndexChanging="gvPlanesAccion_PageIndexChanging"
                                                AllowPaging="True">
                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                <Columns>
                                                    ...
                                                    <asp:ButtonField HeaderText="Asociar" ButtonType="Image" ImageUrl="~/Imagenes/Icons/selectV5.png" Text="Select"
                                                        CommandName="Asociar" />
                                                </Columns>
                                                <EditRowStyle BackColor="#999999" />
                                                <FooterStyle BackColor="#002649" Font-Bold="True" ForeColor="White" />
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="ImageButton23" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                ToolTip="Cancelar" OnClick="ImageButton23_Click"></asp:ImageButton>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table>
                                    <tr align="center">
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" Visible="False"
                                                            CellPadding="4" Font-Names="Calibri" Font-Size="Small" ForeColor="#333333" GridLines="Vertical" HeaderStyle-HorizontalAlign="Center"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField HeaderText="Descripción" DataField="DescripcionAccion">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField HeaderText="Responsable" DataField="NombreHijo">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/editV5.png" Text="Editar"
                                    ...
                                    <tr id="trAddPlanAccion" runat="server">
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="width: 60px" valign="middle" align="center" rowspan="3">
                        <asp:Image ID="imgInfoOkNo" runat="server" ImageUrl="~/Imagenes/Icons/icontexto-webdev-alert.png" />
                    </td>
                    <td valign="middle" align="left">
