<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Origen.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Origen" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Origen] WHERE IdOrigen = @IdOrigen"
    InsertCommand="INSERT INTO [Eventos].[Origen] ([Origen] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Origen, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdOrigen] ,[Origen] ,[Origen].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[Origen], [Listas].[Usuarios] WHERE [Origen].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[Origen] SET [Origen] = @Origen  WHERE IdOrigen = @IdOrigen">
    <DeleteParameters>
        <asp:Parameter Name="IdOrigen" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Origen" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdOrigen,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdOrigen" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdOrigen" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Origen" HeaderText="Origen"
                                            SortExpression="Origen" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Origen:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtOrigen" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iOrigen" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iOrigen" />
                                        </td>
                                        <td>
