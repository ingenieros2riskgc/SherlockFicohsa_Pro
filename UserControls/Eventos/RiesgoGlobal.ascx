<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RiesgoGlobal.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.RiesgoGlobal" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[RiesgoGlobal] WHERE IdRiesgoGlobal = @IdRiesgoGlobal"
    InsertCommand="INSERT INTO [Eventos].[RiesgoGlobal] ([RiesgoGlobal] ,[IdUsuario] ,[FechaRegistro]) VALUES (@RiesgoGlobal, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdRiesgoGlobal] ,[RiesgoGlobal] ,[RiesgoGlobal].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[RiesgoGlobal], [Listas].[Usuarios] WHERE [RiesgoGlobal].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[RiesgoGlobal] SET [RiesgoGlobal] = @RiesgoGlobal  WHERE IdRiesgoGlobal = @IdRiesgoGlobal">
    <DeleteParameters>
        <asp:Parameter Name="IdRiesgoGlobal" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="RiesgoGlobal" Type="String" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Riesgo Global" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdRiesgoGlobal,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdRiesgoGlobal" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdRiesgoGlobal" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="RiesgoGlobal" HeaderText="Riesgo Global"
                                            SortExpression="RiesgoGlobal" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Riesgo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtRiesgoGlobal" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iRiesgoGlobal" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iRiesgoGlobal" />
                                        </td>
                                        <td>
