<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Frecuencia.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Frecuencia" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Frecuencia]  WHERE IdFrecuencia = @IdFrecuencia"
    InsertCommand="INSERT INTO [Eventos].[Frecuencia] ([IdAnio] ,[IdDescFrecuencia] ,[FqDesdeRO01_22] ,[FqHastaRO01_23] ,[IdUsuario] ,[FechaRegistro]) VALUES (@IdAnio, @IdDescFrecuencia, @FqDesdeRO01_22, @FqHastaRO01_23, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdFrecuencia] ,[Frecuencia].[IdAnio] , [Anios].[Anio],[Frecuencia].[IdDescFrecuencia] ,[DescFrecuencia].[DescripcionFicohsa], [FqDesdeRO01_22] ,[FqHastaRO01_23] ,[Frecuencia].[IdUsuario] ,[Frecuencia].[FechaRegistro], [Usuario] FROM [Eventos].[Frecuencia], [Eventos].[Anios], [Eventos].[DescFrecuencia],[Listas].[Usuarios] WHERE [Frecuencia].[IdUsuario] = [Usuarios].[idUsuario] AND [Frecuencia].[IdDescFrecuencia] = [DescFrecuencia].[IdDescFrecuencia] AND [Frecuencia].[IdAnio] = [Anios].[IdAnio]"
    UpdateCommand="UPDATE [Eventos].[Frecuencia] SET [IdAnio] = @IdAnio, [IdDescFrecuencia] = @IdDescFrecuencia, [FqDesdeRO01_22] = @FqDesdeRO01_22, [FqHastaRO01_23] = @FqHastaRO01_23 WHERE IdFrecuencia = @IdFrecuencia">
    <DeleteParameters>
        <asp:Parameter Name="IdFrecuencia" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="IdAnio" Type="Int32" />
        <asp:Parameter Name="IdDescFrecuencia" Type="Int32" />
        <asp:Parameter Name="FqDesdeRO01_22" Type="String" />
        <asp:Parameter Name="FqHastaRO01_23" Type="String" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Frecuencia" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="Usuario, IdAnio, IdDescFrecuencia" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdFrecuencia" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdFrecuencia" Visible="true">
                                        ...
                                        <asp:BoundField DataField="IdDescFrecuencia" HeaderText="IdDescFrecuencia"
                                            SortExpression="IdDescFrecuencia" Visible="False" />
                                        <asp:BoundField DataField="DescripcionFicohsa" HeaderText="Desc. Frecuencia"
                                            SortExpression="DescripcionFicohsa" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="FqDesdeRO01_22" HeaderText="Frec. Desde RO01"
                                            SortExpression="FqDesdeRO01_22" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="FqHastaRO01_23" HeaderText="Frec. Hasta RO01"
                                            SortExpression="FqHastaRO01_23" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="80%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label6" runat="server" Text="Desc. Frecuencia:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlDescFrecuencia" runat="server" Width="300px"
                                    CssClass="Apariencia" DataSourceID="SqlDataSource3" OnDataBound="ddlDescFrecuencia_DataBound"
                                    DataTextField="DescripcionFicohsa" DataValueField="IdDescFrecuencia" AppendDataBoundItems="true">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFqDesdeRO01_22" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                            ...
                            <td>
                                <asp:TextBox ID="txtFqHastaRO01_23" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iFrecuencia" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iFrecuencia" />
                                        </td>
                                        <td>
