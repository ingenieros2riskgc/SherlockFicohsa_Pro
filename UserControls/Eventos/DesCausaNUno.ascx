<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DesCausaNUno.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DesCausaNUno" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DesCausaNUno] WHERE IdDesCausaNUno = @IdDesCausaNUno"
    InsertCommand="INSERT INTO [Eventos].[DesCausaNUno] ([Descripcion] ,[IdTipoRiesgo] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Descripcion, @IdTipoRiesgo,@IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDesCausaNUno] ,[Descripcion] ,[DesCausaNUno].[IdUsuario] ,[DesCausaNUno].[FechaRegistro] , [Usuario], [TipoRiesgo],[TipoRiesgo].[IdTipoRiesgo]  FROM [Eventos].[DesCausaNUno], [Listas].[Usuarios], [Eventos].[TipoRiesgo] WHERE [DesCausaNUno].[IdUsuario] = [Usuarios].[idUsuario] AND  [TipoRiesgo].IdTipoRiesgo = DesCausaNUno.IdTipoRiesgo"
    UpdateCommand="UPDATE [Eventos].[DesCausaNUno] SET [IdTipoRiesgo] = @IdTipoRiesgo, [Descripcion] = @Descripcion  WHERE IdDesCausaNUno = @IdDesCausaNUno">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center" style="margin-left: 24%;">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Descripción Causa Nivel 1" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDesCausaNUno,Usuario, IdTipoRiesgo" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDesCausaNUno" HeaderText="Descripcion" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDesCausaNUno" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TipoRiesgo" HeaderText="Tipo de Riesgo"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        <tr id="tra" runat="server" visible="true">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label5" runat="server" Text="Tipo riesgo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlTipoRiesgo" runat="server" Width="300px"
                                    CssClass="Apariencia" DataSourceID="SqlDataSource2" OnDataBound="ddlTipoRiesgo_DataBound"
                                    DataTextField="TipoRiesgo" DataValueField="IdTipoRiesgo" AppendDataBoundItems="true">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvLineaUno" runat="server" ControlToValidate="ddlTipoRiesgo"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDesCausaNUno" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDesCausaNUno" />
                                        </td>
                                        <td>
