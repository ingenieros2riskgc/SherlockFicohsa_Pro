<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CuentasPerdida.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.CuentasPerdida" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[CuentasPerdida] WHERE IdCuentas = @IdCuentas"
    InsertCommand="INSERT INTO [Eventos].[CuentasPerdida] ([Nombre], [Numero] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Nombre, @Numero, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdCuentas] ,[Nombre],[Numero],[CuentasPerdida].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[CuentasPerdida], [Listas].[Usuarios] WHERE [CuentasPerdida].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[CuentasPerdida] SET [Nombre] = @Nombre, [Numero] = @Numero  WHERE IdCuentas = @IdCuentas">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center" style="margin-left: 24%;">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Cuentas Contables de Pérdida" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdCuentas,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdCuentas" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdCuentas" Visible="True">
                                        ...
                                        <asp:BoundField DataField="Numero" HeaderText="Número"
                                            SortExpression="Numero" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label5" runat="server" Text="Número:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtNumero" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iCuentasPerdida" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iCuentasPerdida" />
                                        </td>
                                        <td>
