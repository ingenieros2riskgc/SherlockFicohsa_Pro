<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CodigoBanco.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.CodigoBanco" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[CodigoBanco] WHERE IdCodigoBanco = @IdCodigoBanco"
    InsertCommand="INSERT INTO [Eventos].[CodigoBanco] ([Codigo] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Codigo, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdCodigoBanco] ,[Codigo] ,[CodigoBanco].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[CodigoBanco], [Listas].[Usuarios] WHERE [CodigoBanco].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[CodigoBanco] SET [Codigo] = @Codigo  WHERE IdCodigoBanco = @IdCodigoBanco">
    <DeleteParameters>
        <asp:Parameter Name="IdCodigoBanco" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Código Banco" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdCodigoBanco,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdCodigoBanco" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdCodigoBanco" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Codigo" HeaderText="Código Banco"
                                            SortExpression="Codigo" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Codigo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCodigo" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iCodigoBanco" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iCodigoBanco" />
                                        </td>
                                        <td>
