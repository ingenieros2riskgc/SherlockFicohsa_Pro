<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Producto.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Producto" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[ProductoAfectado] WHERE IdProductoAfectado = @IdProductoAfectado"
    InsertCommand="INSERT INTO [Eventos].[ProductoAfectado] ([Producto] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Producto, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdProductoAfectado] ,[Producto] ,[ProductoAfectado].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[ProductoAfectado], [Listas].[Usuarios] WHERE [ProductoAfectado].[IdUsuario] = [Usuarios].[idUsuario] ORDER BY Producto"
    UpdateCommand="UPDATE [Eventos].[ProductoAfectado] SET [Producto] = @Producto  WHERE IdProductoAfectado = @IdProductoAfectado">
    <DeleteParameters>
        <asp:Parameter Name="IdProductoAfectado" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Producto" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdProductoAfectado,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdProductoAfectado" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdProductoAfectado" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Producto" HeaderText="Producto"
                                            SortExpression="Producto" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Producto:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtProducto" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iProductoAfectado" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iProductoAfectado" />
                                        </td>
                                        <td>
