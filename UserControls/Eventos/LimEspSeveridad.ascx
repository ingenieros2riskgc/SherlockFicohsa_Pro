<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LimEspSeveridad.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.LimEspSeveridad" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[MtEspSeveridad] WHERE IdMtEspSeveridad = @IdMtEspSeveridad"
    InsertCommand="INSERT INTO [Eventos].[MtEspSeveridad] ([IdDescSeveridad], [IdTipoRiesgo], [Minimo], [Maximo], [IdUsuario], [FechaRegistro]) VALUES (@IdDescSeveridad, @IdTipoRiesgo, @Minimo, @Maximo, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT EMF.IdMtEspSeveridad, ETR.IdTipoRiesgo, ETR.TipoRiesgo, EDF.IdDescSeveridad, EDF.DescripcionFicohsa, Minimo, Maximo, LU.Nombres AS Usuario, EMF.FechaRegistro FROM [Eventos].[MtEspSeveridad] EMF INNER JOIN Eventos.DescSeveridad  EDF ON EMF.IdDescSeveridad = EDF.IdDescSeveridad INNER JOIN Eventos.TipoRiesgo ETR ON ETR.IdTipoRiesgo = EMF.IdTipoRiesgo INNER JOIN [Listas].[Usuarios] LU ON LU.IdUsuario = EMF.IdUsuario ORDER BY TipoRiesgo, Minimo"
    UpdateCommand="UPDATE [Eventos].[MtEspSeveridad] SET [IdDescSeveridad] = @IdDescSeveridad, [IdTipoRiesgo] = @IdTipoRiesgo, [Minimo] = @Minimo, [Maximo] = @Maximo  WHERE IdMtEspSeveridad = @IdMtEspSeveridad">
    <DeleteParameters>
        <asp:Parameter Name="IdMtEspSeveridad" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="Minimo" Type="String" />
        <asp:Parameter Name="Maximo" Type="String" />
        <asp:Parameter Name="IdDescSeveridad" Type="Int32" />
        <asp:Parameter Name="IdTipoRiesgo" Type="Int32" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Límites Específicos Severidad" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdMtEspSeveridad, IdTipoRiesgo, IdDescSeveridad, Minimo, Maximo" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdMtEspSeveridad" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdMtEspSeveridad" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TipoRiesgo" HeaderText="Tipo Riesgo"
                                            SortExpression="TipoRiesgo" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DescripcionFicohsa" HeaderText="Severidad"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Tipo de Riesgo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlTipoRiesgo" runat="server" Width="306px" CssClass="Apariencia" DataSourceID="SqlDataSource2" 
                                    DataTextField="TipoRiesgo" DataValueField="IdTipoRiesgo" AppendDataBoundItems="true"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label5" runat="server" Text="Severidad:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlSeveridad" runat="server" Width="306px" CssClass="Apariencia" DataSourceID="SqlDataSource3"
                                    DataTextField="DescripcionFicohsa" DataValueField="IdDescSeveridad" AppendDataBoundItems="true"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
