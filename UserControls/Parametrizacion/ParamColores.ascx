                    ...
                    <table align="center" width="200px" >
                        ...
                        <tr>
                            ...
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Valor Mínimo" Font-Size="Small" Font-Names="Calibri"
                                    style="color:black"></asp:Label>
                            </td>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Valor Máximo" Font-Size="Small" Font-Names="Calibri"
                                    style="color:black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="Green">
                                <asp:Label ID="Label5" runat="server" Text="Verde:" Font-Size="Small" Font-Names="Calibri"
                                    style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="Yellow">
                                <asp:Label ID="Label1" runat="server" Text="Amarillo:" Font-Size="Small" Font-Names="Calibri"
                                    style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="Red">
                                <asp:Label ID="Label4" runat="server" Text="Rojo:" Font-Size="Small" Font-Names="Calibri"
                                    style="color:black"></asp:Label>
                            </td>
                            <td class="style2">
