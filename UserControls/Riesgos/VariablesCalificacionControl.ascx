                    ...
                    <td>
                        <asp:GridView ID="GVvariablesCalificacionControl" runat="server" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Descripción Variable" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:ImageButton ID="IBinsertGVC" runat="server" CausesValidation="true" CommandName="Insert"
                                ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Insert" ValidationGroup="vgVariableControl" ToolTip="Insertar" Visible="false" OnClick="IBinsertGVC_Click" />
                            <asp:ImageButton ID="IBupdateGVC" runat="server" CausesValidation="true" CommandName="Update"
                                ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Update" ValidationGroup="vgVariableControl" ToolTip="Actualizar" Visible="false" OnClick="IBupdateGVC_Click" />
