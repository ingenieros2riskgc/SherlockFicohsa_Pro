                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GVRiesgos" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="intIdEstado" HeaderText="Código" SortExpression="intIdEstado" 
                                            ItemStyle-HorizontalAlign="Center" visible="true"/>
                                        <asp:TemplateField HeaderText="Nombre Estado" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:ImageButton ID="IBinsertGVC" runat="server" CausesValidation="true" CommandName="Insert"
                                    ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Insert" ValidationGroup="VGtratamiento" OnClick="IBinsertGVC_Click" ToolTip="Insertar" Visible="false" />
            <asp:ImageButton ID="IBupdateGVC" runat="server" CausesValidation="true" CommandName="Update"
                                    ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Update" ValidationGroup="VGtratamiento" ToolTip="Actualizar" Visible="false" OnClick="IBupdateGVC_Click" />
