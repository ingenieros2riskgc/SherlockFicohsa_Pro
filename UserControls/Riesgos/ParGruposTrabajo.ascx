                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Código Grupo" DataField="IdGrupoTrabajo" visible="false">
                                ...
                                <table>
                                    ...
                                    <tr align="right">
                                        <td>
                                            ...
                                            <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/Imagenes/Icons/AddV5.png"
