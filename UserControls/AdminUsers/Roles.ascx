            ...
            <table>
                <tr align="center">
                    <td bgcolor="#BBBBBB" align="center">
                        <asp:Label ID="Label2" runat="server" Text="Rol" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                    </td>
                    <td bgcolor="#f0eef0">
                ...
                <tr align="center">
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField HeaderText="Módulo" DataField="NombreModulo" />
                                <asp:BoundField HeaderText="Sub-Módulo" DataField="NombreSubModulo" />
...
<asp:ModalPopupExtender ID="mpeMsgBox2" runat="server" TargetControlID="btndummy"
    PopupControlID="pnlMsgBox2" OkControlID="btnAceptar" BackgroundCssClass="FondoAplicacion"
    Enabled="True" DropShadow="true">
</asp:ModalPopupExtender>
    ...
    <table width="100%">
        <tr class="topHandle" style="background-color: #5D7B9D">
            <td colspan="2" align="center" runat="server" id="td1">
                &nbsp;
                <asp:Label ID="Label3" runat="server" Text="Atención" Font-Names="Calibri" Font-Size="Small"></asp:Label><br />
            </td>
        </tr>
        <tr>
            <td style="width: 60px" valign="middle" align="center">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Imagenes/Icons/icontexto-webdev-ok.png" />
            </td>
            <td valign="middle" align="left">
                <asp:Label ID="lblMsgBox2" runat="server" Font-Names="Calibri" Font-Size="Small" ForeColor="Black"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right" colspan="2">
                <asp:Button ID="Button1" runat="server" Text="Ok" Font-Names="Calibri" Font-Size="Small" />
            </td>
        </tr>
    </table>
</asp:Panel>