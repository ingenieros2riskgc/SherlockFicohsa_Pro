    ...
    <ContentTemplate>
        ...
        <div id="divFiltrosBusqueda" class="ColumnStyle" runat="server" >
            <div style="text-align: center; color:black; font-size:15px" >
                <table align="center" >
               <caption style="color:black; font-size:15px; width:200px">
                    Filtros de búsqueda 
                </caption>
                    </table>
            </div>
                ...
                <table class="tabla" align="center" width="80%">
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:ImageButton ID="btnBusquedaFiltro" runat="server" ImageUrl="~/Imagenes/Icons/lupa.png" ToolTip="Buscar" OnClick="btnBusquedaFiltro_Click" />
        ...
        <div id="BodyFormCDV" class="ColumnStyle" runat="server" visible="false">
            <div id="form" class="TableContains">
                <table class="tabla" align="center" width="80%">
                    ...
                    <tr id="trEstadoDocumento" runat="server" visible="false" align="center">
                        <td class="RowsText">
                    ...
                    <tr>
                        <td class="RowsText" align="center">
                            <asp:Label ID="Label79" runat="server" Text="Cargar documento:" Font-Names="Calibri" style="color:black"
                                Font-Size="Small"></asp:Label>
                        </td>
                        <td>
        ...
        <div id="DVVersiones" runat="server" visible="false" class="ColumnStyle" >
            <div id="DVtable" class="center-content" align="left">
                <table class="tabla" >
                    <tr align="center">
                        <td >
                            <div style="overflow-x:auto;width:900px" >
                                ...
                                <Columns>
                                    ...
                                    <ItemTemplate>
                                        <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 60px" align="center">
                                    ...
                                    <asp:TemplateField HeaderText="Fecha Eliminación" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 70px">
                                    ...
                                    <asp:TemplateField HeaderText="Justificación" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
                                    ...
                                    <asp:TemplateField HeaderText="Justificación Aprobación" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
