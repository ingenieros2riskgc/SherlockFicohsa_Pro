                    ...
                    <td colspan="2">
                        <asp:GridView ID="GVfactorDesempeño" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Descr. Detalle" HeaderStyle-HorizontalAlign="Center"  ItemStyle-Wrap="true">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis;white-space: normal; ">
                                                    <asp:Label ID="Descripcion" runat="server" Text='<% # Bind("strDescripcion")%>' Width="250px" style="word-break:break-all; word-wrap:break-word;"></asp:Label>
                                                </div>
                                            </ItemTemplate>
            ...
            <asp:GridView ID="GVfactoresDesempeño" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Puntaje Asignado" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <div style="overflow: visible; text-overflow: ellipsis; white-space: nowrap; width: 170px">
                                                    <asp:TextBox ID="TXpuntajeAsignado" DataField="strPuntaje" runat="server" Enabled="false"></asp:TextBox> 
                ...
                <tr id="trTituloTotal" runat="server" visible="false">
                    <td colspan ="4">
                        <asp:Label ID="LprocessText" runat="server" Text="Para procesar los datos has click en el botón:" ForeColor="Black"></asp:Label>
                    </td>
                </tr>
                ...
                <tr runat="server" id="TRcancel">
                    <td colspan="4">
                        <asp:Label ID="LcancelProcess" runat="server" Text="Para cancelar has click en el botón:" ForeColor="Black"></asp:Label>
                    </td>
                    </tr>
                ...
                <tr id="trTotal" runat="server" visible="false">
                    ...
                    <td>
                        <asp:Label ID="LvalorFinalCalificacion" runat="server" ForeColor="Black"></asp:Label>
                        </td>
                </tr>
                </Table>
        </div>
            ...
            <div id="FormRecomendacion" class="TableContains">
                <Table class="controlRecomendacion" align="center" width="80%">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDLrecomendacion" runat="server" OnSelectedIndexChanged="DDLrecomendacion_SelectedIndexChanged" 
                                    AutoPostBack="True" CssClass="Apariencia">
                    ...
                    <tr id="trEspecifique" runat="server" visible="false">
                            ...
                            <td>
                                <asp:TextBox ID="TXespecifique" runat="server" Width="80%" MaxLength="850" CssClass="Apariencia"></asp:TextBox>
                            </td>
                        </tr>
                    <tr>
                        <td class="RowsText">
                        ...
                        <td>
                            <asp:TextBox ID="TXcompromisos" runat="server" TextMode="MultiLine" Wrap="false" Width="80%" CssClass="Apariencia"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                            <td class="RowsText">
