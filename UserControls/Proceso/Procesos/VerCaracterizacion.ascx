    ...
    <ContentTemplate>
                    ...
                    <tr id="Proceso">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlProceso" runat="server" Width="300px"
                                ...
                                OnSelectedIndexChanged="ddlProceso_SelectedIndexChanged">
                            </asp:DropDownList><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlProceso"
        ...
        <div id="Dbutton" runat="server" visible="false" class="ColumnStyle">
            <table id="Tbuttons" class="tabla" align="center" width="25%">
                <tr align="center">
                    <td style="color:black">Para exportar a PDF:
                    </td>
                    <td>
        ...
        <div id="GridVC" runat="server" visible="false" class="ColumnStyle" align="left" style="font-size:15px; width:900px">
            ...
            <asp:GridView ID="GVheader" runat="server" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre Proceso" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="strnombreProceso" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strnombreProceso")%>' ToolTip='<% # Bind("strnombreProceso")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Objetivo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="strObjetivo" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strObjetivo")%>' ToolTip='<% # Bind("strObjetivo")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Nombre Responsable" ItemStyle-CssClass="no-visible" HeaderStyle-CssClass="no-visible">
                        <ItemTemplate>
                            <asp:Label ID="strNombreResponsable" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("NombreResponsable")%>' ToolTip='<% # Bind("NombreResponsable")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
        ...
        <div id="GridVCdetalle" runat="server" visible="false" class="ColumnStyle" style="font-size:15px; width:900px">
           <%--  <asp:GridView ID="GVVCdetalle" runat="server" CellPadding="4"
                ...
                <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                        ...
                        <div class="ColumnStyle" style="font-size:15px; width:900px">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Descripción Entrada" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="strDescripcionEntrada" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strDescripcionEntrada")%>' ToolTip='<% # Bind("strDescripcionEntrada")%>'></asp:Label>
                        </ItemTemplate>
                        <%--<HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />--%>
                        <HeaderStyle Wrap="false" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" />
                    ...
                    <asp:TemplateField HeaderText="Proveedor" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="strProveedor" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strProveedor")%>' ToolTip='<% # Bind("strProveedor")%>'></asp:Label>
                        </ItemTemplate>
                       <%-- <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />--%>
                        <HeaderStyle Wrap="false" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Descripción Actividad" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="strDescripcionActividad" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strDescripcionActividad")%>' ToolTip='<% # Bind("strDescripcionActividad")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" Width="150" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Descripción PHVA" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
                                <asp:Label ID="strDescripcionPHVA" runat="server" Width="150px" Text='<% # Bind("strDescripcionPHVA")%>' ToolTip='<% # Bind("strDescripcionPHVA")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" Width="150" />
                    ...
                    <asp:TemplateField HeaderText="Cargo Responsable" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="strCargoResponsable" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strCargoResponsable")%>' ToolTip='<% # Bind("strCargoResponsable")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" Width="150" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Descripción Procedimiento" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
                                <asp:Label ID="strDescripcionProcedimiento" runat="server" Width="150px" Text='<% # Bind("strDescripcionProcedimiento")%>' ToolTip='<% # Bind("strDescripcionProcedimiento")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" Width="150" />
...
<div class="ColumnStyle" style="font-size:15px; width:900px">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Descripción Salida" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="strDescripcionSalida" runat="server" Width="150px" CssClass="ellipsis" Text='<% # Bind("strDescripcionSalida")%>' ToolTip='<% # Bind("strDescripcionSalida")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" Width="150" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Cliente" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
                                <asp:Label ID="strCliente" runat="server" Width="150px" Text='<% # Bind("strCliente")%>' ToolTip='<% # Bind("strCliente")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" Width="150" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" Width="150" />
        ...
        <div id="divCamposCaracterizacion" runat="server" visible="true" class="ColumnStyle" style="font-size:15px; width:900px">
            <asp:GridView ID="gvCamposCaracterizacion" runat="server" CellPadding="4" AutoGenerateColumns="false"
                ForeColor="#333333" AllowSorting="True" ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Both"
        ...
        <div id="divDocumentos" class="ColumnStyle" runat="server" visible="true" style="font-size:15px; width:900px">
        ...
        <div id="DindicadorRiesgo" runat="server" visible="false" class="ColumnStyle" style="font-size:15px; width:900px">
        ...
        <div id="Driesgos" runat="server" visible="false" class="ColumnStyle" style="font-size:15px; width:900px">
            ...
            <asp:GridView ID="GVindicadorRiesgoPrint" runat="server" CellPadding="4"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Nombre Indicador" ItemStyle-HorizontalAlign="center">
                        <ItemTemplate>
                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                <asp:Label ID="strNombreIndicador" runat="server" Text='<% # Bind("strNombreIndicador")%>' ToolTip='<% # Bind("strNombreIndicador")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                        <HeaderStyle Wrap="false" HorizontalAlign="center" />
                        <ItemStyle Wrap="false" />
