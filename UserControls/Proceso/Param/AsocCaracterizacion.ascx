            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr id="Macroproceso">
                            <td class="leftBBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Macroproceso:" CssClass="Apariencia"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlMacroproceso" runat="server" Width="300px" CssClass="Apariencia" AutoPostBack="True"
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlMacroproceso"
                        ...
                        <tr id="Proceso">
                            <td class="leftBBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Proceso:" CssClass="Apariencia"></asp:Label></td>
                            <td>
                                <asp:DropDownList ID="ddlProceso" runat="server" Width="300px" CssClass="Apariencia" AutoPostBack="True"
                                    DataTextField="NombreProceso" DataValueField="IdProceso">
                                </asp:DropDownList>
