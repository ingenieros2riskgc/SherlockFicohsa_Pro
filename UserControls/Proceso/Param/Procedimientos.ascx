                    ...
                    <table class="tabla" width="900px">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:ImageButton ID="imgBtnActividad" runat="server" OnClick="ImageButton25_Click"
                        ...
                        <tr align="center">
                            <td colspan="2">
                                <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                    CellPadding="4" Font-Names="Calibri" Font-Size="Small" ForeColor="#333333" OnRowCommand="GridView8_RowCommand"
                                    GridLines="Vertical" AllowPaging="True" AllowSorting="True" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" 
                                    DataKeyNames="Id" OnPageIndexChanging="GridView8_PageIndexChanging">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
                                        <Columns>
                                            <asp:BoundField DataField="Id" HeaderText="Código" Visible="false"></asp:BoundField>
                                            <asp:BoundField DataField="Descripcion" HeaderText="Descripción">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="IdCargoResponsable" HeaderText="Id Responsable" Visible="false"></asp:BoundField>
                                            <asp:BoundField DataField="CargoResponsable" HeaderText="Responsable" Visible="false"></asp:BoundField>
                                            <asp:BoundField DataField="IdUsuario" HeaderText="Id Usuario" Visible="false"></asp:BoundField>
                                            <asp:BoundField DataField="NombreUsuario" HeaderText="Usuario" Visible="false"></asp:BoundField>
                                            <asp:BoundField DataField="FechaRegistro" HeaderText="Fecha Registro" Visible="false"></asp:BoundField>
                        ...
                        <caption>
                            ...
                            <caption>
                                ...
                                <caption>
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label6" runat="server" CssClass="Apariencia" Text="Descripción:"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbxDescripcion" runat="server" Columns="100" CssClass="Apariencia" Font-Bold="False" Font-Size="10pt" Height="42px" MaxLength="1100" Rows="4" TextMode="MultiLine" Width="800px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="tbxDescripcion" ErrorMessage="Debe ingresar la descripción." ForeColor="Red" ToolTip="Debe ingresar la descripción." ValidationGroup="iProcedimiento">*</asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="rfvDescLen" runat="server" ControlToValidate="tbxDescripcion" Display="Dynamic" ErrorMessage="La longitud máxima es 1100 caracteres" ForeColor="Red" ToolTip="La longitud máxima es 1100 caracteres" ValidationExpression="^[\s\S]{0,1100}$" ValidationGroup="iProcedimiento">*</asp:RegularExpressionValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label2" runat="server" CssClass="Apariencia" Text="Estado:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label4" runat="server" CssClass="Apariencia" Text="Usuario Creación:"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbxUsuarioCreacion" runat="server" CssClass="Apariencia" Enabled="False" Width="100px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label5" runat="server" CssClass="Apariencia" Text="Fecha de Creación:"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbxFecha" runat="server" CssClass="Apariencia" Enabled="False" Width="100px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr align="center">
                                        <td colspan="2">
                                            <table class="tablaSinBordes">
                                                <tr>
                                                    <td>
                                                        <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iProcedimiento" Visible="False" />
                                                    </td>
                                                    <td>
                                                        <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="btnImgActualizar_Click" Style="text-align: right" ToolTip="Guardar" ValidationGroup="iProcedimiento" />
                                                    </td>
                                                    <td>
