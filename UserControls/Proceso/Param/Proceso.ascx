            ...
            <table width="100%">
                ...
                <tr>
                    <td style="width: 60px" valign="middle" align="center">
                        <asp:Image ID="imgInfo" runat="server" ImageUrl="~/Imagenes/Icons/icontexto-webdev-alert.png" />
                    </td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4"
                                    ...
                                    OnRowCommand="GridView1_RowCommand" HeaderStyle-HorizontalAlign="Center"
                                    DataKeyNames="intIdMacroProceso,intIdUsuario,strDescripcion,strObjetivo,
                                    IdEmpresa,intCargoResponsable,strCargoResponsable,strArea" OnPageIndexChanging="GridView1_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/editV5.png" Text="Modificar" HeaderText="Modificar"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label15" runat="server" Text="Empresa:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label14" runat="server" Text="Cadena de Valor:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label7" runat="server" Text="Macroproceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label6" runat="server" Text="Nombre Proceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label11" runat="server" Text="Responsable:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB" class="auto-style1">
                                <asp:Label ID="Label16" runat="server" Text="Area:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label8" runat="server" Text="Estado:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
