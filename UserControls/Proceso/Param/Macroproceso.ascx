                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="intId" HeaderText="Código" SortExpression="intId" ItemStyle-CssClass="no-visible" 
                                            HeaderStyle-CssClass="no-visible" visible="false">
                                        ...
                                        <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/editV5.png" Text="Modificar" HeaderText="Modificar" CommandName="Modificar" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/selectV5.png" Text="Ver" HeaderText="Ver" CommandName="Ver" ItemStyle-HorizontalAlign="Center" />
                                    </Columns>
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label8" runat="server" Text="Cadena de Valor:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label5" runat="server" Text="Descripción:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Objetivo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Responsable:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label7" runat="server" Text="Estado:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label9" runat="server" Text="Usuario Creación:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
            ...
            <tr align="left" id="filaConsulta" runat="server" visible="false">
                <td>
                    <table id="TablaConsulta" runat="server" align="center" width="80%">
                        <tr id="Titulo" align="center" bgcolor="#002649" runat="server">
                            <td>
                        ...
                        <tr align="left" id="Cabecera" runat="server">
                            <td bgcolor="#f0eef0">
                                <table class="tabla" runat="server">
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="lblTitCV" runat="server" Text="Cadena Valor:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label11" runat="server" Text="Macroproceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr id="Proceso" runat="server">
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="lblProceso" runat="server" Text="Proceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr id="SubProceso" runat="server">
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="lblSubproceso" runat="server" Text="Sub-Proceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label15" runat="server" Text="Descripción:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label16" runat="server" Text="Objetivo:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label17" runat="server" Text="Cargo:" CssClass="Apariencia" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr align="left" id="Detalles" runat="server">
                            <td bgcolor="#f0eef0">
                                <table class="tabla">
                                    <tr>
                                        <td>
                                            <asp:TabContainer ID="TabDetalles" runat="server" ActiveTabIndex="4" Font-Names="Calibri"
                        ...
                        <tr align="center">
                            <td>
                                <asp:ImageButton ID="btnCancelarConsultar" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
