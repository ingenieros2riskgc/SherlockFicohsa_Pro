...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            <tr id="trTitulo" class="center002649">
                <td>
            ...
            <tr id="trTituloAspectos" class="center002649" visible="false" runat="server">
                <td>
            ...
            <tr id="trTituloCriterios" class="center002649" visible="false" runat="server">
                <td>
            ...
            <tr id="BotonRegresarCriterios" runat="server" class="centertdtr" visible="false">
                <td style="background: #EEEEEE">
                    <asp:ImageButton ID="btnRegresarAspectos" runat="server" CausesValidation="False" CommandName="Back"
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Aspectos" OnClick="btnRegresarAspectos_Click" ToolTip="Regresar a Aspectos" />
                </td>
            </tr>

            <tr id="trTituloParametros" class="center002649" visible="false" runat="server">
                <td>
            ...
            <tr id="BotonRegresarParametros" runat="server" class="centertdtr" visible="false">
                <td style="background: #EEEEEE">
                    <asp:ImageButton ID="btnRegresarCriterios" runat="server" CausesValidation="False" CommandName="Back"
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Criterios" OnClick="btnRegresarCriterios_Click" ToolTip="Regresar a Criterios" />
                </td>
            </tr>
        </table>
                    </div>
