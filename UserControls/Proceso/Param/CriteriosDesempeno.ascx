...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            ...
            <tr id="trTituloDesempeno" class="center002649" visible="false" runat="server">
                <td>
            ...
            <tr id="trTituloDetallesFact" class="center002649" visible="false" runat="server">
                <td>
            ...
            <tr id="BotonRegresar" runat="server" class="centertdtr" visible="false">
                <td style="background: #EEEEEE">
                    <asp:ImageButton ID="btnRegresarFactor" runat="server" CausesValidation="False" CommandName="Back"
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Factores de desempeño" OnClick="btnRegresarFactor_Click" ToolTip="Regresar a Factores de desempeño" />
                </td>
            </tr>
        </table>
                    </div>
