    ...
    <ContentTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="DropDownListPE" runat="server" Font-Names="Calibri" Font-Size="Small"
                                                            Height="25px" Width="430px" AutoPostBack="True" CssClass="DropDownStyle"
                                                            OnSelectedIndexChanged="DropDownListPE_SelectedIndexChanged">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td id="Td1" align="center" width="50%" runat="server">
                                                                    ...
                                                                    <asp:Chart ID="Chart2" runat="server" BorderlineColor="DarkBlue" DataSourceID="SqlDataSource1"
                                                                        Height="276px" Palette="None" Width="408px" BackColor="White" BorderlineDashStyle="Solid">
                                                                        <Series>
                                                                            <asp:Series  ChartType="StackedColumn"
                                                                                Color="57, 160, 245" Legend="Legend1" Name="Meta" XValueMember="Periodo" YValueMembers="Meta"
                                                                            ...
                                                                            <asp:Series BackImageAlignment="Top" BorderColor="White" BorderWidth="2" ChartArea="ChartArea1"
                                                                                ChartType="Spline" Color="Orange" IsValueShownAsLabel="True" LabelToolTip="Resultado: #VAL"
                                                                        ...
                                                                        <Legends>
                                                                            <asp:Legend Alignment="Center" BackColor="Transparent" Docking="Bottom" Font="Calibri, 9.75pt"
        ...
        <asp:Panel ID="pnlMsgBox1" runat="server" Width="400px" Style="display: none;" BorderColor="#575757"
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="width: 60px" valign="middle" align="center">
                        <asp:Image ID="imgInfo1" runat="server" ImageUrl="~/Imagenes/Icons/icontexto-webdev-alert.png" />
                    </td>
                    <td valign="middle" align="left">
