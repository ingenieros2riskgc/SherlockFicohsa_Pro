...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="content">
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        <LocalReport ReportPath="Reportes\RptObjetivosVrsRiesgos.rdlc">
                            <DataSources>
                                ...
                                <rsweb:ReportDataSource DataSourceId="SqlDataSourceReporteRiesgosvsObjetivos" Name="DataSetReporteRiesgosvsObjetivos" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceReporteRiesgosvsObjetivos" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
                        SelectCommand="Gestion.ReporteRiesgosvsObjetivos" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextBox8" DefaultValue="PE0" Name="CodigoPlan_Par" PropertyName="Text"
                                Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
        ...
        <asp:Panel ID="pnlMsgBox" runat="server" Width="400px" Style="display: none;" BorderColor="#575757"
            BackColor="#002649" BorderStyle="Solid">
            <table width="100%">
