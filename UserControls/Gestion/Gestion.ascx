            ...
            <tr>
                <td>
                    <table id="TbIndicadores" runat="server" align="center" visible="false">
                                ...
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image" CommandName="SelecPAI" HeaderText="Planes Acción"
                                            ImageUrl="~/Imagenes/Icons/Gears.png" Text="Planes de Acción" FooterStyle-HorizontalAlign="Center">
                                            <FooterStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                    </Columns>
                        ...
                        <tr align="center">
                            <td>
                                <asp:ImageButton ID="CerrarIndicadores" runat="server" ImageUrl="~/Imagenes/Icons/Backv5.png"
            ...
            <tr>
                <td>
                    <table id="TbVariables" runat="server" align="center" visible="false">
                        ...
                        <tr align="center">
                            <td>
                                <asp:ImageButton ID="CerrarVariables" runat="server" ImageUrl="~/Imagenes/Icons/Backv5.png"
