                    ...
                    <table align="center">
                        <tr>
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label16" runat="server" Text="Fecha desde" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                            ...
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label17" runat="server" Text="Fecha hasta" Font-Names="Calibri" Font-Size="Small"
