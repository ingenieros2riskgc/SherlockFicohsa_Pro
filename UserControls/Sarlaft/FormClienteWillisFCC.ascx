        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                ...
                <td align="left">
                    ...
                    <asp:Label ID="lbl2" runat="server" ForeColor="White" Text=" Buscar Formularios" Font-Bold="False"
                        Font-Names="Calibri" Font-Size="Large" Width="1100px"></asp:Label>
                </td>
            </tr>
        </table>
            </div>
            <div>
                <div>
                    <table align="center">
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" Text="Tipo Identificación" Font-Names="Arial" Font-Bold="false" Font-Size="Small" ForeColor="Black"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Número de Documento" Font-Names="Arial" Font-Bold="false" Font-Size="Small" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:DropDownList ID="DDLTipoIden" runat="server" Font-Names="Arial" Font-Size="Small" DataSourceID="SqlDataSource_TipoIden" DataTextField="Descripcion" DataValueField="IdTipoDoc" Width="300px" Height="30px"></asp:DropDownList>
                        ...
                        <tr>
                            <td>
                                <asp:DropDownList ID="DDLTipoPersona" runat="server" Font-Names="Arial" Font-Size="Small" DataSourceID="SqlDataSource_TipoPersona" DataTextField="Descripcion" DataValueField="IdTipoPersona" Width="300px" Height="30px"></asp:DropDownList>
                            ...
                            <td>
                                <asp:ImageButton ID="ImgBtnBuscar" runat="server" ImageUrl="~/Imagenes/Icons/BuscarWillis1.png" ValidationGroup="BuscarWillis" OnClick="ImgBtnBuscar_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <asp:Label ID="lblMsgBox" runat="server" Font-Names="Arial" Font-Size="Small" Font-Bold="false" style="color:#000000"></asp:Label>
                    </td>
                </tr>
                <tr>
