                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image" Text="Aprobar" CommandName="Modificar" HeaderText="Aprobar" ImageUrl="~/Imagenes/Icons/Checkv5.png" >
                                        ...
                                        <asp:ButtonField ButtonType="Image" Text="Consultar" CommandName="Consultar" HeaderText="Consultar" ImageUrl="~/Imagenes/Icons/lupa.png" >
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                    </Columns>
