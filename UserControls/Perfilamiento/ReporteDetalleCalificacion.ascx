            ...
            <tr align="center">
                <td class="style1">
                    <table>
                        ...
                        <tr>
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="lArchivo" runat="server" Text="Archivo:" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlArchivo" runat="server" CssClass="Apariencia"></asp:DropDownList>
