                    ...
                    <table>
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label4" runat="server" Text="Nro. Identificación:" Font-Names="Calibri" style="color:black"
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label2" runat="server" Text="Fecha final:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
