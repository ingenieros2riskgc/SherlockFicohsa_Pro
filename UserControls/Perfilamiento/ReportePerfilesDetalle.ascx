            ...
            <tr align="center">
                <td class="style1">
                    <table>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Fecha inicial:" Font-Names="Calibri" style="color:black"
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label5" runat="server" Text="Filtro Dinámico 1:" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
                                                ...
                                                <tr align="left">
                                                    <td colspan="3">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblDesdeFD1" runat="server" Text="Desde:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblHastaFD1" runat="server" Text="Hasta:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="Td3" runat="server" valign="top" align="left">
                                            <table>
                                                <tr align="left">
                                                    <td>
                                                        <asp:Label ID="lblOtroValorFD2" runat="server" Text="Otro Valor:" Font-Names="Calibri" style="color:black"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr align="left">
                                                    <td colspan="3">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblDesdeFD2" runat="server" Text="Desde:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblHastaFD2" runat="server" Text="Hasta:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <td runat="server" valign="top" align="left">
                                            <table>
                                                <tr align="left">
                                                    <td>
                                                        <asp:Label ID="lblOtroValorFD3" runat="server" Text="Otro Valor:" Font-Names="Calibri" style="color:black"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr align="left">
                                                    <td colspan="3">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblDesdeFD3" runat="server" Text="Desde:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblHastaFD3" runat="server" Text="Hasta:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
