                    ...
                    <table>
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label5" runat="server" Text="Fecha Inicial" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Fecha Final" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                                            ...
                                            <asp:GridView ID="gvSenal" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ButtonField ButtonType="Image" CommandName="Analizar" HeaderText="Analizar"
                                                        ImageUrl="~/Imagenes/Icons/lupa.png" Text="Analizar">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:ButtonField>
