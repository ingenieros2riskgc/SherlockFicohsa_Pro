    ...
    <table width="100%">
        ...
        <tr>
            <td style="width: 60px" valign="middle" align="center">
                <asp:Image ID="imgInfo" runat="server" ImageUrl="~/Imagenes/Icons/icontexto-webdev-aboutV5.png" />
            </td>
            <td valign="middle" align="left">
                <asp:Label ID="lblMessage" runat="server" Font-Names="Tahoma" Font-Size="11px" Font-Bold="False" ForeColor="Black"></asp:Label>
            </td>
        </tr>
        <tr>
