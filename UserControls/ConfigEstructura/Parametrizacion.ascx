                            ...
                            <td>
                                <asp:Panel ID="Panel1" runat="server">
                                    <asp:GridView ID="gvParametrizacion" runat="server" CellPadding="4" EnableModelValidation="True"
                                        ForeColor="#333333" GridLines="Vertical" AutoGenerateColumns="False" AllowPaging="false" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <table id="updateUser" runat="server" visible="false">
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label3" runat="server" Text="Código Categoría" Font-Names="Calibri" style="color:black"
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label5" runat="server" Text="Nombre Categoría" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Nombre Variable" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label2" runat="server" Text="Calificación Categoría" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label4" runat="server" Text="Requiere Condición:" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                                        ...
                                        <td id="TdOtro" runat="server" valign="top" align="left">
                                            <table>
                                                <tr id="trOtroValor" align="left">
                                                    <td>
                                                        <asp:Label ID="lblOtroValor" runat="server" Text="Otro Valor:" Font-Names="Calibri" style="color:black"
                                                            Font-Size="Small"></asp:Label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr align="left">
                                                    <td colspan="3">
                                                        <table id="TblRango">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblDesde" runat="server" Text="Desde:" Font-Names="Calibri" Font-Size="Small"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblHasta" runat="server" Text="Hasta:" Font-Names="Calibri" Font-Size="Small"
                                                                        style="color:black"></asp:Label>
                                                                </td>
                                                                <td>
