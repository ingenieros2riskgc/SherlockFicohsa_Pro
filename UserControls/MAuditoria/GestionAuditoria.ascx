...
<%--SELECT [Enfoque].[IdEnfoque], [Enfoque].Descripcion 
...
<asp:SqlDataSource ID="SqlDataSource20" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    SelectCommand="SELECT * FROM [Auditoria].[Enfoque] 
INNER JOIN [Auditoria].[AudObjEnfoque] on [AudObjEnfoque].IdEnfoque = [Enfoque].IdEnfoque
WHERE ([AudObjEnfoque].[IdObjetivo] = @IdObjetivo and IdAuditoria = @IdAuditoria)">
    <SelectParameters>
        <asp:ControlParameter ControlID="txtCodAuditoriaSel" Name="IdAuditoria" PropertyName="Text"
            Type="Int64" />
        <asp:ControlParameter ControlID="txtCodObjetivoSel" Name="IdObjetivo" PropertyName="Text"
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div id="TreeDIV" runat="server">
            ...
            <asp:Label ID="txtIdArea" runat="server" Text="Label" Visible="False"></asp:Label>
        </div>
                            ...
                            <td>
                                <table class="tabla">
                                    ...
                                    <tr align="left">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNomEnfoqueSel" runat="server" CssClass="Apariencia" Width="400px"
                                                Enabled="false"></asp:TextBox>
                                           <%-- <asp:Label ID="" CssClass="Apariencia" runat="server" ForeColor="#666666"
                                    ...
                                    <tr align="left">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNomLiteralSel" runat="server" CssClass="Apariencia" Width="400px"
                                                Enabled="false"></asp:TextBox>
                                            <%--<asp:Label ID="" runat="server" CssClass="Apariencia" Width="402px"
                        ...
                        <tr align="center" id="trFiltroAud" runat="server" visible="false">
                            <td>
                                <table style="width:50%">
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="lblCodFiltro" runat="server" Text="Código" Font-Size="Small"></asp:Label>
                                        </td>
                                        <td align="center">
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="lblTemaFiltro" runat="server" Text="Tema" Font-Size="Small"></asp:Label>
                                        </td>
                                        <td align="center">
                    ...
                    <asp:ImageButton ID="imgBtn1" CssClass="SelectRow" runat="server" CausesValidation="false"
                        ...
                        <tr id="filaTabGestion" runat="server" bgcolor="#EEEEEE" visible="false">
                            <td>
                                ...
                                <br />
                                <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="2" AutoPostBack="True"
                        ...
                        <tr align="left" id="filaDetalleHallazgo" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                ...
                                <table class="tabla" width="100%">
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label76" runat="server"  Text="Código:" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCodHallazgo" runat="server"  Width="50px"
                                                Enabled="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label45" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Tipo de Hallazgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label15" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Nivel de Riesgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label51" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Hallazgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label52" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Comentario de la Administración:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label75" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Estado del Hallazgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label53" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Usuario:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label54" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Fecha de Creación:"></asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr align="center" id="filaDetalleRecomendacion" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                ...
                                <table class="tabla" width="100%" align="left">
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label79" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Código:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label80" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Dependencia Respuesta:"></asp:Label>
                                        </td>
                                        <td>
                                            <table class="tablaSinBordes">
                                                <tr>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label81" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Recomendación:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label84" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Usuario:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label85" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Fecha de Creación:"></asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr align="center" id="filaDetalleRiesgo" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                ...
                                <table bgcolor="#EEEEEE" class="tabla" width="100%">
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label83" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Código:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label102" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Tipo de Riesgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label92" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Nombre:"></asp:Label>
                                        </td>
                                        <td>
                                            <table>
                                                <tr>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label99" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Descripción:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label100" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Usuario:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label101" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Fecha de Creación:"></asp:Label>
                                        </td>
                                        <td>
                                ...
                                <table class="tabla" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label runat="server" ID="lblTextoTipo" 
                                                Font-Names="calibri" Font-Size="Small"
                                                Text="Seleccione el tipo de Adjunto:"></asp:Label>
                                        </td>
                                        <td align="center">
                                            <asp:DropDownList runat="server" ID="ddlTipoAdjunto" Width="200px" Font-Names="calibri" Font-Size="Small">
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label runat="server" ID="lblTextoUp" 
                                                Font-Names="calibri" Font-Size="Small"
                                                Text="Escoger el archivo a subir:"></asp:Label>
                                        </td>
                                        <td align="center">
                        ...
                        <tr id="filaEncabezado" runat="server" align="center" visible="false">
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlTitulos" Width="200px">
                                    ...
                                    <tr>
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="lblTtituloReporte" runat="server" 
