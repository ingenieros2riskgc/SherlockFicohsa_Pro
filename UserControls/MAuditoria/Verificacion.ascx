                ...
                <td runat="server">
                    <table id="TbConEventos" runat="server" visible="False" align="center">
                        ...
                        <tr align="center" id="filaMetodologia" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                <table bgcolor="#EEEEEE" class="tabla" width="75%">
                                    <tr align="center">
                                        <td>
                        ...
                        <tr align="center" id="filaDetalleHallazgo" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                ...
                                <table bgcolor="#EEEEEE" class="tabla" width="75%">
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label76" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Código:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label45" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Tipo de Hallazgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label19" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Nivel de Riesgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label51" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Hallazgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label52" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Comentario del Auditado:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label75" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Estado del Hallazgo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label53" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Usuario:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label54" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Small" Text="Fecha de Creación:"></asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr align="center" id="filaDetalleRecomendacion" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                <br />
                                <table class="tabla" align="center" width="75%">
                                    <tr align="center" bgcolor="#5D7B9D">
                                        <td colspan="2">
                                    ...
                                    <tr id="filaProcesoRec" runat="server" align="center">
