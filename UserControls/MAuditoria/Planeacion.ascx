                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                                ...
                                                AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <table width="100%" class="tabla">
                        <tr align="left">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label1" runat="server" Text="Código:" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Nombre:" Font-Names="Calibri" style="color:black"
                        ...
                        <tr align="left" runat="server" visible="false" id="TRjustificacion">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="lblJustificacion" runat="server" Text="Justificación:" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
                        ...
                        <tr align="left">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label13" runat="server" Text="Fecha Inicio:" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
                        ...
                        <tr align="left">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label14" runat="server" Text="Fecha Cierre:" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
