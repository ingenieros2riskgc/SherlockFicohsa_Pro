                        ...
                        <tr align="center" id="filaDetalleRecomendacion" runat="server" visible="false">
                            <td bgcolor="#f0eef0">
                                ...
                                <table class="tabla"
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label1" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Objetivo:"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="Label3" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Observación:"></asp:Label>
                                        </td>
                                        <td>
