        ...
        public DataTable loadRteTraza(string Mes, string Ano, string IdRegistro, string IdEstado)
        {
            ...
            try
            {
                ...
                string query = "SELECT RTRIM(a.Identificacion)Identificacion,RTRIM(a.NombreApellido)NombreApellido," + "\n" +
                    ...
                    "INNER JOIN Parametrizacion.DetalleJerarquiaOrg d ON a.IdUsuario = d.idHijo " + "\n" +
                    ...
                    "(MONTH(a.FechaRegistro) = '" + Mes + "' AND YEAR(a.FechaRegistro)= '" + Ano + "') OR (MONTH(a.FechaRegistro) = '" + Mes +
                    "' AND YEAR(a.FechaRegistro)= '" + Ano + "') " + cond + " ORDER BY a.Identificacion, e.FechaRegistro";
                cDataBase.conectar();
