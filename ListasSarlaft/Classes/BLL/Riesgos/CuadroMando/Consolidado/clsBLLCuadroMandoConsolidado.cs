...
namespace ListasSarlaft.Classes
{
    public class clsBLLCuadroMandoConsolidado
    {
        ...
        /// <param name="strErrMsg">Mensaje de error</param>
        /// <returns>Retorna si el proceso fue exitoso o no</returns>
        public bool mtdConsultarReporteNLKDashBoard(ref string strErrMsg, ref List<clsDTOCuadroMandoConsolidado> lstInfo, clsDTOCuadroMandoConsolidadoFiltros objFiltros)
        {
            bool booResult = false;
            DataTable dtInfo = new DataTable();
            try
            {
                ...
                dtInfo = cDALreporte.LoadInfoReporteNLKDashboard(ref strErrMsg, objFiltros);
            }
            catch (Exception ex)
            {
                strErrMsg = "Error en la consulta de datos: " + ex;
