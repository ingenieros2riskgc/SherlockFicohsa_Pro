...
namespace ListasSarlaft.Classes
{
    public class clsValorEvaluacionDesempeñoBLL
    {
        ...
        /// <param name="strErrMsg">Mensaje de error</param>
        /// <returns>Retorna si el proceso fue exitoso o no</returns>
        public bool mtdActualizarValorDetalleDesempeño(ref string nombreFactor, ref decimal valorPuntaje, ref int IdEvaluacionDesempeño, ref string strErrMsg)
        {
            bool booResult = false;
            clsDtValorEvaluacionDesempeño cDtDesempeño = new clsDtValorEvaluacionDesempeño();

            booResult = cDtDesempeño.mtdActualizarValorDetalleDesempeño(ref nombreFactor, ref valorPuntaje, ref IdEvaluacionDesempeño, ref strErrMsg);
        ...
        public bool mtdUpdateEvaluacionDesempeño(ref clsEvaluacionDesempeno objEvaluacionDesempeño, int IdEvaluacionDesempeño, ref string strErrMsg)
        {
            ...
            booResult = cDtDesempeño.mtdUpdateEvaluacionDesempeño(ref objEvaluacionDesempeño, IdEvaluacionDesempeño, ref strErrMsg);
