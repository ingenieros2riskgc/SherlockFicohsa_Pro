...
namespace ListasSarlaft.Classes
{
    public class clsDtMacroproceso
    {
        ...
        public DataTable mtdConsultarEstados(ref string strErrMsg)
        {
            #region Vars
            cDataBase cDataBase = new cDataBase();
            DataTable dtInformacion = new DataTable();
            ...
            {
                strErrMsg = string.Format("Error al consultar los estados. [{0}]", ex.Message);
            }
            finally
            {
                cDataBase.desconectar();
        ...
        public DataTable mtdConsultarRiesgoGlobal(ref string strErrMsg)
        {
            #region Vars
            cDataBase cDataBase = new cDataBase();
            DataTable dtInformacion = new DataTable();
            ...
            try
            {
                strConsulta = string.Format("select * from Eventos.RiesgoGlobal");
            ...
            {
                strErrMsg = string.Format("Error al consultar los riesgos globales. [{0}]", ex.Message);
            }
            finally
            {
                cDataBase.desconectar();
