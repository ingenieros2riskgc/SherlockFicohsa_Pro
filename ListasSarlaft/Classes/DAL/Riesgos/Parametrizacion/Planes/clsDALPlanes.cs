...
namespace ListasSarlaft.Classes.DAL.Riesgos.Parametrizacion.Planes
{
    public class clsDALPlanes
    {
        ...
        public DataTable ConsultarPlanes(ref clsDTOPlanes listaPlanes, int IdTransaccion, string estadoPlan)
        {
            #region Vars
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(listaPlanes.IdDependencia))
                {
                    listaPlanes.IdDependencia = string.Empty;
                }
                ...
                if (string.IsNullOrEmpty(listaPlanes.RiesgoGlobal))
                {
                    listaPlanes.RiesgoGlobal = string.Empty;
                }
                if (string.IsNullOrEmpty(listaPlanes.Estado))
                {
                    listaPlanes.Estado = string.Empty;
                }
                //listaPlanes.Estado = estadoPlan;
                ...
                if (listaPlanes.Periodo.ToString() == "01/01/0001 12:00:00 a. m." || listaPlanes.Periodo.ToString() == "1/01/0001 12:00:00 a. m." ||
                    listaPlanes.Periodo.ToString() == "1/1/0001 12:00:00 a. m." || listaPlanes.Periodo.ToString() == "0001-01-01 12:00:00 a. m.")
                {
                ...
                if (listaPlanes.FechaImplementacion.ToString() == "1/01/0001 12:00:00 a.m." || listaPlanes.FechaImplementacion.ToString() == "01/01/0001 12:00:00 a.m." ||
                    listaPlanes.FechaImplementacion.ToString() == "1/1/0001 12:00:00 a.m." || listaPlanes.FechaImplementacion.ToString() == "1/01/0001 12:00:00 a. m." ||
                    listaPlanes.FechaImplementacion.ToString() == "01/01/0001 12:00:00 a. m." || listaPlanes.FechaImplementacion.ToString() == "1/1/0001 12:00:00 a. m." ||
                    listaPlanes.FechaImplementacion.ToString() == "0001-01-01 12:00:00 a. m." || listaPlanes.FechaImplementacion.ToString() == "1/01/0001 12:00:00 a. m.")
                {
                    listaPlanes.FechaImplementacion = null;
                }

                if (listaPlanes.FechaExtension.ToString() == "1/01/0001 12:00:00 a.m." || listaPlanes.FechaExtension.ToString() == "01/01/0001 12:00:00 a.m." ||
                    listaPlanes.FechaExtension.ToString() == "1/1/0001 12:00:00 a.m." || listaPlanes.FechaExtension.ToString() == "1/01/0001 12:00:00 a. m." ||
                    listaPlanes.FechaExtension.ToString() == "01/01/0001 12:00:00 a. m." || listaPlanes.FechaExtension.ToString() == "1/1/0001 12:00:00 a. m." ||
                    listaPlanes.FechaExtension.ToString() == "0001-01-01 12:00:00 a. m." || listaPlanes.FechaExtension.ToString() == "1/01/0001 12:00:00 a. m.")
                {
                    listaPlanes.FechaExtension = null;
                }
                ...
                List<SqlParameter> parametros = new List<SqlParameter>()
                        {
                            ...
                            new SqlParameter() { ParameterName = "@IdResponsable", SqlDbType = SqlDbType.VarChar, Value =  listaPlanes.IdDependencia },
                            new SqlParameter() { ParameterName = "@IdClasificacionRiesgo", SqlDbType = SqlDbType.VarChar, Value =  listaPlanes.RiesgoGlobal },
                ...
                Dictionary<string, object> FechasNullable = new Dictionary<string, object>();

                FechasNullable.Add("@FechaCompromiso", listaPlanes.FechaCompromiso);
                FechasNullable.Add("@FechaImplementacion", listaPlanes.FechaImplementacion);
                FechasNullable.Add("@FechaExtension", listaPlanes.FechaExtension);

                SqlParameter sPFechaNullable = null;

                foreach (var fecha in FechasNullable)
                {
                    if (fecha.Value == null) { sPFechaNullable = new SqlParameter(fecha.Key, DBNull.Value); }
                    else { sPFechaNullable = new SqlParameter(fecha.Key, fecha.Value); }
                    sPFechaNullable.IsNullable = true;
                    sPFechaNullable.SqlDbType = SqlDbType.DateTime;
                    parametros.Add(sPFechaNullable);
                }
