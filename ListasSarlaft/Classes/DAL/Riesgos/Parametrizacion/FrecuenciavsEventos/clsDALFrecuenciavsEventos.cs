    ...
    public class clsDALFrecuenciavsEventos
    {
        public bool mtdInsertarFrecuenciavsEventos(clsDTOFrecuenciavsEventos objfrequencyEvents, ref string strErrMsg)
        {
            ...
            try
            {
                ...
                strConsulta = string.Format("INSERT INTO [Parametrizacion].[FrecuenciavsEventos] ([EventosMaximos],[CodigoFrecuencia]," +
                    "[NombreFrecuencia],[UsuarioCreacion],[FechaRegistro])" +
                    "VALUES({0},{1},'{2}',{3},GETDATE()) ",
                    objfrequencyEvents.intEventosMaximos, objfrequencyEvents.intCodigoFrecuencia, objfrequencyEvents.strNombreFrecuencia,
                    objfrequencyEvents.intIdUsuario, "GETDATE()"/*objfrequencyEvents.dtFechaRegistro*/);
