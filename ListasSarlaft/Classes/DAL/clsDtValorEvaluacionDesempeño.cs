...
namespace ListasSarlaft.Classes
{
    public class clsDtValorEvaluacionDesempeño
    {
        ...
        public bool mtdActualizarValorDetalleDesempeño(ref string nombreFactor, ref decimal valorFactor, ref int IdEvaluacionDesempeño, ref string strErrMsg)
        {
            #region Vars
            bool booResult = false;
            string strConsulta = string.Empty;
            ...
            try
            {
                strConsulta = string.Format("UPDATE [Procesos].[tblDetalleEvaluacionDesempeño] SET [valorFactor] = {1} " + "\n" +
                    "WHERE [nombreFactor] = '{0}' and [IdEvaluacionDesempeño] = {2}",
                    nombreFactor, clsUtilidades.mtdQuitarComasAPuntos("" + valorFactor), IdEvaluacionDesempeño);
        ...
        public bool mtdConsultarReporteEvaluacionesDesempeño(ref DataTable dtCaracOut, ref string strErrMsg, ref string fechaInicial, ref string fechaFinal)
        {
            ...
            try
            {
                strConsulta = string.Format("SELECT a.[Id],a.[NombreEvaluacion],a.[IdCargoResponsable],a.[FechaEvaluacion],a.[Evaluador],a.[Calificacion],a.[RecomCapacitacion]"
                    + ",a.[RecomCompromisos],a.[Otros],a.[DescripcionOtros],a.[FechaProximaEvaluacion],a.[IdUsuario],a.[FechaRegistro], c.NombreHijo, b.Usuario as Usuario"
                    + " FROM [Procesos].[tblEvaluacionDesempeno] as a"
                    + " left join Listas.Usuarios as b on b.IdUsuario = a.IdUsuario"
                    + " left JOIN Parametrizacion.JerarquiaOrganizacional AS c ON c.idHijo = a.IdCargoResponsable "
                    + "where a.[FechaRegistro] between CONVERT(DATE,'{0} 00:00:00') and CONVERT(DATE,'{1} 23:59:59')"
        ...
        public bool mtdUpdateEvaluacionDesempeño(ref clsEvaluacionDesempeno objEvaluacionDesempeño, int IdEvaluacionDesempeño, ref string strErrMsg)
        {
            #region Vars
            bool booResult = false;
            string strConsulta = string.Empty;
            ...
            try
            {
                ...
                ",[Otros] = '{2}' ,[DescripcionOtros] = '{3}' ,[FechaProximaEvaluacion] = '{4}'" +
                    " WHERE Id = {5} ",
                    objEvaluacionDesempeño.strRecomendacionCapacitacion, objEvaluacionDesempeño.strRecomendacionCompromisos,
                    objEvaluacionDesempeño.strOtros, objEvaluacionDesempeño.strDescripcionOtros, objEvaluacionDesempeño.dtFechaProximaEvaluacion,
                    /*objEvaluacionDesempeño.intId*/ IdEvaluacionDesempeño);
