...
namespace ListasSarlaft.Classes
{
    public class clsDtValorEvaluacionProveedor
    {
        ...
        public bool mtdInsertarValorEvaluacionProveedor(clsEvaluacionProveedor objEvaluacionProveedor, ref string strErrMsg)
        {
            ...
            try
            {
                ...
                ",[ServicioOfrecido],[RealizadoPor],[CargoResponsable],[FechaRegistro],[IdUsuario],[Observaciones],[FechaProximaEvaluacion])" +
                    "VALUES('{0}','{1}','{2}','{3}','{4}','{5}',{6},GETDATE(),{8},'{9}','{10}') ",
                    ...
                    objEvaluacionProveedor.strServicioOfrecido, objEvaluacionProveedor.strRealizadoPor, objEvaluacionProveedor.intCargoResponsable,
                    "GETDATE()"/*objEvaluacionProveedor.dtFechaRegistro*/, objEvaluacionProveedor.intIdUsuario,
        ...
        public bool mtdInsertarValorAspectoProveedor(clsAspectoProveedorHistorico objAspectoProveedor, ref string strErrMsg)
        {
            ...
            try
            {
                strConsulta = string.Format("INSERT INTO [Procesos].[tblAspectoProveedorHistorico] ([NombreAspecto],[ValorPorcentaje]," +
                    "[IdEvalProveedor],[FechaRegistro],[IdUsuario]) VALUES('{0}',{1},{2},GETDATE(),{4}) ",
                    objAspectoProveedor.strAspecto, clsUtilidades.mtdQuitarComasAPuntos("" + objAspectoProveedor.intValor),
                    objAspectoProveedor.intEvaluacionProveedor, "GETDATE()"/*objAspectoProveedor.dtFechaRegistro*/,
                    objAspectoProveedor.intIdUsuario);
        ...
        public bool mtdInsertarValorCriterioProveedor(clsCriterioProvHistorico objCriterioProveedor, ref string strErrMsg)
        {
            ...
            try
            {
                strConsulta = string.Format("INSERT INTO [Procesos].[tblCriterioProvHistorico] ([IdAspectoProvHistorico],[Descripcion]," +
                    "[FechaRegistro],[IdUsuario])" +
                    "VALUES({0},'{1}',GETDATE(),{3}) ",
                    objCriterioProveedor.intIdAspectoProveedorHistorico, objCriterioProveedor.strDescripcion,
                    "GETDATE()"/*objCriterioProveedor.dtFechaRegistro*/, objCriterioProveedor.intIdUsuario);
        ...
        public bool mtdInsertarValorParametroProveedor(clsParametrosProvHistorico objParametroProveedor, ref string strErrMsg)
        {
            ...
            try
            {
                strConsulta = string.Format("INSERT INTO [Procesos].[tblParametrosProvHistorico] ([IdCriterioProvHist],[Descripcion],[Valor]," +
                    "[FechaRegistro],[IdUsuario])" +
                    "VALUES({0},'{1}',{2},GETDATE(),{4}) ",
                    objParametroProveedor.intIdCriterioProvHistorico, objParametroProveedor.strDescripcion,
                    clsUtilidades.mtdQuitarComasAPuntos("" + objParametroProveedor.intValorParametro),
                    "GETDATE()"/*objParametroProveedor.dtFechaRegistro*/, objParametroProveedor.intIdUsuario);
