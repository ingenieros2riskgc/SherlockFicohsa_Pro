...
namespace ListasSarlaft.Classes
{
    public class cAuditoria : cPropiedades
    {
        ...
        public byte[] mtdDescargarArchivoAud(string strNombreArchivo)
        {
            ...
            try
            {
                strConsulta = string.Format("SELECT [UrlArchivo], [Archivo] FROM [Auditoria].[ArchivoHallazgoAuditoria] WHERE [UrlArchivo] = N'{0}'", strNombreArchivo);
        ...
        public DataTable ArchivoAud(String CodRegAuditoria)
        {
            ...
            try
            {
                string strConsulta = string.Format("SELECT * FROM [Auditoria].[ArchivoHallazgoAuditoria] WHERE [IdRegistroAuditoria] = {0} ", CodRegAuditoria);
                cDataBase.conectar();
                dtInformacion = cDataBase.ejecutarConsulta(strConsulta);
                cDataBase.desconectar();
            }
