        ...
        public bool mtdInsertarValorEvaluacionServicio(clsEvaluacionServicio objEvaluacionServicio, ref string strErrMsg)
        {
            ...
            try
            {
                ...
                ",[Funcionarios],[FechaRegistro],[IdUsuario])" +
                    "VALUES('{0}','{1}',{2},'{3}','{4}','{5}','{6}',GETDATE(),{8}) ",
                    objEvaluacionServicio.strCiudad, objEvaluacionServicio.dtFecha, objEvaluacionServicio.intIdTipoEncuesta, 
                    objEvaluacionServicio.strNombreCliente, objEvaluacionServicio.strNombre,
                    objEvaluacionServicio.strCargo, objEvaluacionServicio.strFuncionarios, "GETDATE()"/*objEvaluacionServicio.dtFechaRegistro*/, 
                    objEvaluacionServicio.intIdUsuario);
        ...
        public bool mtdInsertarValorObservacion(clsObservacionServicio objObservacion, ref string strErrMsg)
        {
            ...
            try
            {
                strConsulta = string.Format("INSERT INTO [Procesos].[tblObservacionEvalServicio] ([IdEvalServicio],[Descripcion],[FechaRegistro],[IdUsuario])" +
                    ...
                    objObservacion.intIdEvaServicio, objObservacion.strObservacion, "GETDATE()"/*objObservacion.dtfecha*/, objObservacion.intIdUsuario);
