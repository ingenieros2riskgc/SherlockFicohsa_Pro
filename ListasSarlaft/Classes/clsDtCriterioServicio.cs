    ...
    public class clsDtCriterioServicio
    {
        public bool mtdInsertarCriterioServicio(clsCriterioServicio cCriterioServicio, ref string strErrMsg)
        {
            ...
            try
            {
                    ...
                    cCriterioServicio.intRangoInicial, clsUtilidades.mtdQuitarComasAPuntos(""+cCriterioServicio.intRangoFinal), clsUtilidades.mtdQuitarComasAPuntos(""+cCriterioServicio.strDescripcion), cCriterioServicio.intIdUsuario
                    );
