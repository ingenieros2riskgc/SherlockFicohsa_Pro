                    ...
                    <table align="center">
                        <tr id="TbTIdentificacion" runat="server" class="no-visible">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label5" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Tipo Identificación"
                        ...
                        <tr id="TbNIdentificacion" runat="server">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label6" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Número Identificación"
                                    style="color:black"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
