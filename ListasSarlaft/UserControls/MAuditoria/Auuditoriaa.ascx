...
<asp:SqlDataSource ID="sqlDSempresa" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    SelectCommand="SELECT idHijo AS IdEmpresa, NombreHijo AS Descripcion FROM [Parametrizacion].[JerarquiaOrganizacional] WHERE idHijo =0"></asp:SqlDataSource>
...
<%--SELECT [IdEnfoque], [Descripcion] FROM [Auditoria].[Enfoque] WHERE ([IdObjetivo] = @IdObjetivo)--%>
            ...
            <tr runat="server" id="trReplicar" visible="false">
                <td align="center">
                    <table style="width:60%">
                        <tr>
                            <td colspan="2" bgcolor="#002649" align="center">
            ...
            <tr id="filaDetalleAuditoria" runat="server" align="left" visible="false">
                <td id="Td9" runat="server">
                    <table width="100%" bgcolor="#EEEEEE">
                        <tr>
                            <td>
                                <table class="tabla" width="100%">
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB" style="margin-left: 40px">
                                            <asp:Label ID="Label75" runat="server" Text="Empresa:" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                        </td>
                                        <td>
                                           <%-- <asp:DropDownList ID="ddlEmpresa" runat="server" Width="221px" CssClass="Apariencia"
                                            ...
                                            <asp:DropDownList ID="ddlEmpresa" runat="server" DataSourceID="sqlDSempresa" DataTextField="Descripcion"
                                                DataValueField="IdEmpresa" Font-Names="Calibri" Font-Size="Small" OnDataBound="ddlEmpresa_DataBound"
                                                Width="221px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    ...
                                    <tr align="left">
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label4" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Estándar:"></asp:Label>
                                        </td>
                                        <td bgcolor="#f0eef0">
                                    ...
                                    <tr align="left" runat="server" id="trControlesAud" visible="false">
                                        ...
                                        <td runat="server">
                                            <table bgcolor="#EEEEEE" class="tabla" width="100%">
                                                <tr>
                                                    <td bgcolor="#BBBBBB">
                                                        <asp:Label ID="lblRiesgoControl" runat="server" Font-Names="Calibri" Font-Size="Small"  Text="Riesgo:"></asp:Label>
                                                    </td>
                                                    <td>
                                    ...
                                    <tr align="left" runat="server" id="trActivadesControl" visible="false">
                                        ...
                                        <td runat="server">
                                            <table bgcolor="#EEEEEE" class="tabla" width="100%">
                                                <tr>
                                                    <td bgcolor="#BBBBBB">
                                                        <asp:Label ID="lblControlAct" runat="server" Font-Names="Calibri" Font-Size="Small"  Text="Control:"></asp:Label>
                                                    </td>
                                                    <td>
                                ...
                                <table>
                                    ...
                                    <tr align="left" runat="server" id="trAsociaciones" visible="false">
                                        ...
                                        <td bgcolor="#f0eef0">
                                            <table>
                                                <tr>
                                                    <td align="center"> <asp:Label ID="lblAsoRiesgoControl" runat="server" Text="Asociación Riesgo-Control" Font-Names="Calibri" Font-Size="Small" ForeColor="Black"></asp:Label></td>
                                                    <td align="center"> <asp:Label ID="lblAsoControlActividad" runat="server" Text="Asociación Control-Actividad" Font-Names="Calibri" Font-Size="Small" ForeColor="Black"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                    ...
                                    <tr align="left">
                                        ...
                                        <td bgcolor="#f0eef0">
                                            <asp:TextBox ID="txtAlcance" runat="server" Enabled="True" Columns="100" TextMode="MultiLine" Font-Size="Small"
                                                Font-Names="Calibri" Rows="8"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlEspecial" runat="server" Font-Names="Calibri" Font-Size="Small">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlPeriodicidad" runat="server" Width="169px" Font-Names="Calibri" Font-Size="Small">
                                    ...
                                    <Table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlMesEjecucion" runat="server" Font-Names="Calibri" Font-Size="Small">
                                                    <asp:ListItem Text="--seleccionar--" Value="0"></asp:ListItem>
                                            ...
                                            <td>
                                                <asp:CheckBoxList ID="cblSemanaExe" runat="server" Font-Names="Calibri" Font-Size="Small">
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Usuario:"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
                                <asp:TextBox ID="txtUsuario" runat="server" Font-Names="Calibri" Font-Size="Small" Enabled="False" Width="100px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label10" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Fecha de Creación:"></asp:Label>
                            </td>
                            <td bgcolor="#f0eef0">
                                <asp:TextBox ID="txtFecha" runat="server" Font-Names="Calibri" Font-Size="Small" Enabled="False" Width="100px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr align="center" bgcolor="#EEEEEE">
                            <td colspan="2">
                                <table class="tablaSinBordes">
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server"  ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="btnImgInsertar_Click" ToolTip="Guardar Auditoria" ValidationGroup="AddRecursos2" Visible="False" />
                                        </td>
                                        <td>
