...
namespace ListasSarlaft.UserControls.Gestion
{
    public partial class Indicadores : System.Web.UI.UserControl
    {
        ...
        protected void BtnUpdaterMeta_Click(object sender, ImageClickEventArgs e)
        {
            ...
            int Meta = Convert.ToInt32(TextBox10.Text);
            string IdValor = InfoGridMetas.Rows[IdexRowM]["IdIndicador"].ToString().Trim();
            DataTable dtInfo = new DataTable();

            dtInfo = cCuenta.contadorMeta(IdValor);
            int valorAcumulado = Convert.ToInt32(dtInfo.Rows[0]["Total"].ToString());
        ...
        protected void BtnGuardarMeta_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //if (GridViewMetas.Rows.Count == 0 && (GridViewMetas.Rows.Count != 0))
            //{
            string IdValor = InfoGrid.Rows[IdexRow]["IdIndicador"].ToString().Trim();
            DataTable dtInfo = new DataTable();
