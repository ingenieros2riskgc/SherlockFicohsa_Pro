        ...
        public void VerIndicadoresDetalle()
        {
            ...
            try
            {
                ...
                for (int contind = 0; contind < ContResultados; contind++)
                {
                    ...
                    double ResultadoFinall = Convert.ToDouble(dtIndicadoresResultado.Rows[contind]["Resultado"].ToString().Trim());
                    double MetaFinall = Convert.ToDouble(dtIndicadoresResultado.Rows[contind]["Meta"].ToString().Trim());
                    double ResultCumplimiento = ResultadoFinall / MetaFinall;
                    double ResultadoDecimal = ResultCumplimiento * 100;
                    int ResultadoFinal = Convert.ToInt32(ResultadoDecimal);

                    dCell.Text = ResultadoFinal.ToString().Trim() + " %";
                    cumplimiento = ResultadoFinal.ToString().Trim();
