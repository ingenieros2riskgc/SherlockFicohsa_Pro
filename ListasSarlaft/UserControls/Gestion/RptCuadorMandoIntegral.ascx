...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table align="center">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblObjetivos" runat="server" ForeColor="White" Text="Objetivos:"
                        Font-Bold="False" Font-Names="Calibri" Font-Size="Large" Style="color: #000000; font-size: medium"></asp:Label>
                    </td>
                <td>
                    <asp:DropDownList ID="ddlObjetivos" runat="server" Font-Names="Calibri" Font-Size="Small"
                        Width="428px" Height="28px" Style="margin-left: 14px">
                        <asp:ListItem Value="---">---</asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                <td colspan="3">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        <LocalReport ReportPath="Reportes\RptCuadorMandoIntegral.rdlc">
                            <DataSources>
                                ...
                                <rsweb:ReportDataSource DataSourceId="sqlGraficoIndicadoresvsObjetivos" Name="dsGraficoIndicadoresvsObjetivo" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    ...
                    <asp:SqlDataSource ID="sqlGraficoIndicadoresvsObjetivos" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
                        SelectCommand="Gestion.SP_GraficoIndicadorvsObjetivo" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextBox8" DefaultValue="PE0" Name="CodigoPlan" PropertyName="Text"
                                Type="String" />
                            <asp:ControlParameter ControlID="ddlObjetivos" DefaultValue="OB0" Name="CodigoObjetivo" PropertyName="Text"
                                Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
