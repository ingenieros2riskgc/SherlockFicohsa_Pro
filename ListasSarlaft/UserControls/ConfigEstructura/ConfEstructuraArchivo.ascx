                    ...
                    <table id="updateUser" runat="server" visible="false">
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label5" runat="server" Text="Nombre Campo" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left" visible="false">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label4" runat="server" Text="Tipo Dato" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left" visible="false">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label2" runat="server" Text="Longitud" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label6" runat="server" Text="Posición" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label3" runat="server" Text="Es Paramétrico?" Font-Names="Calibri" style="color:black"
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Tipo Parámetro" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="lblEstado" runat="server" Text="Estado" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="lblNumerico" runat="server" Text="Es Numerico?" Font-Names="Calibri" style="color:black"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td>
