...
namespace ListasSarlaft.UserControls.ConfigEstructura
{
    public partial class Parametrizacion : System.Web.UI.UserControl
    {
        ...
        private void mtdEliminarCategoria()
        {
            ...
            clsDTOParametrizacion objParam = new clsDTOParametrizacion(/*InfoGrid.Rows[RowGrid][0].ToString().Trim(),*/string.Empty,
                InfoGrid.Rows[RowGrid][1].ToString().Trim()/*string.Empty*/, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, false);
            cParam.mtdEliminarCategoria(objParam, ref strErrMsg);
