            ...
            <tr align="center">
                <td>
                    <table id="updateUser" runat="server" visible="false">
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Calificación" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td bgcolor="#BBBBBB" align="center">
                                <asp:Label ID="Label2" runat="server" Text="Activo" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
                            </td>
                            <td>
