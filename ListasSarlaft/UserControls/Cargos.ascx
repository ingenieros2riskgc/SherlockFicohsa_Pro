            ...
            <table width="100%" style="color:black">
                ...
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <asp:Label ID="lblMsgBox" runat="server" Font-Bold="False" Font-Names="Tahoma" ForeColor="Black" Font-Size="11px"
                            ></asp:Label>
                    </td>
                </tr>
                <tr>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    <Columns >
                                        <asp:BoundField DataField="IdCargo" HeaderText="Id de Cargo" SortExpression="IdCargo" Visible="false">
                                        ...
                                        <asp:TemplateField ShowHeader="False" HeaderText="Acción">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="btnImgEliminar" runat="server" CausesValidation="False" OnClick="btnImgEliminar_Click"
                                                    CommandArgument="<%# Container.DataItemIndex %>" ImageUrl="~/Imagenes/Icons/deleteV5.png"
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:ImageButton ID="imgBtnInsertar" runat="server" CausesValidation="False" CommandName="Insert"
                                            ImageUrl="~/Imagenes/Icons/AddV5.png" Text="Insert" OnClick="imgBtnInsertar_Click"
                                            ToolTip="Insertar" />
                                    </td>
                                </tr>
                            </td>
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Tipo de Cargo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label6" runat="server" Text="Descripción:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label8" runat="server" Text="Funciones:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
