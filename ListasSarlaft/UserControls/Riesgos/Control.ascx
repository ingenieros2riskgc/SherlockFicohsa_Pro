...
<asp:Label ID="lbldummyOkNo" runat="server" Text="" Visible="False" style="color:black"></asp:Label>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td align="left" valign="middle">
                <asp:Label ID="lblMsgBoxOkNo" runat="server" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label>
            </td>
        </tr>
        <tr style="height: 10px">
            <td></td>
            ...
            <table width="100%">
                <tr class="topHandle" style="background-color: #5D7B9D">
                    <td colspan="2" align="center" runat="server" id="td1">
                        &nbsp;
                        <asp:Label ID="lblMsgBoxOkNoAI" runat="server" Text="Atención" Font-Names="Calibri" Font-Size="Small" style="color:black"></asp:Label><br />
                    </td>
                </tr>
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <asp:Label ID="lblMsgBox1" runat="server" Text="¿Está seguro que desea (in)activar el control?" Font-Names="Calibri"
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table align="center" bgcolor="#EEEEEE" width="60%">
            ...
            <tr align="center">
                <td>
                    <table id="tbGrid" runat="server">
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td bgcolor="#f0eef0">
                                            <asp:DropDownList ID="DDLArea" runat="server" Width="155px" Font-Names="Calibri"
                                                Font-Size="Small">
                            ...
                            <td>
                                <table>
                                    <tr align="center">
                                        ...
                                        <td>
                                            <asp:ImageButton ID="ImageButton15" CssClass="ImageButton15" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image"  HeaderText="Editar" ImageUrl="~/Imagenes/Icons/editV5.png" Text="Editar" CommandName="Modificar" />                                        
                        ...
                        <tr align="right">
                            <td>
                                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Imagenes/Icons/AddV5.png"
                                        ...
                                        <td colspan="4">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                            ...
                                                            <tr align="right">
                                                                <td colspan="2">
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                    ...
                                                    <td>
                                                        <table>
                                                            <tr align="center">
                                                                ...
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Imagenes/Icons/AddV5.png"
                            ...
                            <td>
                                <table id="tbBotonesUpdate" runat="server">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                    ...
                                    <tr align="center">
                                        <td>
                                            <table>
                                                ...
                                                <tr align="right">
                                                    <td>
                                                        <asp:ImageButton ID="ImageButton8" runat="server" ToolTip="Insertar" ImageUrl="~/Imagenes/Icons/AddV5.png"
                                                ...
                                                <tr align="left">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="DropDownList7" runat="server" Font-Names="Calibri" Font-Size="Small"
                                                            Width="155px" OnSelectedIndexChanged="habilitarBotones">
                                                            <asp:ListItem Value="---">---</asp:ListItem>
                                                        </asp:DropDownList>
                                                                                    ...
                                                                                    <tr align="right">
                                                                                        <td colspan="2">
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <asp:ImageButton ID="ImageButton16" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                                                                            ...
                                                                            <td>
                                                                                <table>
                                                                                    <tr align="center">
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:ImageButton ID="ImageButton17" runat="server" ImageUrl="~/Imagenes/Icons/AddV5.png"
                                                ...
                                                <tr align="center">
                                                    <td colspan="2">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                                ...
                                                                <td>
                                                                    <asp:ImageButton ID="ImageButton14" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
