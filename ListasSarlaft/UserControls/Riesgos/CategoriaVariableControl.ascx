            ...
            <table class="Tablewidth">
                <tr class="topHandle">
                    <td class="centertdtr" colspan="2" runat="server" id="tdCaption">
                        <asp:Label ID="lblCaption" runat="server" Text="Atención" Font-Bold="False" Font-Names="Tahoma" Font-Size="11px"
                ...
                <tr align="center">
                    <td>
                        <asp:GridView ID="GVcategoriasVariablesControl" runat="server" CellPadding="4"
                            ...
                            ShowHeaderWhenEmpty="True" DataKeyNames="strUsuario,dtFechaRegistro" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Descripción Categoría" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
        ...
        <div id="BodyFormCVC" class="ColumnStyle" runat="server" visible="false">
            <div id="form" class="TableContains">
                <table class="tabla" align="center" width="80%">
                    ...
                    <tr class="RowsText">
                        <td class="Apariencia" align="center">Variable</td>
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:ImageButton ID="IBinsertGVC" runat="server" CausesValidation="true" CommandName="Insert"
                                ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Insert" ValidationGroup="vgCategoriaVariable" ToolTip="Insertar" Visible="false" OnClick="IBinsertGVC_Click" />
                            <asp:ImageButton ID="IBupdateGVC" runat="server" CausesValidation="true" CommandName="Update"
                                ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Update" ValidationGroup="vgCategoriaVariable" ToolTip="Actualizar" Visible="false" OnClick="IBupdateGVC_Click" />
