...
namespace ListasSarlaft.UserControls.Riesgos
{
    public partial class Riesgos : System.Web.UI.UserControl
    {
        ...
        private int pagIndexInfoGridIR;
        private int PagIndexInfoGridIR
        {
            get
            {
                pagIndexInfoGridIR = (int)ViewState["pagIndexInfoGridIR"];
                return pagIndexInfoGridIR;
            }
            set
            {
                pagIndexInfoGridIR = value;
                ViewState["pagIndexInfoGridIR"] = pagIndexInfoGridIR;
            }
        }
        ...
        private DataTable infoGridIR;
        private DataTable InfoGridIR
        {
            get
            {
                infoGridIR = (DataTable)ViewState["infoGridIR"];
                return infoGridIR;
            }
            set
            {
                infoGridIR = value;
                ViewState["infoGridIR"] = infoGridIR;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    scrtManager.RegisterPostBackControl(this.ImageButton4);
        ...
        #region Producto
        private int pagIndexInfoGridProducto;

        private int PagIndexInfoGridProducto
        {
            get
            {
                pagIndexInfoGridProducto = (int)ViewState["pagIndexInfoGridProducto"];
                return pagIndexInfoGridProducto;
            }
            set
            {
                pagIndexInfoGridProducto = value;
                ViewState["pagIndexInfoGridProducto"] = pagIndexInfoGridProducto;
            }
        }

        private void inicializarProducto()
        {
            PagIndexInfoGridProducto = 0;
        }

        private DataTable infoGridProducto;
        private DataTable InfoGridProducto
        {
            get
            {
                infoGridProducto = (DataTable)ViewState["infoGridProducto"];
                return infoGridProducto;
            }
            set
            {
                infoGridProducto = value;
                ViewState["infoGridProducto"] = infoGridProducto;
            }
        }

        private void GVProducto_reload()
        {
        ...
        private void loadGridProducto()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdProductoAfectado", typeof(string));
            grid.Columns.Add("Producto", typeof(string));
            grid.Columns.Add("FechaRegistro", typeof(string));
            grid.Columns.Add("Relacion", typeof(string));

            GVProducto.PageIndex = PagIndexInfoGridProducto;
            InfoGridProducto = grid;
            GVProducto.DataSource = InfoGridProducto;
            GVProducto.DataBind();
        }

        private void loadInfoProducto()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoProducto(TBBPONombre.Text, Session["IdRiesgo"].ToString());
                ...
                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        ...
                        InfoGridProducto.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdProductoAfectado"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Producto"].ToString().Trim(),
                ...
                else
                {
                    loadGridProducto();
                    TbProducto.Visible = false;
                    Mensaje1("No se encontraron productos. ");
                }

            }
            catch (Exception ex)
            {
                Mensaje1("Error cargando productos. " + ex.Message);
            }
        }

        protected void GVProducto_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridProducto = e.NewPageIndex;
            GVProducto.PageIndex = PagIndexInfoGridProducto;
            GVProducto.DataSource = InfoGridProducto;
            GVProducto.DataBind();
        }
        ...
        protected void GVProducto_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVProducto.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdProductoriginador = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarProducto(Session["IdRiesgo"].ToString(), IdProductoriginador);
                        GVProducto_reload();
                    ...
                    case "Ver":
                        ...
                        ShowInfoProducto(colsNoVisible);
            ...
            {
                Mensaje1("Error enlazando productos. " + ex.Message);
            }
        }

        private void ShowInfoProducto(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdProducto.Text = colsNoVisible[0].ToString();
            TBPONombre.Text = colsNoVisible[1].ToString();
            TBPOFechaRegistro.Text = colsNoVisible[2].ToString();
        }
        #endregion
        ...
        #region PlanesAsociados
        private int pagIndexInfoGridPlanesAsociados;

        private int PagIndexInfoGridPlanesAsociados
        {
            get
            {
                pagIndexInfoGridPlanesAsociados = (int)ViewState["pagIndexInfoGridPlanesAsociados"];
                return pagIndexInfoGridPlanesAsociados;
            }
            set
            {
                pagIndexInfoGridPlanesAsociados = value;
                ViewState["pagIndexInfoGridPlanesAsociados"] = pagIndexInfoGridPlanesAsociados;
            }
        }
        ...
        protected void GvPlanesAsociados_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridPlanesAsociados = e.NewPageIndex;
            GvPlanesAsociados.PageIndex = pagIndexInfoGridPlanesAsociados;
        ...
        #region LineaNegocio
        private int pagIndexInfoGridLineaNegocio;

        private int PagIndexInfoGridLineaNegocio
        {
            get
            {
                pagIndexInfoGridLineaNegocio = (int)ViewState["pagIndexInfoGridLineaNegocio"];
                return pagIndexInfoGridLineaNegocio;
            }
            set
            {
                pagIndexInfoGridLineaNegocio = value;
                ViewState["pagIndexInfoGridLineaNegocio"] = pagIndexInfoGridLineaNegocio;
            }
        }

        private void inicializarLineaNegocio()
        {
            PagIndexInfoGridLineaNegocio = 0;
        }

        private DataTable infoGridLineaNegocio;
        private DataTable InfoGridLineaNegocio
        {
            get
            {
                infoGridLineaNegocio = (DataTable)ViewState["infoGridLineaNegocio"];
                return infoGridLineaNegocio;
            }
            set
            {
                infoGridLineaNegocio = value;
                ViewState["infoGridLineaNegocio"] = infoGridLineaNegocio;
            }
        }

        private void GVLineaNegocio_reload()
        {
            TbLineaNegocio.Visible = false;
            inicializarLineaNegocio();
            loadGridLineaNegocio();
            loadInfoLineaNegocio();
        }

        private void loadGridLineaNegocio()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdDescLineaUno", typeof(string));
            grid.Columns.Add("Descripcion", typeof(string));
            grid.Columns.Add("FechaRegistro", typeof(string));
            grid.Columns.Add("Relacion", typeof(string));

            GVLineaNegocio.PageIndex = PagIndexInfoGridLineaNegocio;
            InfoGridLineaNegocio = grid;
            GVLineaNegocio.DataSource = InfoGridLineaNegocio;
            GVLineaNegocio.DataBind();
        }

        private void loadInfoLineaNegocio()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoLineaNegocio(TBBLINombre.Text, Session["IdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbLineaNegocio.Visible = true;
                        InfoGridLineaNegocio.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdDescLineaUno"].ToString().Trim(),
                ...
                else
                {
                    loadGridLineaNegocio();
                    TbLineaNegocio.Visible = false;
                    Mensaje1("No se encontraron LineaNegocios. ");
                }

            }
            catch (Exception ex)
            {
                Mensaje1("Error cargando LineaNegocios. " + ex.Message);
            }
        }

        protected void GVLineaNegocio_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridLineaNegocio = e.NewPageIndex;
            GVLineaNegocio.PageIndex = PagIndexInfoGridLineaNegocio;
            GVLineaNegocio.DataSource = InfoGridLineaNegocio;
            GVLineaNegocio.DataBind();
        }

        protected void GVLineaNegocio_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVLineaNegocio.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdLineaNegocioriginador = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarLineaNegocio(Session["IdRiesgo"].ToString(), IdLineaNegocioriginador);
                        GVLineaNegocio_reload();

                        break;

                    case "Ver":

                        ShowInfoLineaNegocio(colsNoVisible);
            ...
            {
                Mensaje1("Error enlazando Linea de Negocios. " + ex.Message);
            }
        }

        private void ShowInfoLineaNegocio(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdLineaNegocio.Text = colsNoVisible[0].ToString();
            TBLINombre.Text = colsNoVisible[1].ToString();
            TBLIFechaRegistro.Text = colsNoVisible[2].ToString();
        }
        #endregion

        #region ActivoAfectado
        private int pagIndexInfoGridActivoAfectado;

        private int PagIndexInfoGridActivoAfectado
        {
            get
            {
                pagIndexInfoGridActivoAfectado = (int)ViewState["pagIndexInfoGridActivoAfectado"];
                return pagIndexInfoGridActivoAfectado;
            }
            set
            {
                pagIndexInfoGridActivoAfectado = value;
                ViewState["pagIndexInfoGridActivoAfectado"] = pagIndexInfoGridActivoAfectado;
            }
        }

        private void inicializarActivoAfectado()
        {
            PagIndexInfoGridActivoAfectado = 0;
        }

        private DataTable infoGridActivoAfectado;
        private DataTable InfoGridActivoAfectado
        {
            get
            {
                infoGridActivoAfectado = (DataTable)ViewState["infoGridActivoAfectado"];
                return infoGridActivoAfectado;
            }
            set
            {
                infoGridActivoAfectado = value;
                ViewState["infoGridActivoAfectado"] = infoGridActivoAfectado;
            }
        }

        private void GVActivoAfectado_reload()
        {
            TbActivoAfectado.Visible = false;
            inicializarActivoAfectado();
            loadGridActivoAfectado();
            loadInfoActivoAfectado();
        }

        private void loadGridActivoAfectado()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdActivoAfectado", typeof(string));
            grid.Columns.Add("Activo", typeof(string));
            grid.Columns.Add("TipoActivo", typeof(string));
            grid.Columns.Add("FechaRegistro", typeof(string));
            grid.Columns.Add("Relacion", typeof(string));

            GVActivoAfectado.PageIndex = PagIndexInfoGridActivoAfectado;
            InfoGridActivoAfectado = grid;
            GVActivoAfectado.DataSource = InfoGridActivoAfectado;
            GVActivoAfectado.DataBind();
        }

        private void loadInfoActivoAfectado()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoActivoAfectado(TBBAANombre.Text, Session["IdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbActivoAfectado.Visible = true;
                        InfoGridActivoAfectado.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdActivoAfectado"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Activo"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["TipoActivo"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["FechaRegistro"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Relacion"].ToString().Trim(),
                                                              });
                    }
                ...
                else
                {
                    loadGridActivoAfectado();
                    TbActivoAfectado.Visible = false;
                    Mensaje1("No se encontraron activos afectados. ");
                }

            }
            catch (Exception ex)
            {
                Mensaje1("Error cargando activos afectados. " + ex.Message);
            }
        }

        protected void GVActivoAfectado_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridActivoAfectado = e.NewPageIndex;
            GVActivoAfectado.PageIndex = PagIndexInfoGridActivoAfectado;
            GVActivoAfectado.DataSource = InfoGridActivoAfectado;
            GVActivoAfectado.DataBind();
        }

        protected void GVActivoAfectado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVActivoAfectado.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdActivoAfectado = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarActivoAfectado(Session["IdRiesgo"].ToString(), IdActivoAfectado);
                        GVActivoAfectado_reload();

                        break;

                    case "Ver":

                        ShowInfoActivoAfectado(colsNoVisible);
            ...
            {
                Mensaje1("Error enlazando activos afectados. " + ex.Message);
            }
        }

        private void ShowInfoActivoAfectado(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdActivoAfectado.Text = colsNoVisible[0].ToString();
            TBAANombre.Text = colsNoVisible[1].ToString();
            TBAATipoActivo.Text = colsNoVisible[2].ToString();
            TBAAFechaRegistro.Text = colsNoVisible[3].ToString();
        }
        #endregion

        #region DimValoracion
        private int pagIndexInfoGridDimValoracion;

        private int PagIndexInfoGridDimValoracion
        {
            get
            {
                pagIndexInfoGridDimValoracion = (int)ViewState["pagIndexInfoGridDimValoracion"];
                return pagIndexInfoGridDimValoracion;
            }
            set
            {
                pagIndexInfoGridDimValoracion = value;
                ViewState["pagIndexInfoGridDimValoracion"] = pagIndexInfoGridDimValoracion;
            }
        }

        private void inicializarDimValoracion()
        {
            PagIndexInfoGridDimValoracion = 0;
        }

        private DataTable infoGridDimValoracion;
        private DataTable InfoGridDimValoracion
        {
            get
            {
                infoGridDimValoracion = (DataTable)ViewState["infoGridDimValoracion"];
                return infoGridDimValoracion;
            }
            set
            {
                infoGridDimValoracion = value;
                ViewState["infoGridDimValoracion"] = infoGridDimValoracion;
            }
        }

        private void GVDimValoracion_reload()
        {
            TbDimValoracion.Visible = false;
            inicializarDimValoracion();
            loadGridDimValoracion();
            loadInfoDimValoracion();
        }

        private void loadGridDimValoracion()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdDimValoracion", typeof(string));
            grid.Columns.Add("Dimensiones", typeof(string));
            grid.Columns.Add("FechaRegistro", typeof(string));
            grid.Columns.Add("Relacion", typeof(string));

            GVDimValoracion.PageIndex = PagIndexInfoGridDimValoracion;
            InfoGridDimValoracion = grid;
            GVDimValoracion.DataSource = InfoGridDimValoracion;
            GVDimValoracion.DataBind();
        }

        private void loadInfoDimValoracion()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoDimValoracion(TBBDVNombre.Text, Session["IdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbDimValoracion.Visible = true;
                        InfoGridDimValoracion.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdDimValoracion"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Dimensiones"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["FechaRegistro"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Relacion"].ToString().Trim(),
                                                              });
                    }
                ...
                else
                {
                    loadGridDimValoracion();
                    TbDimValoracion.Visible = false;
                    Mensaje1("No se encontraron dimensiones de valoración. ");
                }

            }
            catch (Exception ex)
            {
                Mensaje1("Error cargando dimensiones de valoración. " + ex.Message);
            }
        }

        protected void GVDimValoracion_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridDimValoracion = e.NewPageIndex;
            GVDimValoracion.PageIndex = PagIndexInfoGridDimValoracion;
            GVDimValoracion.DataSource = InfoGridDimValoracion;
            GVDimValoracion.DataBind();
        }

        protected void GVDimValoracion_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVDimValoracion.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdDimValoracion = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarDimValoracion(Session["IdRiesgo"].ToString(), IdDimValoracion);
                        GVDimValoracion_reload();

                        break;

                    case "Ver":

                        ShowInfoDimValoracion(colsNoVisible);
            ...
            {
                Mensaje1("Error enlazando Dimensiones de Valoración. " + ex.Message);
            }
        }

        private void ShowInfoDimValoracion(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdDimValoracion.Text = colsNoVisible[0].ToString();
            TBDVNombre.Text = colsNoVisible[1].ToString();
            TBDVFechaRegistro.Text = colsNoVisible[2].ToString();
        }
        #endregion

        #region ProductoNuevo
        private int pagIndexInfoGridProductoNuevo;

        private int PagIndexInfoGridProductoNuevo
        {
            get
            {
                pagIndexInfoGridProductoNuevo = (int)ViewState["pagIndexInfoGridProductoNuevo"];
                return pagIndexInfoGridProductoNuevo;
            }
            set
            {
                pagIndexInfoGridProductoNuevo = value;
                ViewState["pagIndexInfoGridProductoNuevo"] = pagIndexInfoGridProductoNuevo;
            }
        }

        private void inicializarProductoNuevo()
        {
            PagIndexInfoGridProductoNuevo = 0;
        }

        private DataTable infoGridProductoNuevo;
        private DataTable InfoGridProductoNuevo
        {
            get
            {
                infoGridProductoNuevo = (DataTable)ViewState["infoGridProductoNuevo"];
                return infoGridProductoNuevo;
            }
            set
            {
                infoGridProductoNuevo = value;
                ViewState["infoGridProductoNuevo"] = infoGridProductoNuevo;
            }
        }

        private void GVProductoNuevo_reload()
        {
            TbProductoNuevo.Visible = false;
            inicializarProductoNuevo();
            loadGridProductoNuevo();
            loadInfoProductoNuevo();
        }

        private void loadGridProductoNuevo()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdProductoAfectado", typeof(string));
            grid.Columns.Add("Producto", typeof(string));
            ...
            GVProductoNuevo.PageIndex = PagIndexInfoGridProductoNuevo;
            InfoGridProductoNuevo = grid;
            GVProductoNuevo.DataSource = InfoGridProductoNuevo;
            GVProductoNuevo.DataBind();
        }

        private void loadInfoProductoNuevo()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoProducto(TBBPONombreNuevo.Text, Session["tmpIdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbProductoNuevo.Visible = true;
                        InfoGridProductoNuevo.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdProductoAfectado"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Producto"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["FechaRegistro"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Relacion"].ToString().Trim(),
                ...
                else
                {
                    loadGridProductoNuevo();
                    TbProductoNuevo.Visible = false;
                    Mensaje1("No se encontraron Producto. ");
                }

            }
            catch (Exception ex)
            {
                Mensaje1("Error cargando Producto. " + ex.Message);
            }
        }

        protected void GVProductoNuevo_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridProductoNuevo = e.NewPageIndex;
            GVProductoNuevo.PageIndex = PagIndexInfoGridProductoNuevo;
            GVProductoNuevo.DataSource = InfoGridProductoNuevo;
            GVProductoNuevo.DataBind();
        }

        protected void GVProductoNuevo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVProductoNuevo.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdProductoNuevoriginador = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarProducto(Session["tmpIdRiesgo"].ToString(), IdProductoNuevoriginador);
                        GVProductoNuevo_reload();

                        break;

                    case "Ver":

                        ShowInfoProductoNuevo(colsNoVisible);
            ...
            {
                Mensaje1("Error enlazando ProductoNuevos. " + ex.Message);
            }
        }

        private void ShowInfoProductoNuevo(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdProductoNuevo.Text = colsNoVisible[0].ToString();
            TBPONombreNuevo.Text = colsNoVisible[1].ToString();
            TBPOFechaRegistroNuevo.Text = colsNoVisible[2].ToString();
        }
        #endregion

        #region LineaNegocioNuevo
        private int pagIndexInfoGridLineaNegocioNuevo;

        private int PagIndexInfoGridLineaNegocioNuevo
        {
            get
            {
                pagIndexInfoGridLineaNegocioNuevo = (int)ViewState["pagIndexInfoGridLineaNegocioNuevo"];
                return pagIndexInfoGridLineaNegocioNuevo;
            }
            set
            {
                pagIndexInfoGridLineaNegocioNuevo = value;
                ViewState["pagIndexInfoGridLineaNegocioNuevo"] = pagIndexInfoGridLineaNegocioNuevo;
            }
        }

        private void inicializarLineaNegocioNuevo()
        {
            PagIndexInfoGridLineaNegocioNuevo = 0;
        }

        private DataTable infoGridLineaNegocioNuevo;
        private DataTable InfoGridLineaNegocioNuevo
        {
            get
            {
                infoGridLineaNegocioNuevo = (DataTable)ViewState["infoGridLineaNegocioNuevo"];
                return infoGridLineaNegocioNuevo;
            }
            set
            {
                infoGridLineaNegocioNuevo = value;
                ViewState["infoGridLineaNegocioNuevo"] = infoGridLineaNegocioNuevo;
            }
        }

        private void GVLineaNegocioNuevo_reload()
        {
            TbLineaNegocioNuevo.Visible = false;
            inicializarLineaNegocioNuevo();
            loadGridLineaNegocioNuevo();
            loadInfoLineaNegocioNuevo();
        }

        private void loadGridLineaNegocioNuevo()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdDescLineaUno", typeof(string));
            grid.Columns.Add("Descripcion", typeof(string));
            ...
            GVLineaNegocioNuevo.PageIndex = PagIndexInfoGridLineaNegocioNuevo;
            InfoGridLineaNegocioNuevo = grid;
            GVLineaNegocioNuevo.DataSource = InfoGridLineaNegocioNuevo;
            GVLineaNegocioNuevo.DataBind();
        }

        private void loadInfoLineaNegocioNuevo()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoLineaNegocio(TBBLINombreNuevo.Text, Session["tmpIdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbLineaNegocioNuevo.Visible = true;
                        InfoGridLineaNegocioNuevo.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdDescLineaUno"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Descripcion"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["FechaRegistro"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Relacion"].ToString().Trim(),
                ...
                else
                {
                    loadGridLineaNegocioNuevo();
                    TbLineaNegocioNuevo.Visible = false;
                    Mensaje1("No se encontraron Linea Negocio. ");
                }

            }
            catch (Exception ex)
            {
                Mensaje1("Error cargando Linea Negocio. " + ex.Message);
            }
        }

        protected void GVLineaNegocioNuevo_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridLineaNegocioNuevo = e.NewPageIndex;
            GVLineaNegocioNuevo.PageIndex = PagIndexInfoGridLineaNegocioNuevo;
            GVLineaNegocioNuevo.DataSource = InfoGridLineaNegocioNuevo;
            GVLineaNegocioNuevo.DataBind();
        }

        protected void GVLineaNegocioNuevo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVLineaNegocioNuevo.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdLineaNegocioNuevoriginador = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarLineaNegocio(Session["tmpIdRiesgo"].ToString(), IdLineaNegocioNuevoriginador);
                        GVLineaNegocioNuevo_reload();

                        break;

                    case "Ver":

                        ShowInfoLineaNegocioNuevo(colsNoVisible);
        ...
        private void ShowInfoLineaNegocioNuevo(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdLineaNegocioNuevo.Text = colsNoVisible[0].ToString();
            TBLINombreNuevo.Text = colsNoVisible[1].ToString();
            TBLIFechaRegistroNuevo.Text = colsNoVisible[2].ToString();
        }
        #endregion

        #region ActivoAfectadoNuevo
        private int pagIndexInfoGridActivoAfectadoNuevo;

        private int PagIndexInfoGridActivoAfectadoNuevo
        {
            get
            {
                pagIndexInfoGridActivoAfectadoNuevo = (int)ViewState["pagIndexInfoGridActivoAfectadoNuevo"];
                return pagIndexInfoGridActivoAfectadoNuevo;
            }
            set
            {
                pagIndexInfoGridActivoAfectadoNuevo = value;
                ViewState["pagIndexInfoGridActivoAfectadoNuevo"] = pagIndexInfoGridActivoAfectadoNuevo;
            }
        }

        private void inicializarActivoAfectadoNuevo()
        {
            PagIndexInfoGridActivoAfectadoNuevo = 0;
        }

        private DataTable infoGridActivoAfectadoNuevo;
        private DataTable InfoGridActivoAfectadoNuevo
        {
            get
            {
                infoGridActivoAfectadoNuevo = (DataTable)ViewState["infoGridActivoAfectadoNuevo"];
                return infoGridActivoAfectadoNuevo;
            }
            set
            {
                infoGridActivoAfectadoNuevo = value;
                ViewState["infoGridActivoAfectadoNuevo"] = infoGridActivoAfectadoNuevo;
            }
        }

        private void GVActivoAfectadoNuevo_reload()
        {
            TbActivoAfectadoNuevo.Visible = false;
            inicializarActivoAfectadoNuevo();
            loadGridActivoAfectadoNuevo();
            loadInfoActivoAfectadoNuevo();
        }

        private void loadGridActivoAfectadoNuevo()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdActivoAfectado", typeof(string));
            grid.Columns.Add("Activo", typeof(string));
            ...
            GVActivoAfectadoNuevo.PageIndex = PagIndexInfoGridActivoAfectadoNuevo;
            InfoGridActivoAfectadoNuevo = grid;
            GVActivoAfectadoNuevo.DataSource = InfoGridActivoAfectadoNuevo;
            GVActivoAfectadoNuevo.DataBind();
        }

        private void loadInfoActivoAfectadoNuevo()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoActivoAfectado(TBBAANombreNuevo.Text, Session["tmpIdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbActivoAfectadoNuevo.Visible = true;
                        InfoGridActivoAfectadoNuevo.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdActivoAfectado"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Activo"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["TipoActivo"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["FechaRegistro"].ToString().Trim(),
        ...
        protected void GVActivoAfectadoNuevo_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridActivoAfectadoNuevo = e.NewPageIndex;
            GVActivoAfectadoNuevo.PageIndex = PagIndexInfoGridActivoAfectadoNuevo;
            GVActivoAfectadoNuevo.DataSource = InfoGridActivoAfectadoNuevo;
            GVActivoAfectadoNuevo.DataBind();
        }

        protected void GVActivoAfectadoNuevo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVActivoAfectadoNuevo.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdActivoAfectadoNuevo = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarActivoAfectado(Session["tmpIdRiesgo"].ToString(), IdActivoAfectadoNuevo);
                        GVActivoAfectadoNuevo_reload();

                        break;

                    case "Ver":

                        ShowInfoActivoAfectadoNuevo(colsNoVisible);
        ...
        private void ShowInfoActivoAfectadoNuevo(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdActivoAfectadoNuevo.Text = colsNoVisible[0].ToString();
            TBAANombreNuevo.Text = colsNoVisible[1].ToString();
            TBAATipoActivoNuevo.Text = colsNoVisible[2].ToString();
            TBAAFechaRegistroNuevo.Text = colsNoVisible[3].ToString();
        }
        #endregion

        #region DimValoracionNuevo
        private int pagIndexInfoGridDimValoracionNuevo;

        private int PagIndexInfoGridDimValoracionNuevo
        {
            get
            {
                pagIndexInfoGridDimValoracionNuevo = (int)ViewState["pagIndexInfoGridDimValoracionNuevo"];
                return pagIndexInfoGridDimValoracionNuevo;
            }
            set
            {
                pagIndexInfoGridDimValoracionNuevo = value;
                ViewState["pagIndexInfoGridDimValoracionNuevo"] = pagIndexInfoGridDimValoracionNuevo;
            }
        }

        private void inicializarDimValoracionNuevo()
        {
            PagIndexInfoGridDimValoracionNuevo = 0;
        }

        private DataTable infoGridDimValoracionNuevo;
        private DataTable InfoGridDimValoracionNuevo
        {
            get
            {
                infoGridDimValoracionNuevo = (DataTable)ViewState["infoGridDimValoracionNuevo"];
                return infoGridDimValoracionNuevo;
            }
            set
            {
                infoGridDimValoracionNuevo = value;
                ViewState["infoGridDimValoracionNuevo"] = infoGridDimValoracionNuevo;
            }
        }

        private void GVDimValoracionNuevo_reload()
        {
            TbDimValoracionNuevo.Visible = false;
            inicializarDimValoracionNuevo();
            loadGridDimValoracionNuevo();
            loadInfoDimValoracionNuevo();
        }

        private void loadGridDimValoracionNuevo()
        {
            DataTable grid = new DataTable();
            grid.Columns.Add("IdDimValoracion", typeof(string));
            grid.Columns.Add("Dimensiones", typeof(string));
            ...
            GVDimValoracionNuevo.PageIndex = PagIndexInfoGridDimValoracionNuevo;
            InfoGridDimValoracionNuevo = grid;
            GVDimValoracionNuevo.DataSource = InfoGridDimValoracionNuevo;
            GVDimValoracionNuevo.DataBind();
        }

        private void loadInfoDimValoracionNuevo()
        {
            try
            {
                DataTable dtInfo = new DataTable();

                dtInfo = cRiesgo.LoadInfoDimValoracion(TBBDVNombreNuevo.Text, Session["tmpIdRiesgo"].ToString());

                if (dtInfo.Rows.Count > 0)
                {
                    for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                    {
                        TbDimValoracionNuevo.Visible = true;
                        InfoGridDimValoracionNuevo.Rows.Add(new Object[] {
                                                                dtInfo.Rows[rows]["IdDimValoracion"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Dimensiones"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["FechaRegistro"].ToString().Trim(),
                                                                dtInfo.Rows[rows]["Relacion"].ToString().Trim(),
        ...
        protected void GVDimValoracionNuevo_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            PagIndexInfoGridDimValoracionNuevo = e.NewPageIndex;
            GVDimValoracionNuevo.PageIndex = PagIndexInfoGridDimValoracionNuevo;
            GVDimValoracionNuevo.DataSource = InfoGridDimValoracionNuevo;
            GVDimValoracionNuevo.DataBind();
        }

        protected void GVDimValoracionNuevo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                System.Collections.Specialized.IOrderedDictionary colsNoVisible = GVDimValoracionNuevo.DataKeys[Convert.ToInt16(e.CommandArgument)].Values;

                switch (e.CommandName)
                {
                    case "DesEnlazar":

                        string IdDimValoracionNuevo = colsNoVisible[0].ToString();
                        cRiesgo.RelacionarDimValoracion(Session["tmpIdRiesgo"].ToString(), IdDimValoracionNuevo);
                        GVDimValoracionNuevo_reload();

                        break;

                    case "Ver":

                        ShowInfoDimValoracionNuevo(colsNoVisible);
        ...
        private void ShowInfoDimValoracionNuevo(System.Collections.Specialized.IOrderedDictionary colsNoVisible)
        {
            TBIdDimValoracionNuevo.Text = colsNoVisible[0].ToString();
            TBDVNombreNuevo.Text = colsNoVisible[1].ToString();
            TBDVFechaRegistroNuevo.Text = colsNoVisible[2].ToString();
        }
        #endregion
        //set
        #region Treeview
        ...
        private void loadDDLRiesgoTecnologico()
        {
            try
            {
                loadDDLFactorRO();
            ...
            {
                Mensaje1("Error al cargar información de Riesgo Tecnológico. " + ex.Message);
            }
        }
        ...
        private void loadDDLFactorRO()
        {
            ...
            {
                DataTable dtInfo = new DataTable();
                dtInfo = cEvsEIncs.LoadDDLFactorRO();
                for (int i = 0; i < dtInfo.Rows.Count; i++)
                {
                    DDLFactorRO.Items.Insert(i + 1, new ListItem(dtInfo.Rows[i]["Descripcion"].ToString().Trim(), dtInfo.Rows[i]["IdDesFactorRO"].ToString()));
                    DDLFactorRO1.Items.Insert(i + 1, new ListItem(dtInfo.Rows[i]["Descripcion"].ToString().Trim(), dtInfo.Rows[i]["IdDesFactorRO"].ToString()));
                }
            }
            catch (Exception ex)
            {
        ...
        private void loadDDLClasificacion()
        {
            try
            {
                ...
                for (int i = 0; i < dtInfo.Rows.Count; i++)
                {
                    DDLRiesgosGlobales.Items.Insert(i + 1, new ListItem(dtInfo.Rows[i]["NombreClasificacionRiesgo"].ToString().Trim(), dtInfo.Rows[i]["IdClasificacionRiesgo"].ToString()));
                    DDLRiesgosGlobales1.Items.Insert(i + 1, new ListItem(dtInfo.Rows[i]["NombreClasificacionRiesgo"].ToString().Trim(), dtInfo.Rows[i]["IdClasificacionRiesgo"].ToString()));
        ...
        private void loadDDLClasificacionGeneral(string IdClasificacionRiesgo, int Tipo)
        {
            try
            {
                ...
                DropDownList ddlClasificacion = (Tipo == 1) ? DropDownList2 : DropDownList57;

                for (int i = 0; i < dtInfo.Rows.Count; i++)
                {
                    ddlClasificacion.Items.Insert(i + 1, new ListItem(dtInfo.Rows[i]["NombreClasificacionGeneralRiesgo"].ToString().Trim(), dtInfo.Rows[i]["IdClasificacionGeneralRiesgo"].ToString()));
                }
            }
            catch (Exception ex)
            {
        ...
        private void loadGridRiesgos()
        {
            ...
            grid.Columns.Add("IdActivoAfectado", typeof(string));
            grid.Columns.Add("IdFactorRO", typeof(string));
            grid.Columns.Add("IdTipoActivo", typeof(string));
            grid.Columns.Add("IdDimensiones", typeof(string));
        ...
        private void loadInfoRiesgoTecnologico()
        {
            string mensaje = "";
            try
            {
                DataRow RowInfo = InfoGridRiesgos.Rows[RowGridRiesgos];

                DDLFactorRO1.SelectedValue = RowInfo["IdFactorRO"].ToString().Trim();
                mensaje = RowInfo["IdDimensiones"].ToString().Trim();
                GVProducto_reload();
                GVLineaNegocio_reload();

                string valueRiesgoGlobal = DDLRiesgosGlobales1.SelectedValue.ToString().Trim();
                if (valueRiesgoGlobal == "2" || valueRiesgoGlobal == "3")
                {
                    TabPanelActivoAfectado.Visible = TabPanelDimValoracion.Visible = true;
                    TabContainerMultiple.ActiveTab = TabPanelLineasdeNegocio;
                ...
                {
                    TabPanelActivoAfectado.Visible = TabPanelDimValoracion.Visible = false;
                    TabContainerMultiple.ActiveTab = TabPanelLineasdeNegocio;
                }
            }
            catch (Exception ex)
            {
                Mensaje1($"Error al mostrar información de Riesgo Tecnológico. {mensaje} " + ex.Message);
            }
        }
        ...
        protected void DDLRiesgosGlobales_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            loadFilasRiesgosNuevo(DDLRiesgosGlobales.SelectedValue, 1);
        ...
        protected void DDLRiesgosGlobales1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            loadFilasRiesgos(DDLRiesgosGlobales1.SelectedValue, 2);
        }

        private void loadFilasRiesgos(string IdRiesgoGlobal, int Tipo)
        {
            loadDDLClasificacionGeneral(IdRiesgoGlobal, Tipo);

            if (IdRiesgoGlobal.Equals("2") || IdRiesgoGlobal.Equals("3"))
            {
                TabPanelActivoAfectado.Visible = TabPanelDimValoracion.Visible = true;
                TabContainerMultiple.ActiveTab = TabPanelLineasdeNegocio;
        ...
        private void loadFilasRiesgosNuevo(string IdRiesgoGlobal, int Tipo)
        {
            loadDDLClasificacionGeneral(IdRiesgoGlobal, Tipo);

            if (IdRiesgoGlobal.Equals("2") || IdRiesgoGlobal.Equals("3"))
            {
                TabPanelActivoAfectadoNuevo.Visible = TabPanelDimValoracionNuevo.Visible = true;
                TabContainerMultipleNuevo.ActiveTab = TabPanelLineasdeNegocioNuevo;
            ...
            {
                TabPanelActivoAfectadoNuevo.Visible = TabPanelDimValoracionNuevo.Visible = false;
                TabContainerMultipleNuevo.ActiveTab = TabPanelLineasdeNegocioNuevo;
            }
        ...
        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                string tabla = validarTablasMultiples();
                if (!tabla.Equals(""))
                {
                    omb.ShowMessage("Debe relacionar " + tabla, 3, "Atención");
                }
                else
                {
        ...
        protected void ImageButton8_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                Session["tmpIdRiesgo"] = -new Random().Next(1111, 9999);
                resetValuesAgregarRiesgo();
                loadCodigoRiesgo();
                GrillaVariablesCategorias();
                CargaGrillaVariablesCategorias();
        ...
        protected void ImageButton12_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                Mensaje1("Error al buscar riesgos. " + ex.Message);
            }
        }
        ...
        private void resetValuesModificarRiesgo()
        {
            ...
            DropDownList55.Items.Clear();
            DropDownList55.Items.Insert(0, new ListItem("---", "0"));
            DDLRiesgosGlobales1.SelectedIndex = 0;
            DropDownList57.Items.Clear();
            DropDownList57.Items.Insert(0, new ListItem("---", "0"));
            DropDownList58.Items.Clear();
            DropDownList58.Items.Insert(0, new ListItem("---", "0"));
        ...
        protected void MtdStard()
        {
            ...
            MtdLoadIndicadoresVsRiesgo(ref strErrMsg);
        ...
        private void mtdLoadInfoAudRiesgoControl1(string IdRiesgo)
        {
            DataTable dtInfo = new DataTable();
            PromedioControl = 0;
            dtInfo = cRiesgo.mtdLoadInfoAudRiesgoControl1(IdRiesgo);
        ...
        {
            bool validar = true;
            if (InfoGridControlesRiesgo != null)
            {
        ...
        private void modificarRiesgo()
        {
            ...
            int IdTipoCalificacion = RadioTipoCalificacion.SelectedIndex;

            cRiesgo.modificarRiesgo(
                DropDownList47.SelectedValue.ToString().Trim(),
                DropDownList48.SelectedValue.ToString().Trim(),
                DropDownList49.SelectedValue.ToString().Trim(),
                DropDownList50.SelectedValue.ToString().Trim(),
                DropDownList51.SelectedValue.ToString().Trim(),
                ...
                DropDownList55.SelectedValue.ToString().Trim(),
                DDLRiesgosGlobales1.SelectedValue.ToString().Trim(),
                DropDownList57.SelectedValue.ToString().Trim(),
                DropDownList58.SelectedValue.ToString().Trim(),
                ListaRiesgoAsociadoLA,
                ListaFactorRiesgoLAFT,
                TextBox3.Text.Trim(),
                TextBox4.Text.Trim(),
                ListaCausas,
                ListaConsecuencias,
                lblIdDependencia3.Text.Trim(),
                DropDownList66.SelectedValue.ToString().Trim(),
                TextBox5.Text.Trim(),
                TextBox6.Text.Trim(),
                DropDownList68.SelectedValue.ToString().Trim(),
                TextBox7.Text.Trim(),
                TextBox10.Text.Trim(),
                ListaTratamiento,
                InfoGridRiesgos.Rows[RowGridRiesgos]["IdRiesgo"].ToString().Trim(),
                ...
                IdEstado,
                IdTipoCalificacion,
                DDLFactorRO1.SelectedValue.ToString().Trim()
                );
        }
        ...
        private void registrarRiesgo()
        {
            ...
            if (SeleccionaCalificacion.SelectedIndex == 0)
            {
                cRiesgo.registrarRiesgo(Session["tmpIdRiesgo"].ToString().Trim(), DropDownList41.SelectedValue.ToString().Trim(), DropDownList42.SelectedValue.ToString().Trim(),
                ...
                DropDownList6.SelectedValue.ToString().Trim(), DropDownList11.SelectedValue.ToString().Trim(), DDLRiesgosGlobales.SelectedValue.ToString().Trim(),
                DropDownList2.SelectedValue.ToString().Trim(), DropDownList3.SelectedValue.ToString().Trim(), ListaRiesgoAsociadoLA, ListaFactorRiesgoLAFT, TextBox8.Text.Trim(), TextBox9.Text.Trim(), TextBox1.Text.Trim(), ListaCausas, ListaConsecuencias,
                ...
                cbEstadoRiesgo.SelectedIndex.ToString(), "0", DDLFactorRO.SelectedValue.ToString().Trim());
            }
            else if (SeleccionaCalificacion.SelectedIndex == 1)
            {
                //Aqui 
                ...
                DropDownList6.SelectedValue.ToString().Trim(), DropDownList11.SelectedValue.ToString().Trim(), DDLRiesgosGlobales.SelectedValue.ToString().Trim(),
                DropDownList2.SelectedValue.ToString().Trim(), DropDownList3.SelectedValue.ToString().Trim(), ListaRiesgoAsociadoLA, ListaFactorRiesgoLAFT, TextBox8.Text.Trim(), TextBox9.Text.Trim(), TextBox1.Text.Trim(), ListaCausas, ListaConsecuencias,
                lblIdDependencia2.Text.Trim(), IdFrecuenciaEvento.ToString().Trim(), "0", "0", IdImpactoEvento.ToString().Trim(), "0", "0", ListaTratamiento, lblIdDependencia5.Text,
                cbEstadoRiesgo.SelectedIndex.ToString(), "1", DDLFactorRO.SelectedValue.ToString().Trim());
        ...
        private string validarTablasMultiples()
        {
            string tabla = "";
            string idSessionRiesgo = NuevoRiesgo == 1 ? Session["tmpIdRiesgo"].ToString().Trim() : Session["IdRiesgo"].ToString().Trim();
            DataTable dtInformacion = new DataTable();

            dtInformacion = cRiesgo.validarTablasMultiples(idSessionRiesgo, "Riesgos_LineaNegocios");
            if (dtInformacion.Rows.Count == 0) tabla = "línea de negocio";

            dtInformacion = cRiesgo.validarTablasMultiples(idSessionRiesgo, "Riesgos_Productos");
            if (dtInformacion.Rows.Count == 0) tabla = "producto";
        ...
        private void detalleRiesgoSeleccionado()
        {
            ...
            for (int i = 0; i < DDLRiesgosGlobales1.Items.Count; i++)
            {
                DDLRiesgosGlobales1.SelectedIndex = i;
                if (DDLRiesgosGlobales1.SelectedValue.ToString().Trim() == InfoGridRiesgos.Rows[RowGridRiesgos]["IdClasificacionRiesgo"].ToString().Trim())
                {
                    loadFilasRiesgos(DDLRiesgosGlobales1.SelectedValue.ToString().Trim(), 2);
                    break;
                }
                else
                {
        ...
        private void LoadCBEstadoss()
        {
            try
            {
                string valorConsulta = TextBox2.Text.Trim();
                DataTable dtInfo = new DataTable();
                dtInfo = cRiesgo.loadCBEstadoss(valorConsulta);

                for (int i = 0; i < dtInfo.Rows.Count; i++)
                {
                    string valor1 = Convert.ToString(dtInfo.Rows[i]["idEstado"].ToString().Trim());

                    DataTable dtInfo2 = new DataTable();
                    dtInfo2 = cRiesgo.loadCBEstadosss(valor1);



                    cbEstado.SelectedValue = Convert.ToString(dtInfo2.Rows[i]["NombreEstado"].ToString().Trim());
                }
            }
            catch (Exception ex)
            {
        ...
        {
            PagIndexInfoGridIR = e.NewPageIndex;
        ...
        //carga de todas las frecuencias
        private bool MtdLoadIndicadoresVsRiesgo(ref string strErrMsg)
        {
            #region Vars
            bool booResult = false;
            ...
            #endregion Vars
            lstRiesgoInd = cRiesgoInd.mtdConsultarRiesgosIndicadores(booResult, ref strErrMsg, TextBox2.Text.ToString().Trim());
        ...
        private void mtdLoadIndicadoresVsRiesgo(List<clsDTOriesgosIndicadores> lstRiesgoInd)
        {
            string strErrMsg = string.Empty;
            //clsControlInfraestructuraBLL cCrlInfra = new clsControlInfraestructuraBLL();

            foreach (clsDTOriesgosIndicadores objRiesgosIndicadores in lstRiesgoInd)
            {
        ...
        protected void BtnBuscarProductoCancel_Click(object sender, ImageClickEventArgs e)
        {
            TBBPONombre.Text = "";
            GVProducto_reload();
        }

        protected void BtnDesEnlazarProducto_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdProducto.Text.Equals(""))
                {
                    cRiesgo.RelacionarProducto(Session["IdRiesgo"].ToString(), TBIdProducto.Text);
                    GVProducto_reload();
                }
                else
                {
                    Mensaje1("Seleccione un producto");
                }
            }
            catch (Exception ex)
            {
                Mensaje1($"Error asociando/desasociando proceso originador: {ex}");
            }
        }

        protected void BtnBuscarLineaNegocio_Click(object sender, ImageClickEventArgs e)
        {
            GVLineaNegocio_reload();
        }

        protected void BtnBuscarLineaNegocioCancel_Click(object sender, ImageClickEventArgs e)
        {
            TBBLINombre.Text = "";
            GVLineaNegocio_reload();
        }

        protected void BtnDesEnlazarLineaNegocio_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdLineaNegocio.Text.Equals(""))
                {
                    cRiesgo.RelacionarLineaNegocio(Session["IdRiesgo"].ToString(), TBIdLineaNegocio.Text);
                    GVLineaNegocio_reload();
                }
                else
                {
                    Mensaje1("Seleccione una Linea de Negocio");
                }
            }
            catch (Exception ex)
            {
                Mensaje1($"Error asociando/desasociando linea de negocio: {ex}");
            }
        }

        protected void BtnBuscarActivoAfectado_Click(object sender, ImageClickEventArgs e)
        {
            GVActivoAfectado_reload();
        }

        protected void BtnBuscarActivoAfectadoCancel_Click(object sender, ImageClickEventArgs e)
        {
            TBBAANombre.Text = "";
            GVActivoAfectado_reload();
        }

        protected void BtnDesEnlazarActivoAfectado_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdActivoAfectado.Text.Equals(""))
                {
                    cRiesgo.RelacionarActivoAfectado(Session["IdRiesgo"].ToString(), TBIdActivoAfectado.Text);
                    GVActivoAfectado_reload();
                }
                else
                {
            ...
            {
                Mensaje1($"Error asociando/desasociando activo afectado: {ex}");
            }
        }

        protected void BtnBuscarDimValoracion_Click(object sender, ImageClickEventArgs e)
        {
            GVDimValoracion_reload();
        }

        protected void BtnBuscarDimValoracionCancel_Click(object sender, ImageClickEventArgs e)
        {
            TBBDVNombre.Text = "";
            GVDimValoracion_reload();
        }

        protected void BtnDesEnlazarDimValoracion_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdDimValoracion.Text.Equals(""))
                {
                    cRiesgo.RelacionarDimValoracion(Session["IdRiesgo"].ToString(), TBIdDimValoracion.Text);
                    GVDimValoracion_reload();
                }
                else
                {
        ...
        protected void BtnBuscarProductoNuevo_Click(object sender, ImageClickEventArgs e)
        {
            GVProductoNuevo_reload();
        }

        protected void BtnBuscarProductoCancelNuevo_Click(object sender, ImageClickEventArgs e)
        {
            TBBPONombreNuevo.Text = "";
            GVProductoNuevo_reload();
        }

        protected void BtnDesEnlazarProductoNuevo_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdProductoNuevo.Text.Equals(""))
                {
                    cRiesgo.RelacionarProducto(Session["tmpIdRiesgo"].ToString(), TBIdProductoNuevo.Text);
                    GVProductoNuevo_reload();
                }
                else
                {
        ...
        protected void BtnBuscarLineaNegocioNuevo_Click(object sender, ImageClickEventArgs e)
        {
            GVLineaNegocioNuevo_reload();
        }

        protected void BtnBuscarLineaNegocioCancelNuevo_Click(object sender, ImageClickEventArgs e)
        {
            TBBLINombreNuevo.Text = "";
            GVLineaNegocioNuevo_reload();
        }

        protected void BtnDesEnlazarLineaNegocioNuevo_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdLineaNegocioNuevo.Text.Equals(""))
                {
                    cRiesgo.RelacionarLineaNegocio(Session["tmpIdRiesgo"].ToString(), TBIdLineaNegocioNuevo.Text);
                    GVLineaNegocioNuevo_reload();
                }
                else
                {
        ...
        protected void BtnBuscarActivoAfectadoNuevo_Click(object sender, ImageClickEventArgs e)
        {
            GVActivoAfectadoNuevo_reload();
        }

        protected void BtnBuscarActivoAfectadoCancelNuevo_Click(object sender, ImageClickEventArgs e)
        {
            TBBAANombreNuevo.Text = "";
            GVActivoAfectadoNuevo_reload();
        }

        protected void BtnDesEnlazarActivoAfectadoNuevo_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdActivoAfectadoNuevo.Text.Equals(""))
                {
                    cRiesgo.RelacionarActivoAfectado(Session["tmpIdRiesgo"].ToString(), TBIdActivoAfectadoNuevo.Text);
                    GVActivoAfectadoNuevo_reload();
                }
                else
                {
                    Mensaje1("Seleccione una Activo");
                }
            }
            catch (Exception ex)
            {
        ...
        protected void BtnBuscarDimValoracionNuevo_Click(object sender, ImageClickEventArgs e)
        {
            GVDimValoracionNuevo_reload();
        }

        protected void BtnBuscarDimValoracionCancelNuevo_Click(object sender, ImageClickEventArgs e)
        {
            TBBDVNombreNuevo.Text = "";
            GVDimValoracionNuevo_reload();
        }

        protected void BtnDesEnlazarDimValoracionNuevo_Click(object sender, ImageClickEventArgs e)
        {
            try
            {

                if (!TBIdDimValoracionNuevo.Text.Equals(""))
                {
                    cRiesgo.RelacionarDimValoracion(Session["tmpIdRiesgo"].ToString(), TBIdDimValoracionNuevo.Text);
                    GVDimValoracionNuevo_reload();
                }
                else
                {
                    Mensaje1("Seleccione dimensión de valoración");
                }
            }
            catch (Exception ex)
            {
