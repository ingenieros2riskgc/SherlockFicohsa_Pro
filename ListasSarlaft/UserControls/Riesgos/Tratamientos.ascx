                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GVtratamientos" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="intIdTratamiento" HeaderText="Código" SortExpression="intIdTratamiento" 
                                            ItemStyle-HorizontalAlign="Center" visible="true"/>
                                        <asp:TemplateField HeaderText="Tratamiento" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:ImageButton ID="IBinsertGVC" runat="server" CausesValidation="true" CommandName="Insert"
                                    ImageUrl="~/Imagenes/Icons/guardarV5.png" Text="Insert" ValidationGroup="VGtratamiento" ToolTip="Insertar" Visible="false" OnClick="IBinsertGVC_Click"/>
