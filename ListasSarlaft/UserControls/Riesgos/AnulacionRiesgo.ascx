                            ...
                            <td>
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/selectV5.png" Text="Ver"
                                            CommandName="Ver" />
                                    </Columns>
            ...
            <tr runat="server" id="TReventos" visible="false">
                <td align="center">
                    <asp:GridView ID="GVeventosRiesgos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    OnRowCommand="GridView2_RowCommand" HeaderStyle-HorizontalAlign="Center">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
        ...
        <asp:Panel ID="pnlMsgBoxOkNo" runat="server" Width="400px" Style="display: none;"
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td valign="middle" align="left">
                        <asp:Label ID="lblMsgBoxOkNo" runat="server" Font-Names="Calibri" Font-Size="Small" style="color:#000000"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="right" colspan="2">
