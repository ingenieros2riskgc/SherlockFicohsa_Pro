                                             ...
                                             <tr id="trRiesgoA" runat="server" align="center">
                                                <td colspan="2" runat="server">
                                                   <asp:GridView ID="GVriesgos" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" CellPadding="4" DataKeyNames="ListaCausas,IdRiesgo,IdProbabilidad,IdImpacto" Font-Names="Calibri" Font-Size="Small" ForeColor="#333333" GridLines="Vertical" HorizontalAlign="Center" OnRowCommand="GVriesgos_RowCommand" ShowHeaderWhenEmpty="True" Visible="False">
                                                      ...
                                                      <EditRowStyle BackColor="#999999" />
                                                      <FooterStyle BackColor="#002649" Font-Bold="True" ForeColor="White" />
                                                      <HeaderStyle BackColor="#002649" CssClass="gridViewHeader" Font-Bold="True" ForeColor="White" />
                                                      <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                ...
                                                <td runat="server">
                                                   <table id="TbCrearVariables" runat="server" align="center">
                                                      <tr id="Tr4" runat="server" align="center">
                                                         <td runat="server" bgcolor="#002649">
                                                   ...
                                                   <table id="TbAddVaiables" runat="server" align="left" visible="False">
                                                      <tr id="Tr9" runat="server" align="center">
                                                         <td id="Td36" runat="server" bgcolor="#002649" colspan="2">
                                                      ...
                                                      <tr id="Tr16" runat="server">
                                                         <td id="Td37" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="TrValorVariable" runat="server" visible="False">
                                                         <td id="Td1" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="Tr17" runat="server">
                                                         <td id="Td39" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                            <asp:Label ID="Label12" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Formato:"></asp:Label>
                                                         </td>
                                                         <td id="Td41" runat="server">
                                                            <asp:DropDownList ID="DropDownListFormato" runat="server" Font-Names="Calibri" Font-Size="Small" Width="150px"></asp:DropDownList>
                                                      ...
                                                      <tr runat="server">
                                                         <td runat="server" align="center" colspan="2">
                                                            <asp:ImageButton ID="BtnGuardarVariable" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="BtnGuardarVariable_Click" Style="height: 20px; width: 20px;" ToolTip="Guardar" ValidationGroup="AddVariable" />
                                                   ...
                                                   <table id="TbModificaVariable" runat="server" align="left" visible="False">
                                                      <tr id="Tr21" runat="server" align="center">
                                                         <td id="Td47" runat="server" bgcolor="#002649" colspan="2">
                                                      ...
                                                      <tr id="Tr22" runat="server">
                                                         <td id="Td48" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="TrValorVariableUp" runat="server" visible="False">
                                                         <td id="Td3" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="Tr23" runat="server">
                                                         <td id="Td52" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                            <asp:Label ID="Label16" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Formato:"></asp:Label>
                                                         </td>
                                                         <td id="Td53" runat="server">
                                                            <asp:DropDownList ID="DropDownListFormatoUp" runat="server" Font-Names="Calibri" Font-Size="Small" Width="150px"></asp:DropDownList>
                                                      ...
                                                      <tr id="Tr24" runat="server">
                                                         <td id="Td54" runat="server" align="center" colspan="2">
                                                            <asp:ImageButton ID="BtnModificaVariable" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="BtnModificaVariable_Click" Style="height: 20px; width: 20px;" ToolTip="Guardar" ValidationGroup="updateVariable" />
                                                ...
                                                <td id="Td8" runat="server" class="auto-style1">
                                                   <table id="TbMetas" runat="server" align="center">
                                                      <tr id="Tr25" runat="server" align="center">
                                                         <td id="Td17" runat="server" bgcolor="#002649">
                                                      ...
                                                      <tr id="Tr26" runat="server">
                                                         <td id="Td56" runat="server">
                                                            <asp:GridView ID="GridViewMetas" runat="server" AutoGenerateColumns="False"
                                                               ...
                                                               GridLines="Vertical" OnRowCommand="GridViewMetas_RowCommand" PageSize="6" ShowHeaderWhenEmpty="True" OnPreRender="GridViewMetas_PreRender" Width="564px">
                                                               <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                               <Columns>
                                                                  ...
                                                                  <asp:TemplateField HeaderText="Tipo Frecuencia" Visible="True">
                                                                     <ItemTemplate>
                                                                        <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100px">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="Valor Frecuencia" Visible="False">
                                                                     <ItemTemplate>
                                                                        <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 100px" >
                                                   ...
                                                   <table id="TbAddMetas" runat="server" align="left" visible="False">
                                                      <tr id="Tr28" runat="server" align="center">
                                                         <td id="Td58" runat="server" bgcolor="#002649" colspan="4">
                                                      ...
                                                      <tr id="Tr30" runat="server">
                                                         <td id="Td61" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="TrfechasIns" runat="server" visible="False">
                                                         <td id="TdAñoMeta" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                         ...
                                                         <td id="TdmesMeta" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="Tr29" runat="server">
                                                         <td id="Td59" runat="server" bgcolor="#002649" style="color: #FFFFFF; font-weight: 700">
                                                      ...
                                                      <tr id="justificacionId" runat="server">
                                                         <td bgcolor="#BBBBBB" runat="server">
                                                      ...
                                                      <tr id="justificacionId2" runat="server">
                                                         <td colspan="2" runat="server">
                                                            <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                               ...
                                                               <Columns>
                                                                  <asp:BoundField DataField="Id" HeaderText="IdComentario" Visible="False"></asp:BoundField>
                                                                  <asp:BoundField DataField="NombreUsuario" HeaderText="Nombre Usuario">
                                                                     <ItemStyle HorizontalAlign="Center" />
                                                                  </asp:BoundField>
                                                                  <asp:BoundField DataField="FechaModificacion" HeaderText="Fecha Registro">
                                                                     <ItemStyle HorizontalAlign="Center" />
                                                                  </asp:BoundField>
                                                                  <asp:BoundField DataField="JustificacionCambio" HeaderText="Justificación">
                                                                     <ItemStyle HorizontalAlign="Center" />
                                                                  </asp:BoundField>
                                                                  <asp:BoundField DataField="JustificacionCambio" HeaderText="Comentario" Visible="False">
                                                                     <ItemStyle HorizontalAlign="Center" />
                                                                  </asp:BoundField>
                                                               ...
                                                               <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" CssClass="gridViewHeader" HorizontalAlign="Center"></HeaderStyle>
                                                      ...
                                                      <tr id="Tr31" runat="server">
                                                         <td id="Td63" runat="server" align="center" colspan="2">
                                                            <asp:ImageButton ID="BtnGuardarMeta" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="BtnGuardarMeta_Click" Style="height: 20px; " ToolTip="Guardar" ValidationGroup="AddMeta" Visible="False" />
                                                            <asp:ImageButton ID="BtnUpdaterMeta" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png" OnClick="BtnUpdaterMeta_Click" Style="height: 20px; " ToolTip="Guardar" ValidationGroup="AddMeta" Visible="False" />
                                                ...
                                                <td>
                                                   <table id="TbSeleccionarVariables" runat="server" align="center" visible="False">
                                                      <tr id="Tr10" runat="server" align="center">
                                                         <td id="Td7" runat="server" bgcolor="#002649">
                                                ...
                                                <td runat="server">
                                                   <table id="LaFormula" runat="server" align="center">
                                                      <tr id="Tr12" runat="server" align="center">
                                                         <td id="Td29" runat="server" bgcolor="#002649" colspan="2">
                                                      ...
                                                      <tr id="Tr13" runat="server">
                                                         ...
                                                         <td id="Td31" runat="server">
                                                            Dar resultado en % 
                                                            <asp:CheckBox runat="server" ID="ckbResultPor" />
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr id="Tr14" runat="server">
                                                         <td id="Td32" runat="server">
                                                            <asp:Label ID="Label13" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Medium" Style="font-weight: 700; color: #002649;"></asp:Label>
                                                            <asp:Label ID="lblIdFormula" runat="server" Visible="false"></asp:Label>
                                                         </td>
                                                         <td id="Td33" runat="server">
                                                            <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="Small" Style="font-weight: 700; color: #002649;" Text="_________________________________________________________"></asp:Label>
                                                            <br /><br />
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr runat="server">
                                                         <td align="center" colspan="2" runat="server">
                                                            <asp:ImageButton ID="IBinsertFormula" runat="server" CommandName="Insert" ImageUrl="~/Imagenes/Icons/guardarV5.png" OnClick="IBinsertFormula_Click" Text="Insert" ToolTip="Insertar" ValidationGroup="VGprograma" Width="20px" />
                                                            <asp:ImageButton ID="IBupdateFormula" runat="server" CommandName="Update" ImageUrl="~/Imagenes/Icons/guardarV5.png" OnClick="IBupdateFormula_Click" Text="Update" ToolTip="Actualizar" ValidationGroup="VGprograma" Visible="False" />
                                                            <asp:ImageButton ID="IBcancelFormula" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png" ToolTip="Cancelar" Visible="False" />
                                                         </td>
                                                      </tr>
                                                   </table>
                                                </td>
                                       ...
                                       <ContentTemplate>
                                          <div id="dvContentSeguimiento" runat="server">
                                             <table id="tbGridSeguimiento" runat="server" align="center">
                                                   ...
                                                   <td>
                                                      <asp:GridView ID="GVseguimiento" runat="server" AllowPaging="True" AllowSorting="True"
                                                         ...
                                                         <Columns>
                                                            ...
                                                            <asp:ButtonField ButtonType="Image" CommandName="ModificarSeguimiento" HeaderText="Modificar" ImageUrl="~/Imagenes/Icons/editV5.png" Text="ModificarSeguimiento">
                                                               <ItemStyle HorizontalAlign="Center" />
                                                            </asp:ButtonField>
                                                            <asp:ButtonField ButtonType="Image" CommandName="EliminarSeguimiento" HeaderText="Eliminar" ImageUrl="~/Imagenes/Icons/deleteV5.png" Text="EliminarSeguimiento">
                                                               <ItemStyle HorizontalAlign="Center" />
                                                            </asp:ButtonField>
                                                         </Columns>
                                                         <EditRowStyle BackColor="#999999" />
                                                ...
                                                <tr>
                                                   <td>
                                                      <asp:ImageButton ID="ImbNewSeguimiento" runat="server" ImageUrl="~/Imagenes/Icons/AddV5.png" OnClick="ImbNewSeguimiento_Click" ToolTip="Agregar" />
                                                   </td>
                                                </tr>
                                             </table>
                                          </div>
                                             ...
                                             <table align="center" class="tabla" width="65%">
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      ...
                                                      <asp:RegularExpressionValidator ID="revValorMinimo" runat="server" ControlToValidate="txtValorMinimo" ErrorMessage="Solo números Enteros o Decimales" ForeColor="Red" ToolTip="Solo números Enteros o Decimales" ValidationExpression="^(-)?(\d{3}\,)?(\d+\,?)+(,\d{2})?$" ValidationGroup="VGseguimiento">*</asp:RegularExpressionValidator>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td class="RowsText">
