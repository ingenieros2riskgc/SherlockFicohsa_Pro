...
namespace ListasSarlaft.UserControls.Riesgos
{
    public partial class Control : System.Web.UI.UserControl
    {
        ...
        protected void habilitarBotones(object sender, EventArgs e)
        {
            if (DropDownList7.Text != "Finalizado")
            {
        ...
        {
            if (DropDownList7.Text == "3" && TextBox10.Text == "" || TextBox10.Text == "1900-01-01")
            {
                Mensaje("Debe ingresar fecha real de cierre válida cuando el estado es Finalizado.");
            }
            else if (DropDownList7.Text == "3" && TextBox10.Text != "" || TextBox10.Text != "1900-01-01")
            {
                try
                {
