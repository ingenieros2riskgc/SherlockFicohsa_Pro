                        ...
                        <tr align="center">
                            <td>
                                <table>
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB" align="center">
                                            <asp:Label ID="Label16" runat="server" Text="Fecha histórico" Font-Names="Calibri"
                                    ...
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB" align="center">
                                            <asp:Label ID="Label13" runat="server" Text="Áreas" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                        </td>
                                        <td bgcolor="#f0eef0">
                                        ...
                                        <td>
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/Icons/selectV5.png" Text="Ver detalle"
                                                        CommandName="Ver" />
                                                </Columns>
                                                <EditRowStyle BackColor="#999999" />
                                                <FooterStyle BackColor="#002649" Font-Bold="True" ForeColor="White" />
                                    ...
                                    <tr align="center" id="trDetalleRiesgo" runat="server" visible="false">
                                        <td>
                                            <table width="100%">
                                                ...
                                                <tr align="center">
                                                    <td>
                                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
