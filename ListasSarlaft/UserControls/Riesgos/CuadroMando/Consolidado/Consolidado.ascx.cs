    ...
    public partial class Consolidado : System.Web.UI.UserControl
    {
        ...
        protected void IBprocess_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                Mensaje("Se debe seleccionar un Tipo de Reporte.");
            }
        }
        ...
        public bool mtdLoadReportXYZ(ref string strErrMsg)
        {
            ...
            catch (Exception ex)
            {
                ...
                Mensaje("Error captura filtros: " + ex);
            }
            ...
            catch (Exception ex)
            {
                ...
                Mensaje("Error en la consulta del reporte: " + ex);
            }
            if (booResult == true)
            {
        ...
        public void mtdViewCharts(System.Data.DataTable dtInfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                Mensaje("Error en la generación del grafico: " + ex);
            }
