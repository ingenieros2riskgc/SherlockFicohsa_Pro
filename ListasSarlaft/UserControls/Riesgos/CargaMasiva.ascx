                ...
                <td>
                    <table>
                        <tr align="center">
                            ...
                            <td>
                                <asp:Button ID="Bload" runat="server" Text="Analizar" OnClick="Bload_Click" style="height: 21px" />
            ...
            <tr>
                <td>
                    ...
                    <ItemStyle HorizontalAlign="Left" Width="100%" />
                        ...
                        <tr>
                            <td align="center">
                                <asp:ImageButton ID="ImbCancel" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
