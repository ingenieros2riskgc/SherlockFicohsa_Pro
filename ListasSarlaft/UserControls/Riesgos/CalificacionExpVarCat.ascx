 ...
 <asp:ModalPopupExtender ID="mpeMsgBox1" runat="server" TargetControlID="btndummy1"
        ...
        <asp:Panel ID="pnlMsgBox1" runat="server" Width="400px" Style="display: none;" BorderColor="#575757"
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="width: 60px" valign="middle" align="center">
                        <asp:Image ID="imgInfo1" runat="server" ImageUrl="~/Imagenes/Icons/icontexto-webdev-aboutV5.png" />
                    </td>
                    <td valign="middle" align="left">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GvVariables" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            DataKeyNames="IdVariable, NombreVariable, Ponderacion" HeaderStyle-HorizontalAlign="Center"
                            OnRowCommand="GvVariables_RowCommand" OnPageIndexChanging="GvVariables_PageIndexChanging">
