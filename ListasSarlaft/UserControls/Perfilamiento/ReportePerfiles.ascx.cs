...
namespace ListasSarlaft.UserControls.Perfilamiento
{
    public partial class ReportePerfiles : System.Web.UI.UserControl
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            dsReporte = cPerfil.mtdConsultarRptPerfiles(Sanitizer.GetSafeHtmlFragment(tbFechaIni.Text.Trim()),
                Sanitizer.GetSafeHtmlFragment(tbFechaFin.Text.Trim()),
                Sanitizer.GetSafeHtmlFragment(tbNroIdentificacion.Text.Trim()),
                ddlPerfil.SelectedValue.Trim() == "0" ? string.Empty : ddlPerfil.SelectedValue.Trim(),
                ref strErrMsg);
