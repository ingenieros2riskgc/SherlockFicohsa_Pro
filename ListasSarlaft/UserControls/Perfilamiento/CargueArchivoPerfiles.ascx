    ...
    <ContentTemplate>
        <table align="center" bgcolor="#EEEEEE">
            ...
            <tr align="center">
                ...
                <td><asp:FileUpload ID="fuArchivoPerfil" runat="server" Font-Names="Calibri" Font-Size="Small" 
                    style="color:black" accept="text/plain" multiple="false">
                    </asp:FileUpload>
                ...
                <td colspan="3">
                    <asp:GridView ID="gvArchivos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="StrUrlArchivo" HeaderText="Nombre Archivo">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="StrFechaRegistro" HeaderText="Fecha Registro">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
