                                ...
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdRegion" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdRegion" visible="false">
                                    ...
                                    <HeaderStyle BackColor="#002649" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
