            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table width="100%"  class="tabla">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label4" runat="server" Text="Región:"  CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="País:"  CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td align="center" bgcolor="#BBBBBB">
                                    <asp:Label ID="Label5" runat="server" Text="Usuario:" CssClass="Apariencia" style="color:black"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center" bgcolor="#BBBBBB">
                                    <asp:Label ID="Label6" runat="server" Text="Fecha de Creación:" CssClass="Apariencia" style="color:black"></asp:Label>
                                </td>
                                <td>
