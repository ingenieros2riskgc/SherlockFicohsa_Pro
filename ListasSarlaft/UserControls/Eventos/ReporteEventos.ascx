...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
   <ContentTemplate>
      <table align="center" bgcolor="#EEEEEE">
            ...
            <td>
               <table>
                  <tr align="left">
                     ...
                     <td bgcolor="#f0eef0">
                        <asp:DropDownList ID="DropDownList1" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="true" runat="server" Width="200px" Font-Names="Calibri"
                           Font-Size="Small">
                           <asp:ListItem Value="---">---</asp:ListItem>
                           <asp:ListItem Value="1">No hubo eventos</asp:ListItem>
                           <asp:ListItem Value="6">Eventos E Incidentes</asp:ListItem>
                  ...
                  <tr align="left">
                   ...
                   <tr align="left">
                     <td bgcolor="#BBBBBB" align="center">
                        <asp:Label ID="LblCadenaValor" runat="server" Text="Cadena de valor" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                     </td>
                     <td bgcolor="#f0eef0">
                        <asp:DropDownList ID="DDLCadenaValor" runat="server" Width="200px" Font-Names="Calibri"
                   ...
                   <tr align="left">
                     <td bgcolor="#BBBBBB" align="center">
                        <asp:Label ID="LblProceso" runat="server" Text="Proceso Afectado" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                     </td>
                     <td bgcolor="#f0eef0">
                  ...
                  <tr align="left">
                     <td bgcolor="#BBBBBB" align="center">
                        <asp:Label ID="Label50" runat="server" Text="Año reporte" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                     </td>
                     <td bgcolor="#f0eef0">
                  ...
                  <tr align="left">
                     <td bgcolor="#BBBBBB" align="center">
                        <asp:Label ID="Label7" runat="server" Text="Todos los eventos...:" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                     </td>
                     <td bgcolor="#f0eef0">
                        <asp:DropDownList ID="DDLFiltrarSegun" runat="server" Width="200px" Font-Names="Calibri"
                           Font-Size="Small">
                           <asp:ListItem Value="---">---</asp:ListItem>
                           <asp:ListItem Value="1">Del año seleccionado</asp:ListItem>
                           <asp:ListItem Value="2">Del año seleccionado y fecha de registro contable</asp:ListItem>
                           <asp:ListItem Value="3">Del año seleccionado y abiertos en durante el año</asp:ListItem>
                        </asp:DropDownList>
                     </td>
                  </tr>
               </table>
                     ...
                     <td>
                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4"
                           ...
                           <Columns>
                              ...
                              <asp:BoundField HeaderText="Fecha Ocurrencia" DataField="Fecha Ocurrencia" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField DataField="Fecha Cierre" HeaderText="Fecha Cierre" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField DataField="Fecha Descubrimiento" HeaderText="Fecha Descubrimiento" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
         ...
         <tr align="center" id="ReporteEventosIncidentes" runat="server" visible="false">
            <td>
               <table>
                  <tr align="left">
                     <td>
                  ...
                  <tr align="center">
                     <td>
                        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" CellPadding="4"
                           ...
                           <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                           <Columns>
                              <asp:BoundField HeaderText="Código" DataField="Código Evento/Incidente" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField HeaderText="Fuente Reporte" DataField="Fuente del Reporte" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField HeaderText="Fecha Descubrimiento" DataField="Fecha de Descubrimiento" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField HeaderText="Fecha Registro Contable" DataField="Fecha de Registro Contable de la Pérdida" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField HeaderText="Estado" DataField="Estatus del proceso" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField HeaderText="Val. Titulo" DataField="Titulo_Proceso" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                              <asp:BoundField HeaderText="Val. Proceso Originador" DataField="Proceso_Originador" >
                                 <ItemStyle HorizontalAlign="Center" />
                              </asp:BoundField>
                           </Columns>
                           <EditRowStyle BackColor="#999999" />
