...
{
    public partial class DescLineaDos : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    ddlLineaUno.Items.Clear();
                    ddlLineaUno.Items.Add(item);
                    ddlLineaUno.DataBind();
                }
            }
        }
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                ...
                txtSubLinea.Text = GridView1.SelectedRow.Cells[2].Text.Trim();
                txtUsuario.Text = GridView1.SelectedDataKey[0].ToString().Trim();
                txtFecha.Text = GridView1.SelectedRow.Cells[6].Text.Trim();
                ddlLineaUno.SelectedValue = GridView1.SelectedDataKey[1].ToString().Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                txtId.Text = "";
                txtId.Enabled = false;
                ddlLineaUno.SelectedValue = null;
                ddlLineaUno.Focus();
                txtSubLinea.Text = "";
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdDescLineaDos"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdDescLineaDos"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["IdDescLineaUno"].DefaultValue = ddlLineaUno.SelectedValue;
                    SqlDataSource1.UpdateParameters["Descripcion"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtSubLinea.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["Descripcion"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtSubLinea.Text.Trim());
                SqlDataSource1.InsertParameters["IdDescLineaUno"].DefaultValue = ddlLineaUno.SelectedValue;
        ...
        #region DDLs
        protected void ddlLineaUno_DataBound(object sender, EventArgs e)
        {
            ddlLineaUno.Items.Insert(0, new ListItem("", "0")); // Inserta el Item con texto Vacio        
        }
        #endregion
        ...
        protected Boolean VerificarCampos()
        {
            ...
            if (ddlLineaUno.SelectedValue == "-1")
            {
                err = false;
                omb.ShowMessage("Debe seleccionar la Linea de Negocio.", 2, "Atención");
                ddlLineaUno.Focus();
            }
            else if (ValidarCadenaVacia(Sanitizer.GetSafeHtmlFragment(txtSubLinea.Text.Trim())))
            {
                err = false;
