<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Anios.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Anios" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Anios] WHERE IdAnio = @IdAnio"
    InsertCommand="INSERT INTO [Eventos].[Anios] ([Anio] ,[Codigo] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Anio, @Codigo, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdAnio] ,[Anio] ,[Codigo] ,[Anios].[IdUsuario] ,[FechaRegistro], [Usuario] FROM [Eventos].[Anios], [Listas].[Usuarios] WHERE [Anios].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[Anios] SET [Anio] = @Anio, [Codigo] = @Codigo WHERE IdAnio = @IdAnio">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Años" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader" DataKeyNames="Usuario"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdAnio" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                            SortExpression="IdAnio" Visible="true">
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Año:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtAnio" runat="server" Enabled="True" Width="300px"
                                    CssClass="Apariencia"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Código:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCodigo" runat="server" Enabled="True" Width="300px"
                                    CssClass="Apariencia"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
