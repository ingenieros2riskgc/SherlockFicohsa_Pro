<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TipoRiesgo.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.TipoRiesgo" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[TipoRiesgo] WHERE IdTipoRiesgo = @IdTipoRiesgo"
    InsertCommand="INSERT INTO [Eventos].[TipoRiesgo] ([TipoRiesgo] ,[IdUsuario] ,[FechaRegistro]) VALUES (@TipoRiesgo, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdTipoRiesgo] ,[TipoRiesgo] ,[TipoRiesgo].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[TipoRiesgo], [Listas].[Usuarios] WHERE [TipoRiesgo].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[TipoRiesgo] SET [TipoRiesgo] = @TipoRiesgo  WHERE IdTipoRiesgo = @IdTipoRiesgo">
    <DeleteParameters>
        <asp:Parameter Name="IdTipoRiesgo" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="TipoRiesgo" Type="String" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Tipo de Riesgo" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdTipoRiesgo,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdTipoRiesgo" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdTipoRiesgo" Visible="True">
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Tipo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtTipoRiesgo" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iTipoRiesgo" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iTipoRiesgo" />
                                        </td>
                                        <td>
