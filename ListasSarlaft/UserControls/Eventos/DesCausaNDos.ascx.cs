...
{
    public partial class DesCausaNDos : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    ddlCausaNUno.Items.Clear();
                    ddlCausaNUno.Items.Add(item);
                    ddlCausaNUno.DataBind();

                    ddlDesFactorRO.Items.Clear();
                    ddlDesFactorRO.Items.Add(item);
                    ddlDesFactorRO.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    ddlCausaNUno.SelectedValue = GridView1.SelectedDataKey[2].ToString().Trim();
                    ddlDesFactorRO.SelectedValue = GridView1.SelectedDataKey[3].ToString().Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                txtId.Enabled = false;
                txtDescripcion.Text = "";
                ddlCausaNUno.SelectedValue = null;
                ddlDesFactorRO.SelectedValue = null;
                txtUsuario.Text = Session["loginUsuario"].ToString().Trim(); //Aca va el Descripcion de usuario logueado
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdDesCausaNDos"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdDesCausaNDos"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["IdDesCausaNUno"].DefaultValue = ddlCausaNUno.SelectedValue;
                    SqlDataSource1.UpdateParameters["IdDesFactorRO"].DefaultValue = ddlDesFactorRO.SelectedValue;
                    SqlDataSource1.UpdateParameters["Descripcion"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDescripcion.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["Descripcion"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDescripcion.Text.Trim());
                SqlDataSource1.InsertParameters["IdDesCausaNUno"].DefaultValue = ddlCausaNUno.SelectedValue;
                SqlDataSource1.InsertParameters["IdDesFactorRO"].DefaultValue = ddlDesFactorRO.SelectedValue;
        ...
        #region DDLs
        protected void ddlCausaNUno_DataBound(object sender, EventArgs e)
        {

        }

        protected void ddlDesFactorRO_DataBound(object sender, EventArgs e)
        {
