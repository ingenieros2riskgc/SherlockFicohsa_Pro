...
{
    public partial class DescFrecuencia : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtDescripcionFicohsa.Text = GridView1.SelectedRow.Cells[1].Text.Trim();
                    txtDescripcionSBP.Text = GridView1.SelectedRow.Cells[2].Text.Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                txtId.Text = "";
                txtId.Enabled = false;
                txtDescripcionFicohsa.Text = "";
                txtDescripcionSBP.Text = "";
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdDescFrecuencia"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdDescFrecuencia"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["DescripcionFicohsa"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDescripcionFicohsa.Text.Trim());
                    SqlDataSource1.UpdateParameters["DescripcionSBP"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDescripcionSBP.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["DescripcionFicohsa"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDescripcionFicohsa.Text.Trim());
                SqlDataSource1.InsertParameters["DescripcionSBP"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDescripcionSBP.Text.Trim());
