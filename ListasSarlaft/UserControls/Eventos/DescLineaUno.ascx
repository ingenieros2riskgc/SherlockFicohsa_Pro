<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DescLineaUno.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DescLineaUno" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DescLineaUno] WHERE IdDescLineaUno = @IdDescLineaUno"
    InsertCommand="INSERT INTO [Eventos].[DescLineaUno] ([Descripcion] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Descripcion, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDescLineaUno] ,[Descripcion] ,[DescLineaUno].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[DescLineaUno], [Listas].[Usuarios] WHERE [DescLineaUno].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[DescLineaUno] SET [Descripcion] = @Descripcion  WHERE IdDescLineaUno = @IdDescLineaUno">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Linea de Negocio" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDescLineaUno,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDescLineaUno" HeaderText="Descripcion" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDescLineaUno" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Descripcion" HeaderText="Linea de Negocio"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDescLineaUno" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDescLineaUno" />
                                        </td>
                                        <td>
