<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DescFrecuencia.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DescFrecuencia" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DescFrecuencia] WHERE IdDescFrecuencia = @IdDescFrecuencia"
    InsertCommand="INSERT INTO [Eventos].[DescFrecuencia] ([DescripcionFicohsa], [DescripcionSBP] ,[IdUsuario] ,[FechaRegistro]) VALUES (@DescripcionFicohsa, @DescripcionSBP, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDescFrecuencia] ,[DescripcionFicohsa],[DescripcionSBP] ,[DescFrecuencia].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[DescFrecuencia], [Listas].[Usuarios] WHERE [DescFrecuencia].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[DescFrecuencia] SET [DescripcionFicohsa] = @DescripcionFicohsa, [DescripcionSBP] = @DescripcionSBP  WHERE IdDescFrecuencia = @IdDescFrecuencia">
    <DeleteParameters>
        <asp:Parameter Name="IdDescFrecuencia" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="DescripcionFicohsa" Type="String" />
        <asp:Parameter Name="DescripcionSBP" Type="String" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Desc. Frecuencia" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDescFrecuencia,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDescFrecuencia" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDescFrecuencia" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DescripcionFicohsa" HeaderText="Descripcion Ficohsa"
                                            SortExpression="DescripcionFicohsa" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DescripcionSBP" HeaderText="Descripcion SBP"
                                            SortExpression="DescripcionFicohsa" HtmlEncode="False"
                                            HtmlEncodeFormatString="False">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="DescripcionFicohsa:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDescripcionFicohsa" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                               
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label5" runat="server" Text="DescripcionSBP:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDescripcionSBP" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDescFrecuencia" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDescFrecuencia" />
                                        </td>
                                        <td>
