<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DescLineaDos.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DescLineaDos" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DescLineaDos] WHERE [IdDescLineaDos] = @IdDescLineaDos"
    InsertCommand="INSERT INTO [Eventos].[DescLineaDos] ([IdDescLineaUno], [IdUsuario], [Descripcion], [FechaRegistro]) VALUES (@IdDescLineaUno, @IdUsuario, @Descripcion, @FechaRegistro)"
    SelectCommand="SELECT [IdDescLineaDos], [DescLineaUno].[IdDescLineaUno] AS IdDescLineaUno, [DescLineaDos].[Descripcion], [DescLineaDos].[IdUsuario], [Usuario], [DescLineaUno].[Descripcion] as [DescLineaUno], CONVERT(VARCHAR(10),[DescLineaDos].[FechaRegistro],103) AS FechaRegistro FROM [Eventos].[DescLineaDos], [Eventos].[DescLineaUno], [Listas].[Usuarios] WHERE [DescLineaUno].[IdDescLineaUno] = [DescLineaDos].[IdDescLineaUno] AND [DescLineaDos].[idUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[DescLineaDos] SET [IdDescLineaUno] = @IdDescLineaUno, [Descripcion] = @Descripcion WHERE [IdDescLineaDos] = @IdDescLineaDos">
    <DeleteParameters>
        <asp:Parameter Name="IdDescLineaDos" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="IdDescLineaUno" Type="Int32" />
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server"
    ...
    SelectCommand="SELECT [IdDescLineaUno], [Descripcion] FROM [Eventos].[DescLineaUno]"></asp:SqlDataSource>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Sublinea de Negocio" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader" DataKeyNames="Usuario,IdDescLineaUno"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDescLineaDos" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                            SortExpression="IdDescLineaDos" Visible="true">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="IdDescLineaUno" HeaderText="IdDescLineaUno"
                                            SortExpression="IdDescLineaUno" InsertVisible="False" ReadOnly="True"
                                            Visible="False" />
                                        ...
                                        <asp:BoundField DataField="DescLineaUno" HeaderText="Linea de Negocio"
                                            SortExpression="DescLineaUno" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Linea de Negocio:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlLineaUno" runat="server" Width="300px"
                                    CssClass="Apariencia" DataSourceID="SqlDataSource2" OnDataBound="ddlLineaUno_DataBound"
                                    DataTextField="Descripcion" DataValueField="IdDescLineaUno" AppendDataBoundItems="true">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvLineaUno" runat="server" ControlToValidate="ddlLineaUno"
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Sublinea de Negocio:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSubLinea" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvSubLinea" runat="server" ControlToValidate="txtSubLinea"
                                    ErrorMessage="Debe ingresar el SubLinea." ToolTip="Debe ingresar la SubLinea."
                                    ValidationGroup="iLineaUno" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iLineaUno"/>
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ValidationGroup="iLineaUno"
                                                ToolTip="Guardar" />
                                        </td>
                                        <td>
