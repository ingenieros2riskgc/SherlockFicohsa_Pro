<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LimGblSeveridad.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.LimGblSeveridad" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"        
    SelectCommand="SELECT Gbl.IdMtGblSeveridad, EDF.IdDescSeveridad, EDF.DescripcionFicohsa, Minimo, Maximo, LU.Nombres AS Usuario, Gbl.FechaRegistro FROM [Eventos].[MtGblSeveridad] Gbl INNER JOIN Eventos.DescSeveridad  EDF ON Gbl.IdDescSeveridad = EDF.IdDescSeveridad INNER JOIN [Listas].[Usuarios] LU ON LU.IdUsuario = Gbl.IdUsuario ORDER BY Minimo"
    UpdateCommand="UPDATE [Eventos].[MtGblSeveridad] SET [IdDescSeveridad] = @IdDescSeveridad, [Minimo] = @Minimo, [Maximo] = @Maximo  WHERE IdMtGblSeveridad = @IdMtGblSeveridad">
    <UpdateParameters>
        <asp:Parameter Name="IdMtGblSeveridad" Type="Int32" />
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Límites Globales Severidad" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdMtGblSeveridad, IdDescSeveridad, Minimo, Maximo" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdMtGblSeveridad" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdMtGblSeveridad" Visible="True">
