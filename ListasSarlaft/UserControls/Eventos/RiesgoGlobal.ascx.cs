...
{
    public partial class RiesgoGlobal : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtRiesgoGlobal.Text = GridView1.SelectedRow.Cells[1].Text.Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                txtId.Text = "";
                txtId.Enabled = false;
                txtRiesgoGlobal.Text = "";
                txtUsuario.Text = Session["loginUsuario"].ToString().Trim(); //Aca va el RiesgoGlobal de usuario logueado
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdRiesgoGlobal"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdRiesgoGlobal"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["RiesgoGlobal"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtRiesgoGlobal.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["RiesgoGlobal"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtRiesgoGlobal.Text.Trim());
