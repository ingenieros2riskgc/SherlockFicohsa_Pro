...
{
    public partial class DesCausaNUno : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    ddlTipoRiesgo.Items.Clear();
                    ddlTipoRiesgo.Items.Add(item);
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    ddlTipoRiesgo.SelectedValue = GridView1.SelectedDataKey[2].ToString().Trim();
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdDesCausaNUno"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdDesCausaNUno"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["IdTipoRiesgo"].DefaultValue = ddlTipoRiesgo.SelectedValue;
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataSource1.InsertParameters["IdTipoRiesgo"].DefaultValue = ddlTipoRiesgo.SelectedValue;
