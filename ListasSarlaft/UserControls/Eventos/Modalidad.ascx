<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Modalidad.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Modalidad" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Modalidad] WHERE IdModalidad = @IdModalidad"
    InsertCommand="INSERT INTO [Eventos].[Modalidad] ([Modalidad] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Modalidad, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdModalidad] ,[Modalidad] ,[Modalidad].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[Modalidad], [Listas].[Usuarios] WHERE [Modalidad].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[Modalidad] SET [Modalidad] = @Modalidad  WHERE IdModalidad = @IdModalidad">
    <DeleteParameters>
        <asp:Parameter Name="IdModalidad" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Modalidad" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdModalidad,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdModalidad" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdModalidad" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Modalidad" HeaderText="Modalidad"
                                            SortExpression="Modalidad" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Modalidad:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtModalidad" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iModalidad" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iModalidad" />
                                        </td>
                                        <td>
