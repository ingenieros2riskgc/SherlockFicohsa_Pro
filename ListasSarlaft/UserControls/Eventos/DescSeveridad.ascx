<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DescSeveridad.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.DescSeveridad" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[DescSeveridad] WHERE IdDescSeveridad = @IdDescSeveridad"
    InsertCommand="INSERT INTO [Eventos].[DescSeveridad] ([DescripcionFicohsa], [DescripcionSBP] ,[IdUsuario] ,[FechaRegistro]) VALUES (@DescripcionFicohsa, @DescripcionSBP, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdDescSeveridad] ,[DescripcionFicohsa],[DescripcionSBP] ,[DescSeveridad].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[DescSeveridad], [Listas].[Usuarios] WHERE [DescSeveridad].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[DescSeveridad] SET [DescripcionFicohsa] = @DescripcionFicohsa, [DescripcionSBP] = @DescripcionSBP  WHERE IdDescSeveridad = @IdDescSeveridad">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Desc. Severidad" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdDescSeveridad,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdDescSeveridad" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdDescSeveridad" Visible="True">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iDescSeveridad" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iDescSeveridad" />
                                        </td>
                                        <td>
