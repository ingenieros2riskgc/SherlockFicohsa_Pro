    ...
    public partial class Modalidad : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtModalidad.Text = GridView1.SelectedRow.Cells[1].Text.Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                txtId.Enabled = false;
                txtModalidad.Text = "";
                txtUsuario.Text = Session["loginUsuario"].ToString().Trim(); //Aca va el Modalidad de usuario logueado
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdModalidad"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdModalidad"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["Modalidad"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtModalidad.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["Modalidad"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtModalidad.Text.Trim());
