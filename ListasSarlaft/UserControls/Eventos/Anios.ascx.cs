...
{
    public partial class Anios : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtAnio.Text = GridView1.SelectedRow.Cells[1].Text.Trim();
                    txtCodigo.Text = GridView1.SelectedRow.Cells[2].Text.Trim();
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdAnio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlDataSource1.UpdateParameters["Anio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtAnio.Text.Trim());
                    SqlDataSource1.UpdateParameters["Codigo"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtCodigo.Text.Trim());
                    SqlDataSource1.UpdateParameters["IdAnio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());


                    var result = SqlDataSource1.Update();

                    omb.ShowMessage("Datos actualizados correctamente", 3, "Atención");
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["Anio"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtAnio.Text.Trim());
                SqlDataSource1.InsertParameters["Codigo"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtCodigo.Text.Trim());
