<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FuenteReporte.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.FuenteReporte" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[FuenteReporte] WHERE IdFuenteReporte = @IdFuenteReporte"
    InsertCommand="INSERT INTO [Eventos].[FuenteReporte] ([Fuente] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Fuente, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdFuenteReporte] ,[Fuente] ,[FuenteReporte].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[FuenteReporte], [Listas].[Usuarios] WHERE [FuenteReporte].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[FuenteReporte] SET [Fuente] = @Fuente  WHERE IdFuenteReporte = @IdFuenteReporte">
    <DeleteParameters>
        <asp:Parameter Name="IdFuenteReporte" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Fuente del Reporte" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdFuenteReporte,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdFuenteReporte" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdFuenteReporte" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Fuente" HeaderText="Fuente del Reporte"
                                            SortExpression="Fuente" HtmlEncode="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Fuente:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtFuente" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iFuenteReporte" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iFuenteReporte" />
                                        </td>
                                        <td>
