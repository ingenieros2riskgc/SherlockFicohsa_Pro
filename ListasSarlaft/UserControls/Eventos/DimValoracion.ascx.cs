...
{
    public partial class DimValoracion : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtDimensiones.Text = GridView1.SelectedRow.Cells[1].Text.Trim();
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                txtId.Enabled = false;
                txtDimensiones.Text = "";
                txtUsuario.Text = Session["loginUsuario"].ToString().Trim(); //Aca va el Dimensiones de usuario logueado
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdDimValoracion"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdDimValoracion"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["Dimensiones"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDimensiones.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["Dimensiones"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtDimensiones.Text.Trim());
