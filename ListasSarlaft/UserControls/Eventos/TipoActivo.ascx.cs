    ...
    public partial class TipoActivo : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (GridView1.SelectedRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtTipo.Text = System.Web.HttpUtility.HtmlDecode(GridView1.SelectedRow.Cells[1].Text.Trim());
        ...
        protected void imgBtnInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                txtId.Enabled = false;
                txtTipo.Text = "";
                txtUsuario.Text = Session["loginUsuario"].ToString().Trim(); //Aca va el Tipo de usuario logueado
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdTipoActivo"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlDataSource1.UpdateParameters["IdTipoActivo"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
                    SqlDataSource1.UpdateParameters["Tipo"].DefaultValue = EncodeExcludeSomeCaracters(txtTipo.Text.Trim());
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.InsertParameters["Tipo"].DefaultValue = EncodeExcludeSomeCaracters(txtTipo.Text.Trim());
