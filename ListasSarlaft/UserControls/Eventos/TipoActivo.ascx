<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TipoActivo.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.TipoActivo" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[TipoActivo] WHERE IdTipoActivo = @IdTipoActivo"
    InsertCommand="INSERT INTO [Eventos].[TipoActivo] ([Tipo] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Tipo, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdTipoActivo] ,[Tipo] ,[TipoActivo].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[TipoActivo], [Listas].[Usuarios] WHERE [TipoActivo].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[TipoActivo] SET [Tipo] = @Tipo  WHERE IdTipoActivo = @IdTipoActivo">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Tipo de Activo" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdTipoActivo,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdTipoActivo" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdTipoActivo" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Tipo" HeaderText="Tipo de Activo"
                                            SortExpression="Tipo" HtmlEncode="False"
                ...
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTipo" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iTipoActivo" />
                                        </td>
                                        <td>
