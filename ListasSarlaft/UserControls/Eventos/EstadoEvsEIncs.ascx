<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EstadoEvsEIncs.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.EstadoEvsEIncs" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[EstadoEvsEIncs] WHERE IdEstadoEvsEIncs = @IdEstadoEvsEIncs"
    InsertCommand="INSERT INTO [Eventos].[EstadoEvsEIncs] ([Estado] ,[IdUsuario] ,[FechaRegistro]) VALUES (@Estado, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdEstadoEvsEIncs] ,[Estado] ,[EstadoEvsEIncs].[IdUsuario] ,[FechaRegistro] , [Usuario] FROM [Eventos].[EstadoEvsEIncs], [Listas].[Usuarios] WHERE [EstadoEvsEIncs].[IdUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[EstadoEvsEIncs] SET [Estado] = @Estado  WHERE IdEstadoEvsEIncs = @IdEstadoEvsEIncs">
    <DeleteParameters>
        <asp:Parameter Name="IdEstadoEvsEIncs" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Estatus Evento/Incidente" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdEstadoEvsEIncs,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdEstadoEvsEIncs" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdEstadoEvsEIncs" Visible="True">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Estado" HeaderText="Estado"
                                            SortExpression="Estado" HtmlEncode="False"
                ...
                <td bgcolor="#f0eef0">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEstado" runat="server" Width="300px" CssClass="Apariencia" MaxLength="50"></asp:TextBox>
