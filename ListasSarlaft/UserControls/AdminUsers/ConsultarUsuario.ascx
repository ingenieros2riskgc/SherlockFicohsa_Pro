            ...
            <tr align="center">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label1" runat="server" Text="Número Documento" Font-Names="Calibri"
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
                            ...
                            <td>
                                <asp:Panel ID="Panel1" runat="server">
                                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" EnableModelValidation="True"
                                        ...
                                        ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <tr align="center">
                            <td colspan="2">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
