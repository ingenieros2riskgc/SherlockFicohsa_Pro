...
namespace ListasSarlaft.UserControls
{
    public partial class ConsultarUsuario : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            scriptManager.RegisterPostBackControl(this.Exportar);
            ...
            try
            {
                ...
                */
                ...
                if (boolResult == true)
                {
                    ...
                    ShowMessage("Usuario actualizado con éxito.", 3, "Atención");
                }
                else
                {
        ...
        protected void Exportar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Mensaje("Error al exportar el reporte de usuarios:" + ex.Message.ToString());
            }
        }


        private DataTable ReporteUsuarios()
        {
            string selectCommand =

            "SELECT b.NombreRol, a.NumeroDocumento, a.Nombres, a.Apellidos, a.Usuario, a.Bloqueado, " +
            "a.IdJerarquia, c.NombreHijo, a.IdMacroProcesoU, a.IdProcesoU, a.VerTodosProcesos, a.FechaUltActualPassword " +
            "FROM Listas.Usuarios as a " +
            "INNER JOIN Listas.Roles as b ON a.IdRol = b.IdRol " +
            "LEFT JOIN Parametrizacion.JerarquiaOrganizacional as c ON a.IdJerarquia = c.idHijo;";
