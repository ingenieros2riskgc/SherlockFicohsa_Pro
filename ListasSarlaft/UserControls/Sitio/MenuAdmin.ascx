                    ...
                    <td class="style2">
                        <asp:Menu ID="Menu3" runat="server" DynamicHorizontalOffset="2" Font-Names="Franklin Gothic Medium"
                            ...
                            <Items>
                                ...
                                <%-- ****************** Sarlaft *******************************************--%>
                                <asp:MenuItem Text="AML" Value="AML">
                                    ...
                                    <asp:MenuItem Text="Conocimiento de cliente" Value="Conocimiento de cliente">
                                        <asp:MenuItem Text="Formulario conocimiento cliente" Value="Formulario conocimiento cliente" NavigateUrl="~/Formularios/Sarlaft/Admin/AdminFormClienteFCC.aspx">
                                        </asp:MenuItem>
                                        <asp:MenuItem Text="Consultar cliente" Value="Consultar cliente" NavigateUrl="~/Formularios/Sarlaft/Admin/ConsultarFormClienteFCC.aspx">
                                        </asp:MenuItem>
                                    </asp:MenuItem>
                                    <asp:MenuItem Text="Reportes" Value="Reportes">
