                                        ...
                                        <tr bgcolor="#EEEEEE" id="filaAccion" runat="server" visible="false">
                                            <td>
                                                <table align="center">
                                                    <tr>
                                                        <td>
                                                            <asp:ImageButton ID="btnImgEditar" runat="server" ImageUrl="~/Imagenes/Icons/editV5.png"
                                                                OnClick="btnImgEditar_Click" EnableTheming="True" ToolTip="Editar" />
                                                        </td>
                                                        <td>
                                                            <asp:ImageButton ID="btnImgEliminar" runat="server" ImageUrl="~/Imagenes/Icons/deleteV5.png"
                                                                OnClick="btnImgEliminar_Click" ToolTip="Eliminar" />
                                                        </td>
                                                        <td>
                                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/AddV5.png"
                            ...
                            <table width="100%" align="center">
                                <tr>
                                    ...
                                    <tr align="center" bgcolor="#5D7B9D">
                                        <td align="center" bgcolor="#002649">
                                        ...
                                        <table width="100%" class="tabla">
                                            <tr>
                                                <td align="center" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label1" runat="server" Text="Nivel Superior:" CssClass="Apariencia" style="color:black"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblNodoPadre" runat="server" Width="360px" CssClass="Apariencia" style="color:black"></asp:Label>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label7" runat="server" Text="Tipo Area:" CssClass="Apariencia" style="color:black"></asp:Label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label3" runat="server" Text="Nombre Responsable:" CssClass="Apariencia" style="color:black"></asp:Label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label4" runat="server" Text="Correo Electrónico Responsable:" CssClass="Apariencia" style="color:black"></asp:Label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label5" runat="server" Text="Cargo Responsable:" CssClass="Apariencia" style="color:black"></asp:Label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#BBBBBB">
                                                    <asp:Label ID="Label8" runat="server" Text="Area:" CssClass="Apariencia" style="color:black"></asp:Label>
                                                </td>
                                                <td>
                                ...
                                <tr bgcolor="#EEEEEE">
                                    <td>
                                        <table align="center">
                                            <tr>
                                                <td>
                                                    <asp:ImageButton ID="btnImgGrabar" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
