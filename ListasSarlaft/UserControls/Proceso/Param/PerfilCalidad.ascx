        ...
        <div class="ColumnStyle" id="divFiltro" runat="server">
            <div class="ColumnStyle" runat="server">
                <div style="text-align: center">
                    <asp:Label ID="lblFiltro" runat="server" ForeColor="Black" Text="Filtros de búsqueda" Font-Bold="False"
            ...
            <div class="TableContains">
                <table class="tabla" align="center" width="80%">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:ImageButton ID="btnBusquedaFiltro" runat="server" ImageUrl="~/Imagenes/Icons/Apps-Search-And-Replace-icon.png" ToolTip="Buscar" OnClick="btnBusquedaFiltro_Click" />
