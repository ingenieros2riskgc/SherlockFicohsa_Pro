                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4"
                                    ...
                                    CssClass="Apariencia" Font-Bold="False" HeaderStyle-HorizontalAlign="Center"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label19" runat="server" Text="Cadena de Valor:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label22" runat="server" Text="Macroproceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label7" runat="server" Text="Proceso:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label12" runat="server" Text="Estado:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
