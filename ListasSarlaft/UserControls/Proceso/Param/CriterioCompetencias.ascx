...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            ...
            <tr id="trTituloCompetencias" class="center002649" visible="false" runat="server">
                <td>
            ...
            <tr id="BotonRegresar" runat="server" class="centertdtr" visible="false">
                <td style="background: #EEEEEE">
                    <asp:ImageButton ID="btnRegresarCompetencias" runat="server" CausesValidation="False" CommandName="Back"
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Competencias" OnClick="btnRegresarCompetencias_Click" ToolTip="Regresar a Competencias" />
                </td>
            </tr>
        </table>
                    </div>
