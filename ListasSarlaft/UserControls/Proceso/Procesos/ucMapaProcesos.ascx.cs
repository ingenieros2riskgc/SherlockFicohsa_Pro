        ...
        private bool mtdCargarProcesos(ref string strErrMsg)
        {
            ...
            if (booResult)
            {
                foreach (clsCadenaValor objCadena in lstCadenas)
                {
                    ...
                    lblCadenas.BackColor = System.Drawing.Color.White;
                    lblCadenas.ForeColor = System.Drawing.Color.Black;
                    lblCadenas.Text = objCadena.strNombreCadenaValor;
                    lblCadenas.Attributes.Add("class", "white-space:normal;display:inline-block; ");
                    ...
                    if (booResult)
                    {
                        ...
                        if (lstMP != null)
                            ...
                            foreach (clsMacroproceso objMP in lstMP)
                            {
                                ...
                                btnMP.Attributes.Add("class", "white-space:normal;display:inline-block; ");
