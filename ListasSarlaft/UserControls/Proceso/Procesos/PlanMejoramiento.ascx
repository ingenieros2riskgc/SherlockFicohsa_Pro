                            ...
                            <td>
                                <asp:GridView ID="GVplanmejoramiento" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Descripcion Actividad" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
                                        ...
                                        <asp:TemplateField HeaderText="Plan de Mejoramiento" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:ImageButton ID="IBinsertGVC" runat="server" CausesValidation="true" CommandName="Insert"
                                    ImageUrl="~/Imagenes/Icons/guardar.png" Text="Insert" ValidationGroup="CrlSalida" ToolTip="Insertar" Visible="false" OnClick="IBinsertGVC_Click" Width="22px"/>
