...
<asp:UpdatePanel ID="GEPbody" runat="server">
    <ContentTemplate>
        ...
        <div class="TituloLabel" id="HeadGES" runat="server" width="60%">
            <%--<br />--%>
            ...
            <div id="form" class="TableContains">
                <Table class="tabla" align="center" width="80%">
                    ...
                    <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="RBtipoEncuesta" runat="server" ValidationGroup="GEvaServicio" cssClass="Apariencia" AutoPostBack="True">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TXfuncionarios" runat="server" CssClass="Apariencia" TextMode="MultiLine" Wrap="false" Width="300px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <div id="DVprint" class="ColumnStyle" runat="server" visible="false">
            <Table class="tabla" align="center" width="50%">
                <tr>
                    <td>
                        ...
                        <asp:Label ID="LprocessText" runat="server" Text="Para exportar la Encuesta a PDF:" ForeColor="Black"></asp:Label>
                        </td>
                    <td>
         ...
         <div id="DVgridEncuestas" class="ColumnStyle" runat="server" visible="false">
             <Table class="tabla" align="center" width="80%">
                        <tr>
                            <td class="RowsText">
                                <asp:Label runat="server" CssClass="Apariencia" ID="TextoQuestion" Text="Califique cada pregunta en la escala de 1 a 5, siendo 1 deficiente y 5 Excelente. NC:  No contesta."></asp:Label>
                            </td>
                                </tr>
                 <tr>
                     <td>
                         <asp:Label ID="LdescripcionEmpresa" runat="server" ForeColor="Black"></asp:Label>
                     </td>
                 </tr>
                 ...
                 <tr>
                     <td class="RowsText">
                         <asp:Label ID="Lobservaciones" runat="server" cssClass="Apariencia" Text="Observaciones y Oportunidades de Mejora:"></asp:Label>
                     </td>
                 </tr>
                 <tr>
                     <td>
                         <asp:TextBox ID="TXobservaciones" runat="server" CssClass="Apariencia" Wrap="false" Width="300px" Height="75px" TextMode="MultiLine"></asp:TextBox>
                     </td>
                 </tr>
                 <tr>
                        <td>
            ...
            <Table id="Tbuttons" class="tabla" align="center" width="25%">
                <tr align="center">
                        <td>
                            ...
                            <asp:Label ID="Label1" runat="server" Text="Para exportar a PDF:" ForeColor="Black"></asp:Label>
                        </td>
                    <td>
                        <asp:ImageButton ID="ImButtonPDFEvaExport" runat="server" cssClass="Apariencia" ImageUrl="~/Imagenes/Icons/pdfImg.jpg" OnClick="ImButtonPDFEvaExport_Click" />
                    </td>
                    <td>
                            
                        <asp:Label ID="Label2" runat="server" Text="Para exportar a Excel:" ForeColor="Black"></asp:Label>
                        </td>
                    <td>
                        <asp:ImageButton ID="ImButtonExcelExport" runat="server" cssClass="Apariencia" ImageUrl="~/Imagenes/Icons/excel.png" OnClick="ImButtonExcelExport_Click"/>
                    </td>
                    </tr>
                </Table>
        </div>
