...
<asp:UpdatePanel ID="GEPbody" runat="server">
    <ContentTemplate>
        ...
        <div id="ResultadoDesempeño" runat="server" visible="false" class="ColumnStyle">
            <Table class="TresultDesempeño" align="center" width="800px">
                        <tr align="center">
                            <td colspan="4">
            <asp:GridView ID="GVProveedorCriterios" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Descripción Parametro" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="true">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: normal;">
                                                    <asp:Label ID="DesParametro" runat="server" Width="200px" Text='<% # Bind("strDesParametro")%>' style="word-break:break-all; word-wrap:break-word;"></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                            <HeaderStyle Wrap="false" Width="120" />
                                            <ItemStyle Wrap="false" Width="120" />
            ...
            <asp:GridView ID="GVresultProveedor" runat="server" CellPadding="4"
                ...
                <tr align="center" id="cancel" runat="server">
                    <td colspan="4" style="color:black; font-size:15px">
                        <asp:Label runat="server" ID="Lcancel" Text="Para cancelar has click en el botón:"  ForeColor="Black"></asp:Label>
                    </td>
                </tr>
    ...
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="btnInsertarNuevo" />
        <asp:PostBackTrigger ControlID="IBprocess" />
    </Triggers>
    </asp:UpdatePanel>