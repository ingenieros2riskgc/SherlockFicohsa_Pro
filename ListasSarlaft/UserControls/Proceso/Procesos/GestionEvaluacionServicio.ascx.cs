    ...
    public partial class GestionEvaluacionServicio : System.Web.UI.UserControl
    {
        ...
        protected bool mtdInsertarValorEvaluacionSerivicio(ref string strErrMsg)
        {
            ...
            if (booResult == true)
            {
                ...
                //booResult = true;
                //int IdEvaluacionServicio = cValorEvaluacionInd.mtdLastIdEvaluacionServicios(ref strErrMsg);
                int IdEvaluacionServicio = mtdLastIdEvaluacionServicios(ref strErrMsg);
        ...
        public int mtdLastIdEvaluacionServicios(ref string strErrMsg)
        {
            int LastId = 0;
        ...
        private void mtdShowUpdate(int RowGrid1)
        {
            ...
            if (IdEncuesta > 0)
                DDLencuestas.SelectedValue = Convert.ToString(IdEncuesta);
