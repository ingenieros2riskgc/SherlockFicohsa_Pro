    ...
    <ContentTemplate>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="rfvCadenaValor" runat="server" ControlToValidate="ddlCadenaValor"
                                    ...
                                    <tr id="Subproceso">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlSubproceso" runat="server" Width="300px"  DataTextField="Nombre" DataValueField="IdProceso"
                                                CssClass="Apariencia">
                                            </asp:DropDownList></td>
                                        <td>
        ...
        <div id="DVprocess" runat="server" class="ColumnStyle" visible="false">
            <Table id="Tprocess" class="tabla" align="center" width="80%">
                <tr>
                    <td>
                        <asp:Label ID="LprocessText" runat="server" Text="Para procesar los datos has click en el botón:" CssClass="Apariencia"></asp:Label>
                    </td>
                    </tr>
                <tr align="center">
                    <td>
                ...
                <tr runat="server" id="TRcancel">
                    <td>
                        <asp:Label ID="LcancelProcess" runat="server" Text="Para cancelar has click en el botón:" CssClass="Apariencia"></asp:Label>
                    </td>
                    </tr>
