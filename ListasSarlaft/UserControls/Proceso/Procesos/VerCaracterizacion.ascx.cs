...
namespace ListasSarlaft.UserControls.Proceso.Procesos
{
    public partial class VerCaracterizacion : System.Web.UI.UserControl
    {
        ...
        private void mtdLoadGridHeaderCaracterizacion()
        {
            ...
            grid.Columns.Add("Numerales", typeof(string));
            grid.Columns.Add("Responsables", typeof(string));
        ...
        private bool mtdLoadInfoGridCaracterizacion(ref string strErrMsg)
        {
            ...
            int AuxIdConsulta = Request.QueryString["IdProceso"] != null ? Convert.ToInt32(LidProcesoT.Text) : IdConsulta;
            if (Request.QueryString["IdProceso"] != null) mtdLoadGridHeaderCaracterizacion();

            clsVerCaracterizacion objVerCaracterizacionIn = new clsVerCaracterizacion(0, string.Empty, 0, AuxIdConsulta,
                string.Empty, string.Empty
                //,string.Empty, string.Empty, string.Empty
                );
            clsVerCaracterizacion objVerCaracterizacionOut = new clsVerCaracterizacion();
            lstVerCaracterizacion = cVerCaracterizacion.mtdConsultarVerCaracterizacion(objVerCaracterizacionIn, ref objVerCaracterizacionOut,
                    //string.Empty, string.Empty, string.Empty, 
                    ref strErrMsg);
            ...
            if (lstVerCaracterizacion != null)
            {
                ...
                //mtdLoadInfoGridHeaderRecursos(lstVerCaracterizacion);
                ...
                gvCamposCaracterizacion.PageIndex = pagIndex;
                gvCamposCaracterizacion.DataBind();


                booResult = true;
                divCamposCaracterizacion.Visible = true;
                divDocumentos.Visible = true;
                gvCamposCaracterizacion.Visible = true;
            }
            else
            {
        ...
        private void mtdLoadInfoGridHeaderCaracterizacion(List<clsVerCaracterizacion> lstVerCaracterizacion)
        {
            foreach (clsVerCaracterizacion objVerCaracterizacion in lstVerCaracterizacion)
            {
                ...
                InfoGrid.Rows.Add(new Object[] {
                    ...
                    objVerCaracterizacion.Recursos.ToString().Trim(),
                    objVerCaracterizacion.Numerales.ToString().Trim(),
                    objVerCaracterizacion.Responsables.ToString().Trim()
                    });
            }
        }
        private void mtdLoadInfoGridHeaderRecursos(List<clsVerCaracterizacion> lstVerCaracterizacion)
        {
            foreach (clsVerCaracterizacion objVerCaracterizacion in lstVerCaracterizacion)
            {
                string cadena = objVerCaracterizacion.strnombreProceso.ToString().Trim();
        ...
        private bool mtdLoadInfoGridDetalle(ref string strErrMsg)
        {
            ...
            Session["IdProceso"] = AuxIdConsulta;
        ...
        private bool mtdLoadInfoGridIndicador(ref string strErrMsg)
        {
            ...
            clsVerCaracterizacionBLL cVerCaracterizacion = new clsVerCaracterizacionBLL();
            int AuxCadenaValor = 0;
            int AuxIdConsulta = 0;

            if (Request.QueryString["IdProceso"] != null)
            {
                AuxCadenaValor = 0;
                AuxIdConsulta = Convert.ToInt32(LidProcesoT.Text);
            }
            else
            {

                //Validación Cadena de Valor
                string nomCadenaValor = ddlCadenaValor.SelectedItem.Text;
                string ddlCadena = cCarat.mtdConsultaCadenaValor(nomCadenaValor);
                string ddlCadenaResul = Convert.ToString(ddlCadena);
                //Fin Validación Cadena de Valor

                //Validación Macroproceso
                string nomMacroProceso = ddlMacroproceso.SelectedItem.Text;
                string ddlMacro = cCarat.mtdConsultaMacroproceso(nomMacroProceso);
                string ddlMacroResul = Convert.ToString(ddlMacro);
                //Fin Validación Macroproceso
                ...
                AuxCadenaValor = Convert.ToInt32(ddlCadenaResul);
                AuxIdConsulta = IdConsulta;
            }

            clsVerCaracterizacion objVerCaracterizacionIn = new clsVerCaracterizacion(0, string.Empty, AuxCadenaValor, AuxIdConsulta,
                    string.Empty, string.Empty);
        ...
        private bool mtdValidarProceso(ref string strErrMsg)
        {
            bool booResult = false;

            if ((ddlProceso.SelectedValue != "0") && (!string.IsNullOrEmpty(ddlProceso.SelectedValue)))
            {
                IdConsulta = Convert.ToInt32(ddlProceso.SelectedValue.ToString().Trim());
                booResult = true;
            }
            else
                    if (ddlMacroproceso.SelectedValue != "0")
            {
                IdConsulta = Convert.ToInt32(ddlMacroproceso.SelectedValue.ToString().Trim());
                booResult = true;
            }
        ...
        private void CargaGridCamposCaracterizacion()
        {
            try
            {
                ...
                objVerCaracterizacionIn.intIdProceso = LidProcesoT.Text.Equals("") ? Convert.ToInt32(IdConsulta) : Convert.ToInt32(LidProcesoT.Text);
        ...
        protected void btnSearchCarac_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (mtdValidarProceso(ref strErrMsg))
            {
                CargarGvDocumentos(); //Ya
                ...
                GridVC.Visible = true;
                if (!mtdLoadInfoGridDetalle(ref strErrMsg)) //Ya
                    omb.ShowMessage(strErrMsg, 2, "Atención");
                GridVCdetalle.Visible = true;
        ...
        private List<DocumentosCaracterizacion> ConsultarDocumentos(int idProceso) => caracterizacionBLL.ConsultarDocumentos(idProceso);

        private void CargarGvDocumentos()
        {
            try
            {
                gvDocumentos.DataSource = ConsultarDocumentos(Convert.ToInt32(IdConsulta));
        ...
        protected void ImButtonPDFexport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                string codigo = ((Label)Row.FindControl("lCodigoAplicativo")).Text.ToUpper();
                string intId = ((Label)Row.FindControl("intId")).Text.ToUpper();
                string strnombreProceso = ((Label)Row.FindControl("strnombreProceso")).Text.ToUpper();
                string strObjetivo = ((Label)Row.FindControl("strObjetivo")).Text.ToUpper();
                string responsable = ((Label)Row.FindControl("strNombreResponsable")).Text.ToUpper();
            ...
            {
                string strDescripcionEntrada = ((Label)Row.FindControl("strDescripcionEntrada")).Text.ToUpper();
                string strProveedor = ((Label)Row.FindControl("strProveedor")).Text.ToUpper();
                /*string strDescripcionActividad = ((Label)Row.FindControl("strDescripcionActividad")).Text;
                string strCargoResponsable = ((Label)Row.FindControl("strCargoResponsable")).Text;
                string strDescripcionSalida = ((Label)Row.FindControl("strDescripcionSalida")).Text;
                string strCliente = ((Label)Row.FindControl("strCliente")).Text;
            ...
            foreach (GridViewRow Row in GVVCactividades.Rows)
            {
                /*string strDescripcionEntrada = ((Label)Row.FindControl("strDescripcionEntrada")).Text;
                string strProveedor = ((Label)Row.FindControl("strProveedor")).Text;*/
                string strDescripcionActividad = ((Label)Row.FindControl("strDescripcionActividad")).Text.ToUpper();
                string strDescripcionPHVA = ((Label)Row.FindControl("strDescripcionPHVA")).Text.ToUpper();
                string strCargoResponsable = ((Label)Row.FindControl("strCargoResponsable")).Text.ToUpper();
                string strDescripcionProcedimiento = ((Label)Row.FindControl("strDescripcionProcedimiento")).Text.ToUpper();
            ...
            pRows.Clear();
            #endregion
            #region Recursos,numerales,responsables

            PdfPTable pdfpTableRecuersos = new PdfPTable(gvCamposCaracterizacion.HeaderRow.Cells.Count);
            foreach (TableCell headerCell in gvCamposCaracterizacion.HeaderRow.Cells)
            {
                PdfPCell pdfCell = new PdfPCell(new Phrase(headerCell.Text.Replace("&#243;", "ó"), titleFont));
                pdfCell.BackgroundColor = new Color(gvCamposCaracterizacion.HeaderStyle.BackColor);
                pdfpTableRecuersos.AddCell(pdfCell);
            }
            foreach (GridViewRow Row in gvCamposCaracterizacion.Rows)
            {
                /*string strDescripcionEntrada = ((Label)Row.FindControl("strDescripcionEntrada")).Text;
                string strProveedor = ((Label)Row.FindControl("strProveedor")).Text;*/
                string Recursos = Row.Cells[0].Text.ToUpper();
                string Numerales = Row.Cells[1].Text.ToUpper();
                string Responsables = Row.Cells[2].Text.ToUpper();
                ...
                */
                ...
                /*rowTable.Add(new PdfPCell(new Phrase(Context.Server.HtmlDecode(strDescripcionEntrada), textFont)));
                rowTable.Add(new PdfPCell(new Phrase(Context.Server.HtmlDecode(strProveedor), textFont)));*/
                rowTable.Add(new PdfPCell(new Phrase(Context.Server.HtmlDecode(Recursos), textFont)));
                rowTable.Add(new PdfPCell(new Phrase(Context.Server.HtmlDecode(Numerales), textFont)));
                rowTable.Add(new PdfPCell(new Phrase(Context.Server.HtmlDecode(Responsables), textFont)));
            ...
            pdfpTableRecuersos.Rows.AddRange(pRows);
            pRows.Clear();
            #endregion Recursos,numerales,responsables
            #region Documentos
            ...
            {
                string NombreIndicador = ((Label)GridViewRow.FindControl("strNombreIndicador")).Text.ToUpper();
            ...
            {
                string strNombreRiesgo = ((Label)GridViewRow1.FindControl("strNombreRiesgo")).Text.ToUpper();
                List<PdfPCell> rowTable = new List<PdfPCell>
                {
                    new PdfPCell(new Phrase(Context.Server.HtmlDecode(strNombreRiesgo), textFont)),
                };
            ...
            Document pdfDocument = new Document(PageSize.A4, 36, 36, 20, 36);
            ...
            pathImg = Server.MapPath("~") + "Imagenes/Logos/LogoSherlock.jpg";
            ...
            pdfcellImage.FixedHeight = 50f;
            pdfcellImage.PaddingBottom = 25f;
            ...
            pdfcellImageEmpresa.FixedHeight = 75f;
            pdfcellImageEmpresa.PaddingBottom = 25f;
            ...
            pdfDocument.Add(new Phrase(""));
            pdfDocument.Add(Chunk.NEWLINE);
            Paragraph Titulo = new Paragraph(new Phrase("Reporte de Caracterización"));
            ...
            //pdfDocument.Add(Chunk.NEWLINE);
            pdfDocument.Add(pdfpTableRecuersos);
            //pdfDocument.Add(Chunk.NEWLINE);
        ...
        protected void exportExcel(HttpResponse Response, string filename)
        {
            ...
            workbook.Worksheets.Add(gridRiesgos, "Caracterización Riesgos");
