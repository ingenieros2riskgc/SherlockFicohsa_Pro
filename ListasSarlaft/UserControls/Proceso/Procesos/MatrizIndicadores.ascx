    ...
    <ContentTemplate>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GVMatriz" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Política Calidad" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Descripción Objetivo" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 140px">
                                        ...
                                        <asp:TemplateField HeaderText="Fórmula" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 140px">
                                        ...
                                        <asp:TemplateField HeaderText="Descripción Inicador" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 125px">
                                        ...
                                        <asp:TemplateField HeaderText="Meta" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Nombre Período" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
        ...
        <div id="DVseguimiento" class="ColumnStyle" runat="server" visible="false">
            <Table class="tabla" align="center" width="50%">
                ...
                <tr>
                                        <td class="RowsText">
                                            <asp:Label ID="Label16" runat="server" Text="Fórmula:" CssClass="Apariencia"></asp:Label>
                                        </td>
                                        <td>
        ...
        <div id="DVgridSeguimiento" class="ColumnStyle" runat="server" visible="false">
            ...
            <asp:GridView ID="GVCumplimiento" runat="server" CellPadding="4"
                                    ...
                                    <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                <Columns>
                    <asp:TemplateField HeaderText="Periodo" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Cumplimiento" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
            ...
            <Table id="Tbuttons" class="tabla" align="center" width="25%">
                ...
                <tr>
                    <td colspan="4">
                        ...
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Filtros" ValidationGroup="Matriz"  ToolTip="Regresar a Indicadores" OnClick="btnRegresarFiltros_Click" />
                    </td>
                </tr>
                </Table>
        </div>
