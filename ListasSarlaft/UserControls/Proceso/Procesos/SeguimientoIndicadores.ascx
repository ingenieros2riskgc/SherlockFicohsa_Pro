...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            <tr id="FilaTituloPpal" class="center002649">
                <td>
            ...
            <tr id="FilaTituloIndicador" runat="server" class="center002649">
                <td>
            ...
            <tr id="BotonRegresarFiltros" runat="server" class="centertdtr" visible="false">
                <td style="background: #EEEEEE">
                    <asp:ImageButton ID="btnRegresarFiltros" runat="server" CausesValidation="False" CommandName="Back"
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Filtros" OnClick="btnRegresarFiltros_Click" ToolTip="Regresar a Filtros" />
                </td>
            </tr>

            <tr id="FilaTituloAnalisis" class="center002649" runat="server">
                <td>
            ...
            <tr id="BotonRegresarIndicador" runat="server" class="centertdtr" visible="false">
                <td style="background: #EEEEEE">
                    <asp:ImageButton ID="btnRegresarIndicador" runat="server" CausesValidation="False" CommandName="Back"
                        ImageUrl="~/Imagenes/Icons/Backv5.png" Text="Regresar a Indicadores" OnClick="btnRegresarIndicador_Click" ToolTip="Regresar a Indicadores" />
                </td>
            </tr>
        </table>
                    </div>
