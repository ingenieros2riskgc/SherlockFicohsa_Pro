                                ...
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="IdTipo" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdTipo" visible="false">
                        ...
                        <tr align="center" bgcolor="#EEEEEE">
                            <td>
                                ...
                                <table   class = "tabla">
                                    <tr>
                                        <td align="center" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label10" runat="server" Text="Tipo:" CssClass="Apariencia" Width="80px" style="color:black"></asp:Label>
                                        </td>
                                        <td>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False" HeaderText="Acción">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" CommandName="Select"
                                                                ImageUrl="~/Imagenes/Icons/editV5.png" Text="Seleccionar" ToolTip="Editar" CommandArgument="SelectOp" />
                                                            <asp:ImageButton ID="btnImgEliminarOpcion" runat="server" CausesValidation="False"
                                                                ...
                                                                ImageUrl="~/Imagenes/Icons/deleteV5.png" Text="Eliminar" CommandName="Select" ToolTip="Eliminar" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                </Columns>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <asp:ImageButton ID="imgBtnInsertarOpcion" runat="server" CausesValidation="False" CommandName="Insert"
                                                ImageUrl="~/Imagenes/Icons/AddV5.png" Text="Insert" OnClick="imgBtnInsertarOpcion_Click"
                                                ToolTip="Insertar" />
                                        </td>
                                    </tr>
                                </table>
                ...
                <td bgcolor="#f0eef0">
                   <table width="100%"  class = "tabla">
                    <tr align="center" bgcolor="#002649">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label16" runat="server" Text="Código:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label17" runat="server" Text="Nombre:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Fecha de Creación:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr align="center">
                            <td colspan="2">
                                <table  class = "tablaSinBordes">
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertarOp" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Visible="False" OnClick="btnImgInsertarOp_Click" ToolTip="Guardar" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizarOp" runat="server" ImageUrl="~/Imagenes/Icons/guardarV5.png"
                                                Style="text-align: right" OnClick="btnImgActualizarOp_Click" 
                                                ToolTip="Guardar" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgCancelarOp" runat="server" ImageUrl="~/Imagenes/Icons/cancelV5.png"
