    ...
    <ContentTemplate>
        ...
        <table align="center" width="100%">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Correos Enviados"
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Modulo" HeaderText="Módulo" InsertVisible="False" ReadOnly="True"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#f0eef0">
                    <table border="1" cellspacing="0" cellpadding="2" bordercolor="White" width="100%">
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Destinatario:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label6" runat="server" Text="Copia1:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label11" runat="server" Text="Estado:" CssClass="Apariencia" Font-Bold="True" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label12" runat="server" Text="Fecha de Envío:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
