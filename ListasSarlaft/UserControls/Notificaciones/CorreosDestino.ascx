    ...
    <ContentTemplate>
        ...
        <table align="center" width="100%">
            <tr align="center" bgcolor="#002649">
                <td>
                    <%--<br />--%>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Correos Destino"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    HorizontalAlign="Center" Font-Names="Calibri" Font-Size="Small" HeaderStyle-HorizontalAlign="Center"
                    ...
                    <table class="tabla" width="100%">
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label1" runat="server" Text="Modulo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr runat="server" visible="false">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="LnombreEvento" runat="server" Text="Evento:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="LfechaCierre" runat="server" Text="Requiere Fecha de Cierre:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <table class="tablaSinBordes">
                                    <tr>
                                        <td>
                                            <asp:RadioButtonList ID="RBLrequiereFechaCierre" runat="server" CssClass="Apariencia">
                                                <asp:ListItem Value="SI" Text="Sí requiere"></asp:ListItem>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Etapa:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label12" runat="server" Text="A:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                                <table class="tablaSinBordes">
                                    <tr>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label6" runat="server" Text="Copia:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label10" runat="server" Text="Otros:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label8" runat="server" Text="Asunto:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label9" runat="server" Text="Cuerpo:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr id="filaNroDias" runat="server">
                            <td align="center" bgcolor="#BBBBBB">
                                <asp:Label ID="Label11" runat="server" Text="Nro Días Recordatorio:" CssClass="Apariencia" style="color:black"></asp:Label>
                            </td>
                            <td>
