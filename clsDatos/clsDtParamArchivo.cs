...
namespace clsDatos
{
    public class clsDtParamArchivo
    {
        ...
        public void mtdAgregarEstructuraCampoCreate(clsDTOEstructuraCampoEstructura objEstructura, ref string strErrMsg)
        {
            #region Vars
            clsDatabase cDatabase = new clsDatabase();
            DataTable dtInformacion = new DataTable();
            ...
            try
            {
                strConsulta = string.Format("INSERT INTO [Perfiles].[tblEstructuraCampos] ([IdUsuario], [NombreCampo], [Longitud], [Parametriza], [IdTipoParametro], " +
                    ...
                    objEstructura.BooEsParametrico == true ? 1 : 0,
                    Convert.ToInt32(objEstructura.StrIdVariable), Convert.ToInt32(objEstructura.StrIdTipoDato),
                    Convert.ToInt32(objEstructura.StrPosicion), objEstructura.BoolEstado == true ? 1 : 0, objEstructura.BoolNumerico == true ? 1 : 0);
        ...
        public void mtdActualizarEstructura(clsDTOEstructuraCampoEstructura objEstructura, ref string strErrMsg)
        {
            #region Vars
            clsDatabase cDatabase = new clsDatabase();
            DataTable dtInformacion = new DataTable();
            ...
            try
            {
                strConsulta = string.Format("UPDATE [Perfiles].[tblEstructuraCampos] " +
                    ...
                    "[IdTipoDato] = {5}, [Posicion]= {6}, [Numerico] = {8}, [Estado] = {9}" +
                    "WHERE [IdCampo] = {7}",
                    ...
                    objEstructura.BoolNumerico == true ? 1 : 0, objEstructura.BoolEstado == true ? 1 : 0);
